...
export function SearchTrigger({ onClick, variant = 'full', ...rest }: SearchTriggerProps) {
  return (
    <button
      type="button"
      onClick={onClick}
    ...
    >
      ...
      <KeyboardShortcut className={styles.searchTrigger__shortcut}>⌘K</KeyboardShortcut>
    </button>
  )
}
