(() => {
  ...
  var import_jkl_icon_button_react = __require("@fremtind/jkl-icon-button-react");
  var getIcon = (messageType) => {
    switch (messageType) {
      case "error":
  ...
  function messageFactory(messageType) {
    const MessageBox = ({
      ...
      const hasStringChild = import_react.default.Children.map(children, (child) => typeof child === "string");
      const newChildren = hasStringChild?.[0] ? /* @__PURE__ */ import_react.default.createElement("p", {
        className: "jkl-body"
      }, children) : children;
      return /* @__PURE__ */ import_react.default.createElement("div", {
        ...
        "data-theme": "light"
      }, getIcon(messageType), /* @__PURE__ */ import_react.default.createElement("div", {
        className: "jkl-message-box__content"
      }, title !== void 0 && /* @__PURE__ */ import_react.default.createElement("p", {
        className: "jkl-message-box__title"
      }, title), newChildren), dismissAction?.handleDismiss && /* @__PURE__ */ import_react.default.createElement(import_jkl_icon_button_react.IconButton, {
  ...
  var import_react35 = __toESM(__require("react"));
  ...
  function useFeatures(props, visualElement2, preloadedFeatures) {
    var features = [];
    var lazyContext = (0, import_react3.useContext)(LazyContext);
    if (!visualElement2)
      return null;
  ...
  function useReducedMotion() {
    ...
    var _a = __read((0, import_react8.useState)(prefersReducedMotion.current), 1), shouldReduceMotion = _a[0];
    return shouldReduceMotion;
  }
  function useReducedMotionConfig() {
    var reducedMotionPreference = useReducedMotion();
    var reducedMotion = (0, import_react8.useContext)(MotionConfigContext).reducedMotion;
  ...
  function useVisualElement(Component, visualState, props, createVisualElement) {
    ...
    var presenceContext = (0, import_react9.useContext)(PresenceContext);
    var shouldReduceMotion = useReducedMotionConfig();
    var visualElementRef = (0, import_react9.useRef)(void 0);
  ...
  function useCreateMotionContext(props) {
    var _a = getCurrentTreeVariants(props, (0, import_react11.useContext)(MotionContext)), initial = _a.initial, animate3 = _a.animate;
  ...
  function usePanGesture(_a) {
    ...
    var transformPagePoint = (0, import_react29.useContext)(MotionConfigContext).transformPagePoint;
    var handlers = {
  ...
  var import_react30 = __toESM(__require("react"), 1);
  ...
  function MeasureLayout(props) {
    var _a = __read(usePresence(), 2), isPresent = _a[0], safeToRemove = _a[1];
    var layoutGroup = (0, import_react30.useContext)(LayoutGroupContext);
    return import_react30.default.createElement(MeasureLayoutWithContext, __assign({}, props, { layoutGroup, switchLayoutGroup: (0, import_react30.useContext)(SwitchLayoutGroupContext), isPresent, safeToRemove }));
  }
  ...
  function useForceUpdate() {
    ...
    var _a = __read((0, import_react32.useState)(0), 2), forcedRenderCount = _a[0], setForcedRenderCount = _a[1];
    var forceRender = (0, import_react32.useCallback)(function() {
      isMounted.current && setForcedRenderCount(forcedRenderCount + 1);
    }, [forcedRenderCount]);
    var deferredForceRender = (0, import_react32.useCallback)(function() {
  ...
  function onlyElements(children) {
    var filtered = [];
    import_react34.Children.forEach(children, function(child) {
  ...
  var AnimatePresence = function(_a) {
    ...
    var forceRenderLayoutGroup = (0, import_react34.useContext)(LayoutGroupContext).forceRender;
    ...
    var presentChildren = (0, import_react34.useRef)(childrenToRender);
    var allChildren = (0, import_react34.useRef)(/* @__PURE__ */ new Map()).current;
    var isInitialRender = (0, import_react34.useRef)(true);
    useIsomorphicLayoutEffect(function() {
  ...
  var FormErrorMessageBox = (0, import_react35.forwardRef)((props, ref) => {
    const { className, errors, isSubmitted, isValid, messageBoxProps, ...rest } = props;
    const previousErrors = (0, import_react35.useRef)(errors);
    (0, import_react35.useEffect)(() => {
      previousErrors.current = errors;
    }, [errors]);
    const hasNewErrors = errors.length > previousErrors.current.length;
    return /* @__PURE__ */ import_react35.default.createElement(AnimatePresence, null, isSubmitted && !isValid && /* @__PURE__ */ import_react35.default.createElement(motion.div, {
      ref,
      ...
      exit: { opacity: 0 },
      ...rest
    }, /* @__PURE__ */ import_react35.default.createElement(ErrorMessageBox, {
      ...defaultMessageBoxProps,
      ...messageBoxProps,
      role: hasNewErrors ? "alert" : "presentation"
    }, /* @__PURE__ */ import_react35.default.createElement("ul", {
      className: "jkl-list"
    }, errors.filter((error) => typeof error !== "undefined").map((error) => /* @__PURE__ */ import_react35.default.createElement(motion.li, {
