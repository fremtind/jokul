...
function messageFactory(messageType) {
  const MessageBox = ({
    ...
    const newChildren = hasStringChild?.[0] ? /* @__PURE__ */ React.createElement("p", {
      className: "jkl-body"
    }, children) : children;
    return /* @__PURE__ */ React.createElement("div", {
      ...
      "data-theme": "light"
    }, getIcon(messageType), /* @__PURE__ */ React.createElement("div", {
      className: "jkl-message-box__content"
    }, title !== void 0 && /* @__PURE__ */ React.createElement("p", {
      className: "jkl-message-box__title"
    }, title), newChildren), dismissAction?.handleDismiss && /* @__PURE__ */ React.createElement(IconButton, {
...
import React6, { forwardRef as forwardRef2, useEffect as useEffect11, useRef as useRef8 } from "react";
...
function useReducedMotionConfig() {
  ...
  var reducedMotion = useContext3(MotionConfigContext).reducedMotion;
...
function useProjection(projectionId, _a, visualElement2, ProjectionNodeConstructor) {
  ...
  var initialPromotionConfig = useContext6(SwitchLayoutGroupContext);
...
function useLayoutId(_a) {
  ...
  var layoutGroupId = (_b = useContext7(LayoutGroupContext)) === null || _b === void 0 ? void 0 : _b.id;
...
var makeUseVisualState = function(config) {
  return function(props, isStatic) {
    var context = useContext8(MotionContext);
...
function usePanGesture(_a) {
  ...
  var panSession = useRef5(null);
  var transformPagePoint = useContext11(MotionConfigContext).transformPagePoint;
  var handlers = {
...
import { useContext as useContext13, useRef as useRef7, cloneElement, Children, isValidElement } from "react";
...
function useForceUpdate() {
  ...
  var _a = __read(useState2(0), 2), forcedRenderCount = _a[0], setForcedRenderCount = _a[1];
...
var AnimatePresence = function(_a) {
  ...
  var forceRenderLayoutGroup = useContext13(LayoutGroupContext).forceRender;
  ...
  var presentChildren = useRef7(childrenToRender);
  var allChildren = useRef7(/* @__PURE__ */ new Map()).current;
  var isInitialRender = useRef7(true);
  useIsomorphicLayoutEffect(function() {
...
var FormErrorMessageBox = forwardRef2((props, ref) => {
  const { className, errors, isSubmitted, isValid, messageBoxProps, ...rest } = props;
  const previousErrors = useRef8(errors);
  useEffect11(() => {
    previousErrors.current = errors;
  }, [errors]);
  const hasNewErrors = errors.length > previousErrors.current.length;
  return /* @__PURE__ */ React6.createElement(AnimatePresence, null, isSubmitted && !isValid && /* @__PURE__ */ React6.createElement(motion.div, {
    ref,
    ...
    exit: { opacity: 0 },
    ...rest
  }, /* @__PURE__ */ React6.createElement(ErrorMessageBox, {
    ...defaultMessageBoxProps,
    ...messageBoxProps,
    role: hasNewErrors ? "alert" : "presentation"
  }, /* @__PURE__ */ React6.createElement("ul", {
    className: "jkl-list"
  }, errors.filter((error) => typeof error !== "undefined").map((error) => /* @__PURE__ */ React6.createElement(motion.li, {
