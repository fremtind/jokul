...
<ComponentExample component={ScaffoldExample} codeExample={scaffoldExampleCode} knobs={scaffoldExampleKnobs} />
...
## Når bruker vi Scaffold?

Før du bruker Scaffold er det greit å ha tatt stilling til noen spørsmål:

-   Liste med kontrollspørsmål
-   Se [Message](/komponenter/message#når-bruker-vi-en-melding-) for eksempler

Dokumentér riktig og feil bruk av komponenten visuelt med `DoDontExample`. Se for eksempel [System message](/komponenter/systemmessage#når-bruker-vi-en-varselmelding-) for inspirasjon.
