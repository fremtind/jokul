...
// Source: ./src/sanity/queries/indexedSearch.ts
// Variable: componentSearchQuery
// Query: *[_type == "jokul_component" && defined(slug.current)] {        "id": _id,        "slug": slug.current,        "title": name,        short_description,        keywords,        image,        imageDark,        documentation_article    }
export type ComponentSearchQueryResult = Array<{
  id: string;
  slug: string | null;
  title: string | null;
  short_description: string | null;
...
// Variable: fundamentalsSearchQuery
// Query: *[_type == "jokul_fundamentals" && defined(slug.current)] {        "id": _id,        "slug": slug.current,        "title": name,        short_description,        article    }
export type FundamentalsSearchQueryResult = Array<{
  id: string;
  slug: string | null;
  title: string | null;
  short_description: string | null;
...
// Variable: blogPostSearchQuery
// Query: *[_type == "jokul_blog_post" && defined(slug.current)] {        "id": _id,        "slug": slug.current,        "title": name,        short_description,        article    }
export type BlogPostSearchQueryResult = Array<{
  id: string;
  slug: string | null;
  title: string | null;
  short_description: string | null;
