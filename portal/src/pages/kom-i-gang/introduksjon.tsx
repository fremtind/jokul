...
const Introduksjon: FC = () => (
    <MainContent>
        ...
        <Paragraph>
            Et designsystem kan være veldig mange ting. For oss er det blant
            annet et sett med felles normer for hvordan vi samarbeider om å
            bygge digitale produkter og tjenester.
        </Paragraph>
        <HeadingLarge>Hvorfor har vi et designsystem?</HeadingLarge>
        <Paragraph>
            Designsystemet vårt hjelper oss med å opprettholde en felles
            forståelse for hvordan vi gjør ting sammen. Det er mange gode
            grunner til å ha et designsystem. I Fremtind gir det oss en god del
        ...
        <Paragraph>
            Jøkul har blitt anerkjent av det norske fagmiljøet for design
            (Grafill),{" "}
        ...
        <Paragraph>
            Jøkul har mange bevegelige deler og det er mye man kan fordype seg
            i. På de neste sidene vil du få en kort innføring (cirka 15
            minutter) i de viktigste temaene vi forventer at du kjenner til, så
            du har gode forutsetninger for å bli en superbruker.
        </Paragraph>
        <UnorderedList className="jkl-portal-ul">
