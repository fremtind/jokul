...
## Hvordan bruke Jøkul i et nytt prosjekt
...
`Controller` må du gjerne [lage et issue på GitHub](https://github.com/fremtind/jokul/issues), og veldig gjerne [komme med en pull request](/endre/utvikling#pull-requests)!
