...
Dersom dialog brukesikombinasjon med en tidsbegrensning gjelder kravene under TIDSBEGRENSNING

#### Blinking på siden

Innhold skal ikke blinke mer enn tre gangeriløpet av ett sekund. Dette er et spesialtilfelle og hvis blinking oppstår er det som regel som følge av en feil ved animasjon som må rettes.
