...
All dokumentasjon på portalen en skrevet med språket [Markdown](https://daringfireball.net/projects/markdown/). Dette er et markeringsspråk som lar deg definere strukturen i det du skriver ved hjelp av enkle tegn i teksten. Her følger en kort introduksjon til de viktigste funksjonene. For en mer utfyllende gjennomgang med eksempler anbefaler vi [Markdown Guide](https://www.markdownguide.org/basic-syntax/).
