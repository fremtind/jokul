...
<InfoMessage>
    >>>>>>> cb2300e41 (chore: gi hovedbranchen et nytt navn) Proxy er et eksempel på moderne javascript som ikke kan
    polyfilles eller transpileres. Det finnes en ponyfill, men den er ikke et fullgodt alternativ. Framer Motion og
    React Hook Form er bibliotek som benytter seg av denne typen funksjonalitet, og de vil dermed ikke virke i alle
    nettlesere. Om man må støtte Internet Explorer 11, finnes det work-arounds for begge inntil videre.
</InfoMessage>
...
<InfoMessage>
    >>>>>>> cb2300e41 (chore: gi hovedbranchen et nytt navn) Selv om ikke alle komponentene våre bruker webcomponents,
    så anbefaler vi fortsatt å sette opp disse polyfillene med en gang du tar i bruk en eller flere av våre
    React-pakker.
</InfoMessage>
