...
Vi har noen minstekrav til dokumentasjon som den nye komponenten din <strong>må</strong> følge. Disse kravene gjelder dokumentasjonen som vises under Komponenter.

<strong>Må</strong>-krav:
...
I tillegg har vi noen <i>vil</i>-ønsker. Disse er det fint om du har med fordi de gjør det lettere for andre å bruke komponenten, men de er ikke et krav.
