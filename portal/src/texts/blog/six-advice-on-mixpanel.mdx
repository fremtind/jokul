...
![Edwards Deming](/assets/blog/quote-edwards-deming-data-opinion.jpg)
...
In short, meldskade.no is a typical SPA which promises the user to follow a set of operations
