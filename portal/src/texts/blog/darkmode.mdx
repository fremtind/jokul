...
<PortalImage alt='Valgene for "Dark mode" og "Invertert" i et komponenteksempel' src={props.images[0]} />
...
<body data-theme="dark">
    <InfoMessageBox title="Mørkt tema">
        Alle Jøkul-komponenter på denne siden vil automatisk få mørkt tema.
    </InfoMessageBox>
</body>
```

Du kan fint sette mørkt tema på kun en liten del av løsningen, og man kan også eksplisitt sette lyst tema med `data-theme="light"` på samme måte. Eksemplene i portalen er et eksempel på dette, der "Dark mode"-valget styrer `data-theme`-attributten kun på komponentvinduet.
