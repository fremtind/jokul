...
![Illustrasjon av ikon justert i forhold til fonthøyde, linjehøyde og baseline](/assets/blog/ikon_illustrasjon.png)
...
*(Her kan enten stoppe å lese eller fortsette hvis du ønsker nerdete detaljer...)*
