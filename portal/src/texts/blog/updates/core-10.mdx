...
Kjerneteamet har tatt en skikkelig vårrengjøring av Sass-kodebasen. Det har blant annet resultert i en ny [Stilguide for Sass](/guider/sass). Vårrengjøringen sørger for at Jøkul er klar for fjerningen av den gamle `@import`-syntaksen i Sass, og at Sass-koden har et tydelig dokumentert API.
