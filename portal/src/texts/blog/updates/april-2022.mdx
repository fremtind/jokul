...
Kjerneteamet ble oppmerksomme på at Jøkul hadde [mange kritiske mangler](https://github.com/fremtind/jokul/issues/2812) som gjorde løsningene våre utilgjengelige for brukere av høykontrastmodus (forced colors). Disse er rettet, og det er **viktig at alle oppdaterer** til nyeste versjon.
...
Enn så lenge har fokuset til kjerneteamet vært på å få Jøkul til å fungere overhode i høykontrastmodus. Om du vil bryne deg på denne designutfordringen, si i fra på designsystemforum så hjelper noen fra kjerneteamet deg i gang!
...
Kjerneteamet har brukt april til å designe et nytt onboardingløp for Jøkul. En del av det er synlig her i portalen. På landingssiden finner du tre navigasjonskort som peker til en flunkende ny _Kom i gang_-seksjon. Ta en titt, og kom gjerne med tilbakemeldinger!
