...
Ellers skjer det mye jobbing i kjerneteamet med forbedringer "under panseret" både i Figma og i Sass-kode. Der gjenstår det fremdeles en del, men _watch this space_ 👀
...
HenrikHermansen fikset en bug i Feedback hvor smileys ikke fikk en React `key`. Han fikset også så typedefinisjoner blir eksportert fra `@forbrukerradet/jkl-image-react` på riktig måte.
