...
<Ingress>
    Sommeren 2015 begynte en liten gruppe utviklere og en designer å gå fra team til team i SpareBank 1-universet for å
    fortelle om en idé vi jobbet med. En idé som med tiden har vokst til en kultur.
</Ingress>
...
<PortalImage alt="Hotel Monteleone takskilt" src={props.images[0]} />
...
<PortalImage alt="Eksempel på Fremtinds nye profil" src={props.images[1]} />
...
<PortalImage alt="Bilder av flere deltakere i digitalt designsystemforum" src={props.images[2]} />
...
<iframe
    width="560"
    height="315"
    src="https://www.youtube.com/embed/paPkOTZxf08"
