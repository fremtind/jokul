...
description: Vi kutter snart støtten for Internet Explorer
publishDate: "2021.10.20"
---

<Ingress>
    Internet Explorer (IE) har vært med oss i mange år, men nå kan vi endelig si ha det bra! I denne artikkelen vi jeg komme med et forslag på implementasjon hvordan du kan få dette inn i din applikasjon slik at vi kan fjerne støtten i Jøkul.
</Ingress>

Dersom du har levd bak en stein og ikke fått med deg at support for IE sakte men sikkert forsvinner, så kan du lese [her](https://techcommunity.microsoft.com/t5/microsoft-365-blog/microsoft-365-apps-say-farewell-to-internet-explorer-11-and/ba-p/1591666).
Edge har også begynt å bruke Chromium i mars 2021 og derfor kan du også legge inn en melding om dette. Teamene må selv bestemme hva de ønsker å gjøre med Edge, men vi anbefaler alle å legge inn melding om IE.

Microsoft tilbyr funksjonalitet for automatisk videresending av brukere fra IE til Edge hvis nettstedet er registrert hos Microsoft som inkompatibelt med IE, dette kan du lese mer om [her](https://docs.microsoft.com/en-us/microsoft-edge/web-platform/ie-to-microsoft-edge-redirection).
Vi (kundeklienter for privat) har tatt dette i bruk, men det ser ikke ut som om det fungerer for en eller annen grunn. Du kan søke om å komme med på den listen, men jeg kan ikke love at det fungerer bra.

Under kan du se implementasjonen av begge sperrene. Ta gjerne kontakt med meg dersom det er noe du lurer så skal jeg prøve å hjelpe :) Jeg kan også sende deg logo av typen SVG av Chrome, Firefox, Edge og Fremtind dersom du trenger det.

Først legger du inn referanse til CSS- og JS-filene i head av index_template.html eller tilsvarende:
