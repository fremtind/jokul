...
Dersom du har levd under en stein og ikke fått med deg at støtte for IE sakte men sikkert forsvinner, så kan du [lese her](https://techcommunity.microsoft.com/t5/microsoft-365-blog/microsoft-365-apps-say-farewell-to-internet-explorer-11-and/ba-p/1591666).
Edge har vært basert på Chromium fra mars 2021 så derfor kan du også legge inn en melding om dette. Teamene må selv bestemme hva de ønsker å gjøre med Edge, men vi anbefaler alle å legge inn melding om IE.
...
Vi i kundeklienter for privatmarkedet har tatt dette i bruk, men det ser ikke ut som om det fungerer for en eller annen grunn. Du kan søke om å komme med på den listen, men jeg kan ikke love at det fungerer bra.
