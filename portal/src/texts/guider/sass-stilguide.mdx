...
Alle klassenavn i Jøkul skal starte med `jkl` for å synliggjøre hvor CSSen kommer fra og unngå navnekollisjoner.
...
For å synliggjøre at en variabel kommer fra Jøkul, og for å unngå navnekollisjoner, skal alle CSS-variabler prefixes med `jkl` på lik linje som klassenavn.
