...
order: 3
keywords: webfonts jkl hook form
---
...
Ta [Accordion](/komponenter/accordion) som et eksempel. Skal du bruke React-komponenten installerer du den med `npm i @fremtind/jkl-accordion-react` og får automatisk med riktig versjon av `@fremtind/jkl-accordion` som en avhengighet. Dersom du bare bruker stilpakken, installerer du den med `npm i @fremtind/jkl-accordion`.
