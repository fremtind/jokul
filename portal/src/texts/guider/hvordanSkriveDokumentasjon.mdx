...
<Ingress>
    For at design&shy;systemet skal fungere må system&shy;dokumentasjonen være god. Hvis utviklere og designere ikke vet
    hvilke muligheter og begrensninger som finnes i systemet, kommer de til å gjøre feil og dobbelt&shy;arbeid.
</Ingress>
