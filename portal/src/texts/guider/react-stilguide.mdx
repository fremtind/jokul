...
Her er et eksempel fra `SystemMessage`. Vi setter `data-theme="light"` fordi bakgrunnsfargen i meldingsboksen gjør at tekstfargen som vanligvis brukes i mørkt tema får for dårlig kontrast. Her vil vi fjerne muligheten for at en bruker kan overstyre propen.
