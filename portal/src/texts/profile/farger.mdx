...
order: 3
images:
    - farger/bilforsikring_detaljside.png
    - farger/betaling_faktura.png
    - farger/hund_feilmelding.png
    - farger/tilganger_suksess.png
---
...
<Grid className="jkl-spacing-xl--bottom">
    <PortalImage alt="Skjermbilde av en detaljside for en bilforsikring" src={props.images[0]} />
    <PortalImage alt="Skjermbilde av en fakturaoversikt med detaljvisning for en faktura" src={props.images[1]} />
</Grid>
...
<Grid className="jkl-spacing-xl--bottom">
    ...
    />
    <PortalImage
        alt="Skjermbilde av et skjema for tilgangsstyring med en beskjed om at en endring var vellykket"
        src={props.images[3]}
    />
</Grid>
