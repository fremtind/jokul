...
<Ingress>
    Farger er en viktig del av Fremtinds identitet. Det etterlatte inntrykket av våre løsninger skal være snohvit med
...
<ColorDescription title="Snohvit" colorVariable="snohvit" cmyk="0 0 0 0">
    Snohvit bruker vi mest som bakgrunnsfarge, og som tekstfarge der vi har mørke flater. I tillegg er den fokusfarge, for
...
For Varde og lavere skal man bruke granitt tekst, og for Fjellgra og høyere skal man bruke snohvit tekst. Bruk Svaberg og Stein med omhu.
...
Tekstfargene våre er snohvit eller granitt. Se fargebeskrivelsene for å finne ut hvilken farge du skal bruke mot hvilken bakgrunn, for å overholde kontrastkravet.
