...
### Merknad om skjemavalidering

Vi har valgt at valideringsteksten skal erstatte hjelpeteksten. Derfor er det veldig viktig at feilmeldingen også tar med seg informasjonen fra hjelpeteksten, i tillegg til å forklare hva som er feil.
...
<Grid>
    <DoDontExample
        ...
        content={
            <TextInput
                label="Fødselsnummer"
                errorLabel="Fødselsnummeret er feil. Et fødselsnummer har 11 siffer."
                defaultValue="Input"
            />
        }
    />
