...
const kontrast: UUContent = {
    ...
    links: [["Eksternt verktøy til testing av kontrast", "https://colourcontrast.cc"]],
    body: () => (
        <>
            <Paragraph>For å sikre god lesbarhet skal all tekst ha tilstrekkelig kontrast mot bakgrunnen.</Paragraph>
            <List>
            ...
            <Paragraph>
                Våre <Anchor href="/profil/farger">farger i Jøkul</Anchor> er bestemt med hensyn til kontrastnivået.
            </Paragraph>
        </>
    ),
};
