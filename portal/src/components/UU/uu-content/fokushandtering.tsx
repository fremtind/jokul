...
const fokushandtering: UUContent = {
    ...
    links: [
        [
            "Hvordan teste fokusrekkefølge",
            "/universell-utforming/testguide/#fokusrekkefølge",
        ],
    ],
    body: () => (
        <>
            ...
            <Paragraph>
                Fokuserbare elementer må navigeres i en rekkefølge som gir
                mening for innholdet. Merk at man må være ekstra oppmerksom i
                dynamiske menyer og dialoger.
            </Paragraph>
            <HeadingSmall>Handlinger ved fokus</HeadingSmall>
            <Paragraph>
                Det skal være forutsigbart å bruke nettsiden. Ved fokus skal det
                derfor ikke foregå automatiske handlinger som at:
            </Paragraph>
            <UnorderedList>
            ...
            <Paragraph>
                Unngå bruk av <InlineCode>tabindex</InlineCode> for å overskrive
                dokumentets naturlige fokusrekkefølge. Hvis semantikken er på
                plass så er det sannsynligvis ingen feil her.
            </Paragraph>
        </>
    ),
};
