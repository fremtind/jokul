...
const dekorativtInnhold: UUContent = {
    ...
    body: () => (
        <>
            <Paragraph>
                Merk at <InlineCode>alt</InlineCode>-attributt alltid skal
                brukes på bilder, men på dekorativt innhold skal den være blank
                (<InlineCode>alt=&quot;&quot;</InlineCode>).
            </Paragraph>
            <List>
                <CheckListItem>
                    Rent dekorativt innhold skal ignoreres av kompenserende
                    teknologi
                </CheckListItem>
            </List>
            ...
            <UnorderedList>
                <ListItem>
                    Et visuelt element som brukes tilinnramming.
                </ListItem>
                <ListItem>
                    Illustrerende for nærliggende tekst, men bidrar ikke med
                    tilleggsinformasjon.
                </ListItem>
