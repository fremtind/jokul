...
export const BlogPageTemplate: FC<Blog> = ({ title, ingress, sections, tag, author, published_date, ...rest }) => {
    useFadingContent();
    ...
    return (
        <AnimatedPageWrapper className={"jkl-portal-blog-page"} {...rest}>
            <article>
                <span className={"jkl-portal-blog-visually-hidden"} id={"header-label"} aria-hidden={true}>
                    Overskrift og ingress
                </span>
                <section aria-labelledby={"header-label"}>
                    <TagComponent>
                        <span className={"jkl-portal-blog-visually-hidden"}>Kategori</span>
                    ...
                    <div className={"jkl-portal-blog-meta"}>
                        <div className={"jkl-portal-blog-meta__date"}>
                            <span className={"jkl-portal-blog-visually-hidden"}>Publisert dato</span>
                            {formatDate(published_date ?? "", "yyyy.MM.dd")}
                        </div>
                        <span className={"jkl-portal-blog-visually-hidden"}>Forfatter</span>
                        {(author as User).name}
                    </div>
                </section>
                <div className={"jkl-portal-blog-main"}>
                    <hr className={"jkl-portal-blog-divider"} aria-hidden={true} />
                    <span className={"jkl-portal-blog-visually-hidden"} id={"main-label"} aria-hidden={true}>
                        Bloggpost
                    </span>
                    <section aria-labelledby={"main-label"} className={"jkl-portal-blog-main__content"}>
