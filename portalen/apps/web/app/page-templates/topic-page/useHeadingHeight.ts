...
export const useHeadingHeight = () => {
     ...
     */
    const readHeadingHeight = useCallback((state: "expanded" | "collapsed" = "expanded") => {
        ...
        heading.dataset.collapsed = state === "collapsed" ? "true" : "false";
    ...
    useEffect(() => {
        ...
        const updateHeadingHeight = throttle(() => {
            ...
            if (typeof collapsed === "undefined" || typeof expanded === "undefined") {
