import{r as s,j as n}from"./iframe-DcdLGGMr.js";import{B as e}from"./Button-BZBCghMj.js";import{d as l,a as d,c as i,M as c,e as m,f as u,g as M,b as p}from"./Modal-DGW7j2oS.js";import{u as k}from"./useModal-1zBX9M9-.js";/* empty css               */import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./usePreviousValue-lZMKw1Ox.js";import"./Loader-CpJTSMmp.js";import"./useDelayedRender-Dvk4NPou.js";import"./IconButton-Bz5wfVwz.js";import"./CloseIcon-CeBg7sWT.js";import"./Icon-C2TKnfUB.js";import"./index-D8buYTFU.js";import"./index-Chjiymov.js";import"./useId-BR-4MYcj.js";const z={title:"Komponenter/Modal",component:p,subcomponents:{ModalActions:M,ModalBody:u,ModalCloseButton:m,ModalContainer:c,ModalHeader:i,ModalOverlay:d,ModalTitle:l},parameters:{layout:"centered"},tags:["autodocs"]},o={args:{role:"document"},render:y=>{const[a,h]=s.useState(!1),r="Bekreft sletting",[t,{title:B,overlay:x,container:f,modal:g,closeButton:j}]=k({title:r});return s.useEffect(()=>{t&&t.show()},[t]),n.jsxs(n.Fragment,{children:[n.jsx(e,{onClick:C=>h(!a),children:"Vis modal"}),a&&n.jsxs(c,{...f,children:[n.jsx(d,{...x}),n.jsxs(p,{...g,children:[n.jsxs(i,{children:[n.jsx(l,{...B,children:r}),n.jsx(m,{...j})]}),n.jsx(u,{children:"Er du sikker på at du vil slette dette dokumentet?"}),n.jsxs(M,{children:[n.jsx(e,{variant:"primary",onClick:()=>{t?.hide()},children:"Slett"}),n.jsx(e,{onClick:()=>t?.hide(),children:"Avbryt"})]})]})]})]})}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    role: "document"
  },
  render: args => {
