import{r as b,j as e}from"./iframe-BMIei6zj.js";import{C as j}from"./Card-Db3qbkQO.js";import{F as r}from"./Flex-Cfuo7GDR.js";import{T as c}from"./_index-BQuUqLnY.js";/* empty css               *//* empty css               */import{c as z}from"./clsx-B-dksMZM.js";import"./preload-helper-PPVm8Dsz.js";import"./SlotComponent-BGqEN7cn.js";import"./mergeRefs-DE5gAkyb.js";const n=b.forwardRef(function({className:g,size:u="l",as:k,srOnly:x,...h},T){const f=k||"h2";return e.jsx(f,{className:z("jkl-title",x&&"jkl-sr-only",g),"data-text-size":u,ref:T,...h})});n.__docgenInfo={description:"",methods:[],displayName:"Title",props:{as:{required:!1,tsType:{name:"ElementType"},description:`Her kan du angi hva slags element komponenten skal rendres
som. Det kan enten være en string for native HTML elementer
eller en komponent (som Link fra react-router og lignende).`},ref:{required:!1,tsType:{name:'ReactComponentPropsWithRef["ref"]',raw:'React.ComponentPropsWithRef<As>["ref"]'},description:""},size:{defaultValue:{value:'"l"',computed:!1},required:!1}}};const p=["xs","s","m","l","xl"],E={title:"Komponenter/Typografi/Title",component:n,args:{srOnly:!1,size:"l",children:"Forsikringer kjøper du i banken din eller i forbundet ditt"},argTypes:{size:{control:"select",options:p,description:"Visuell størrelse på tittelen, frakoblet fra `as`-nivået.",table:{defaultValue:{summary:"l"},type:{summary:'"xs" | "s" | "m" | "l" | "xl"'}}},as:{control:"select",options:["h1","h2","h3","h4","h5","h6","label","legend"],description:"Semantisk element. Standard er h2. Bruk h1–h6 for dokument-hierarki, eller label/legend for skjema-grupperinger.",table:{defaultValue:{summary:"h2"},type:{summary:'"h1" | "h2" | "h3" | "h4" | "h5" | "h6" | "label" | "legend"'}}},srOnly:{control:"boolean",description:"Skjuler tittelen visuelt, men beholder den i skjermlesere.",table:{defaultValue:{summary:"false"}}},children:{control:"text",description:"Innholdet i tittelen."},className:{control:"text",description:"Ekstra klassenavn som legges til i tillegg til `jkl-title`.",table:{type:{summary:"string"}}}},tags:["autodocs","grouping content"]},s={},i={parameters:{controls:{disable:!0},docs:{source:{code:`<Title size="xs">…</Title>
<Title size="s">…</Title>
<Title size="m">…</Title>
<Title size="l">…</Title>
<Title size="xl">…</Title>`}}},render:()=>e.jsx(r,{direction:"column",gap:"s",children:p.map(m=>e.jsxs(n,{size:m,children:["Markedsposisjon og eierforhold — ",m]},m))})},t={parameters:{controls:{disable:!0},docs:{source:{code:`{/* Samme element (h2), ulik visuell størrelse */}
...
<Title as="h3" size="m">Bærekraft</Title>\`
  ...
  render: () => <Card variant="filled" padding="l">
