import{j as e,r as x}from"./iframe-BOrF9nqU.js";import{s as b,f as p}from"./_index-BOngtseL.js";import{b as T,a as h,c as f,T as S}from"./TableHeader-CmaUaSmM.js";import{T as g}from"./TableBody-D_W-G9iC.js";import{a as d,T as l}from"./TableRow-Dfli23nD.js";import{c as k}from"./paginated-table-data-ZMeh4d0Y.js";import{u as w}from"./utils-DYxs2h-a.js";import{B as D}from"./Button-COep8p7o.js";import{I as C}from"./Icon-C5fNV8qg.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./ChevronDownIcon-CzubDJuv.js";import"./ChevronUpIcon-yHubngUK.js";import"./usePreviousValue-BF2Ry_x_.js";import"./Loader-OB5j8Itx.js";import"./useDelayedRender-Nyh3Rj9X.js";const G={title:"Komponenter/Table",component:S,subcomponents:{TableCaption:f,TableHead:h,TableHeader:T,TableBody:g,TableRow:l,TableCell:d},args:{fullWidth:!0,caption:e.jsx(f,{srOnly:!0,children:"Overskrift for skjermlesere"}),children:e.jsxs(e.Fragment,{children:[e.jsx(h,{sticky:!0,children:e.jsx(l,{children:b.columns.map((i,o)=>e.jsx(T,{bold:!0,children:i},o))})}),e.jsx(g,{children:b.rows.map((i,o)=>e.jsx(l,{children:i.map((u,a)=>e.jsx(d,{"data-th":b.columns[a],align:[1,2].includes(a)?"right":"left",children:u},a))},o))})]})}},c={},m={name:"useSortableTableHeader",args:{caption:e.jsx(f,{srOnly:!0,children:"Overskrift for skjermlesere"})},render:i=>{const[o,u]=x.useState(p.columns[0]),[a,B]=x.useState("desc"),j=(r,n)=>{u(r),B(n)},{getSortProps:y}=w(o,a,j);return e.jsxs(S,{caption:i.caption,fullWidth:!0,children:[e.jsx(h,{sticky:!0,children:e.jsx(l,{children:p.columns.slice(0,4).map((r,n)=>e.jsx(T,{bold:!0,...y(r),children:r},n))})}),e.jsx(g,{children:p.rows.sort((r,n)=>{if(o==="Forfallsdato"){const s=new Date(r[0]).getTime(),t=new Date(n[0]).getTime();return a==="asc"?s-t:t-s}if(o==="Beløp"){const s=Number(r[2]),t=Number(n[2]);return a==="asc"?s-t:t-s}return 0}).map((r,n)=>e.jsxs(l,{children:[r.slice(0,4).map((s,t)=>e.jsx(d,{"data-th":k[t],align:[1,2].includes(t)?"right":"left",children:s.toLocaleString()},t)),e.jsx(d,{children:e.jsx(D,{variant:"ghost",icon:e.jsx(C,{children:"download"}),iconPosition:"right",children:"Last ned"})})]},n))})]})}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:"{}",...c.parameters?.docs?.source}}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
