...
| "onChange"`,elements:[{name:"literal",value:'"type"'},{name:"literal",value:'"children"'},{name:"literal",value:'"className"'},{name:"literal",value:'"name"'},{name:"literal",value:'"defaultValue"'},{name:"literal",value:'"value"'},{name:"literal",value:'"placeholder"'},{name:"literal",value:'"width"'},{name:"literal",value:'"onFocus"'},{name:"literal",value:'"onBlur"'},{name:"literal",value:'"onChange"'}]}],raw:`Omit<
    ...
    | "onBlur"
    | "onChange"
>`},description:"Props som sendes direkte til komponentens TextInput"}},composes:["Omit"]};const Kt={title:"Komponenter/DatePicker",component:he,parameters:{layout:"padded"},tags:["autodocs"]},Q={args:{}};var De,we,Oe;Q.parameters={...Q.parameters,docs:{...(De=Q.parameters)==null?void 0:De.docs,source:{originalSource:`{
  args: {}
}`,...(Oe=(we=Q.parameters)==null?void 0:we.docs)==null?void 0:Oe.source}}};const Ht=["DatePicker"];export{Q as DatePicker,Ht as __namedExportsOrder,Kt as default};
