...
@default undefined`}}};const B={title:"Layout/Primitives/TwoColumn",component:t,tags:["autodocs"],argTypes:{minContentWidth:{table:{defaultValue:{summary:"50%"}},options:["50%","60%","70%","80%","90%"],control:{type:"select"}},gap:{table:{defaultValue:{summary:"undefined"}},options:Object.keys(r.unit),control:{type:"select"}},ref:{table:{disable:!0}},as:{table:{disable:!0}},className:{table:{disable:!0}},style:{table:{disable:!0}}},args:{minContentWidth:"50%",gap:void 0}},n={parameters:{layout:"fullscreen"},render:o=>e.jsxs(t,{...o,children:[e.jsx("div",{style:{border:"2px dashed var(--jkl-color-border-subdued)",width:"200px",paddingInline:r.unit[40],flexGrow:0},children:"Sidebar"}),e.jsxs(v,{as:b,children:[e.jsx("h2",{children:"Lag en commit"}),e.jsx("p",{children:"For å dokumentere endringer på en måte som automatiserer versjonering og generering av changelogs, bruker vi verktøyet Changesets."}),e.jsx("p",{children:"Changesets lar oss definere nøyaktig hvilke pakker som er påvirket av en endring og hva slags versjonsoppdatering (major, minor, eller patch) endringen medfører."}),e.jsx(k,{children:"Gå videre"})]})]})};var s,i,d;n.parameters={...n.parameters,docs:{...(s=n.parameters)==null?void 0:s.docs,source:{originalSource:`{
  parameters: {
    layout: "fullscreen"
  },
  render: props => {
...
}`,...(d=(i=n.parameters)==null?void 0:i.docs)==null?void 0:d.source}}};const G=["Demo"];export{n as Demo,G as __namedExportsOrder,B as default};
