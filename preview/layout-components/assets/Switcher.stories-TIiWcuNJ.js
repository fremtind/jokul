import{j as n}from"./jsx-runtime-BbjHj44Y.js";import{R as N}from"./index-C6mWTJJr.js";import{c as D}from"./clsx-B-dksMZM.js";import{t as o}from"./tokens-DyQL8Q6a.js";import{F as E}from"./Flex-Bxl3x-bI.js";import"./_commonjsHelpers-BosuxZz1.js";const i=N.forwardRef(function(s,k){const{as:g="div",className:f,treshold:b="30rem",gap:y=20,padding:d,maxElements:j=3,style:x,...S}=s,w=g;return n.jsx(w,{"data-testid":"jkl-switcher",className:D("jkl-switcher",f),"data-max-elements":j,style:{...x,"--treshold":b,"--gap":o.unit[y],"--padding":d?o.unit[d]:0},...S,ref:k})});i.__docgenInfo={description:`Switcher er en komponent som lar deg vise elementer ved
