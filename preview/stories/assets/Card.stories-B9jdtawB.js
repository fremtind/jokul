import{j as e}from"./jsx-runtime-BOJBhsC5.js";import{R as h}from"./index-Bv6P490N.js";import{c as k}from"./clsx-B-dksMZM.js";import{S as j}from"./SlotComponent-CgJtPkTS.js";import{I as v}from"./Image-Bda2t8MS.js";import{C as a}from"./Card-DRTpCu7t.js";import{F as r}from"./Flex-DAYRz_h9.js";import{C as F}from"./CheckIcon-DREZZ8z7.js";import{C as b}from"./CopyIcon-CTiS2n6z.js";import"./_commonjsHelpers-DaWZu8wl.js";import"./mergeRefs-BP-F_O_W.js";import"./tokens-d2GYn7oW.js";import"./Icon-DYEEOjBa.js";const g=h.forwardRef(function({as:c,asChild:s,className:p,placement:m="top",...f},x){const C=s?j:c||"img";return e.jsx(C,{ref:x,className:k("jkl-card-image",`jkl-card-image--${m}`,p),...f})});g.__docgenInfo={description:"Bildekomponent som kan brukes i `Card` for å sørge for at bildet\nblør helt ut i kantene av kortet. Rendres normalt som et `<img>`-\nelement, men du kan overstyre dette med `as` dersom du f.eks. har\nen egen komponent for å håndtere responsive bilder.",methods:[],displayName:"CardImage",props:{as:{required:!1,tsType:{name:"ElementType"},description:`Her kan du angi hva slags element komponenten skal rendres
...
}`,...d.parameters?.docs?.source}}};const W=["CardStory","ImageCard","CopyCard","LinkCard","FullImageCard"];export{i as CardStory,o as CopyCard,d as FullImageCard,t as ImageCard,l as LinkCard,W as __namedExportsOrder,L as default};
