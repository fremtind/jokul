import{j as e}from"./jsx-runtime-BOJBhsC5.js";import{r as n}from"./index-Bv6P490N.js";import{P as N,T as V,S as ue}from"./Button-7xZWz2K4.js";import{c as I}from"./clsx-B-dksMZM.js";import{S as de}from"./Message-Ciln1P9-.js";import{R as me}from"./RadioButton-CLkk-7j6.js";import{R as ce}from"./RadioButtonGroup-ChabOaJg.js";import{F as $}from"./FieldGroup-DI0jauUP.js";import{T as K}from"./TextArea-jK8ILvxK.js";import{C as pe}from"./Checkbox-DYaADVQK.js";import{u as ge}from"./useAnimatedHeight-x0eECUB-.js";import{T as P}from"./TextInput-CuQXZqTY.js";import"./_commonjsHelpers-DaWZu8wl.js";import"./usePreviousValue-CFxVqUaX.js";import"./Loader-DU6KErPQ.js";import"./useDelayedRender-CuF3W8uc.js";import"./useId-B1yQ3ow-.js";import"./WarningIcon-tCz-nOjC.js";import"./Icon-DYEEOjBa.js";import"./InfoIcon-CLYJ9S_Z.js";import"./DismissButton-BUYMtHg5.js";import"./CloseIcon-UHfS0BBi.js";import"./SupportLabel-WsXYroYu.js";import"./BaseRadioButton-B-4anWNh.js";import"./Label-BcS4ibrI.js";import"./InputGroup-Cl7hE9X0.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-1XLPz9Eq.js";import"./BaseTextInput-BSs526x8.js";import"./IconButton-9XUYZjY_.js";const ve=/^[a-zA-ZæøåÆØÅ0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-ZæøåÆØÅ0-9-]+(?:\.[a-zA-Z0-9-]+)+$/,ke=t=>ve.test(t),be=/^\d{8}$/,fe=t=>be.test(t),ye={feedbackSubmitted:!1,followupStarted:!1,followupSubmitted:!1,contactSubmitted:!1,setFeedbackSubmitted:()=>null,setFollowupStarted:()=>null,setFollowupSubmitted:()=>null,setContactSubmitted:()=>null},W=n.createContext(ye),w=()=>n.useContext(W),G=({value:t,children:s})=>e.jsx(W.Provider,{value:t,children:s});G.__docgenInfo={description:"",methods:[],displayName:"FeedbackContextProvider",props:{children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""},value:{required:!0,tsType:{name:"intersection",raw:`{
...
>`,required:!0}}]}},description:""}}};const Z=n.createContext(void 0),q=()=>n.useContext(Z),X=({state:t,children:s})=>e.jsx(Z.Provider,{value:t,children:s});X.__docgenInfo={description:"",methods:[],displayName:"MainQuestionContextProvider",props:{children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""},state:{required:!0,tsType:{name:"signature",type:"object",raw:`{
 ...
 hovedspørsmålet i Feedback, ignoreres ellers)`}]}}],raw:"FeedbackOption[]"},{name:"undefined"}]}],raw:"SetStateAction<FeedbackOption | FeedbackOption[] | undefined>"}],raw:`Dispatch<
    SetStateAction<FeedbackOption | FeedbackOption[] | undefined>
>`,required:!0}},{key:"message",value:{name:"string",required:!1}},{key:"setMessage",value:{name:"Dispatch",elements:[{name:"SetStateAction",elements:[{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]}],raw:"SetStateAction<string | undefined>"}],raw:"Dispatch<SetStateAction<string | undefined>>",required:!0}},{key:"submitted",value:{name:"boolean",required:!0}},{key:"handleSubmit",value:{name:"FormEventHandler",elements:[{name:"HTMLFormElement"}],raw:"FormEventHandler<HTMLFormElement>",required:!0}}]}},description:""}}};const J=({label:t,name:s,options:o,helpLabel:i,autoFocus:p=!1})=>{const g=H(),u=q(),r=g||u,l=n.useRef(null);n.useEffect(()=>{p&&l.current&&l.current.focus()},[p]);const d=a=>{const{value:v}=a.target,c=o?.find(m=>m.value.toString()===v);if(c){if(!r?.currentValue){r?.setCurrentValue([c]);return}if(Array.isArray(r?.currentValue)){const m=r.currentValue.find(k=>k===c);m?r.setCurrentValue(k=>k.filter(b=>b!==m)):r.setCurrentValue(k=>[...k,c])}}};return r?e.jsx($,{labelProps:{variant:"large"},legend:t,helpLabel:i,children:o?.map((a,v)=>e.jsx(pe,{name:s||t,value:a.value.toString(),onChange:d,ref:v===0?l:void 0,children:a.label},`${t}-${a.value}`))}):(console.error("Questions must be used inside a Followup or Feedback context provider"),null)};J.__docgenInfo={description:"",methods:[],displayName:"CheckboxQuestion",props:{type:{required:!1,tsType:{name:"union",raw:'"radio" | "checkbox" | "text" | "smiley"',elements:[{name:"literal",value:'"radio"'},{name:"literal",value:'"checkbox"'},{name:"literal",value:'"text"'},{name:"literal",value:'"smiley"'}]},description:""},label:{required:!0,tsType:{name:"string"},description:""},name:{required:!1,tsType:{name:"string"},description:""},helpLabel:{required:!1,tsType:{name:"string"},description:""},options:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    /** Teksten som vises ved alternativet */
    label: string;
    value: T;
    /** Her kan du spesifisere en egen tekst til oppfølgingsspørsmålet dersom
...
}`,computed:!1}},onSubmit:{required:!0,tsType:{name:"signature",type:"function",raw:"(values: FeedbackAnswer[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"union",raw:"SingleFeedbackAnswer | MultiFeedbackAnswer",elements:[{name:"SingleFeedbackAnswer"},{name:"MultiFeedbackAnswer"}]}],raw:"FeedbackAnswer[]"},name:"values"}],return:{name:"void"}}},description:""}}};const Le=t=>{const[s,o]=n.useState(),[i,p]=n.useState(),[g,u]=n.useState(!1),r=n.useRef({onSubmit:t,currentValue:s,message:i,submitted:g});n.useEffect(()=>{r.current={...r.current,onSubmit:t,currentValue:s,message:i,submitted:g}},[t,s,i,g]);const l=n.useCallback((v=!0)=>{const{message:c,currentValue:m,submitted:k,onSubmit:b}=r.current;if(!k&&m!==void 0){const f=Array.isArray(m)?m.map(y=>y.value):m?.value;b({feedbackValue:f,intentionalSubmit:v,...v&&c?{message:c}:{}})}},[]),d=n.useCallback(()=>l(!1),[l]);return n.useEffect(()=>(typeof window<"u"&&window.addEventListener("beforeunload",d),()=>{d(),window.removeEventListener("beforeunload",d)}),[d]),{currentValue:s,setCurrentValue:o,message:i,setMessage:p,submitted:g,handleSubmit:v=>{v.preventDefault(),l(),u(!0)}}},Ne={title:"Takk for tilbakemeldingen!",children:"Husk at vi ikke kan besvare meldinger fra dette skjemaet. Kontakt gjerne din forsikringsrådgiver om du har flere spørsmål."},le=({label:t,options:s,type:o,addOnQuestion:i,successMessage:p=Ne,helpLabel:g,onSubmit:u})=>{const r=Le(u),{setFeedbackSubmitted:l,contactSubmitted:d,landmarkLabel:a}=w(),{handleSubmit:v,currentValue:c,setCurrentValue:m,submitted:k}=r,[b]=ge(c!==void 0);n.useEffect(()=>{l(k)},[k,l]);const f=se(o);return e.jsxs(e.Fragment,{children:[!k&&e.jsx(X,{state:r,children:e.jsxs("form",{onSubmit:v,"aria-label":a,children:[e.jsx(f,{label:t,options:s,helpLabel:g}),e.jsxs("div",{ref:b,className:I({"jkl-feedback__submit-wrapper":!0,"jkl-feedback__submit-wrapper--hidden":c===void 0}),children:[i&&e.jsx(re,{helpLabel:typeof i=="object"?i.helpLabel:void 0,label:typeof i=="object"?i.label:void 0}),e.jsxs("div",{className:"jkl-feedback__buttons jkl-spacing-40--top",children:[e.jsx(N,{className:"jkl-spacing-40--right",children:"Send"}),e.jsx(V,{type:"button",onClick:()=>m(void 0),children:"Avbryt"})]})]})]})}),k&&!d&&e.jsx(E,{...p})]})};le.__docgenInfo={description:"",methods:[],displayName:"MainQuestion",props:{type:{required:!0,tsType:{name:"union",raw:'"radio" | "smiley"',elements:[{name:"literal",value:'"radio"'},{name:"literal",value:'"smiley"'}]},description:""},label:{required:!0,tsType:{name:"string"},description:""},helpLabel:{required:!1,tsType:{name:"string"},description:""},options:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    /** Teksten som vises ved alternativet */
    label: string;
    value: T;
    /** Her kan du spesifisere en egen tekst til oppfølgingsspørsmålet dersom
...
for brukeren.`}}};const ot={title:"Komponenter/Feedback",component:R,parameters:{layout:"centered"},tags:["autodocs"]},C={args:{type:"radio",label:"Hvordan opplevde du å bestille forsikring på nett?",helpLabel:"Hjelpetekst",options:[{label:"Enkelt og greit",value:"enkelt"},{label:"Midt på treet",value:"ok"},{label:"Tungvindt",value:"tungvindt"}],addOnQuestion:{label:"Er det noe mer du vil legge til?",helpLabel:"Hjelpetekst"},successMessage:{title:"Takk for tilbakemeldingen!",children:"Vi setter pris på at du tar deg tid til å gi oss tilbakemelding."},onSubmit:console.info},render:t=>e.jsx(R,{...t})},L={args:{type:"smiley",label:"Hvordan opplevde du å bestille forsikring på nett?",helpLabel:"Hjelpetekst",options:ee,addOnQuestion:{label:"Er det noe mer du vil legge til?",helpLabel:"Hjelpetekst"},successMessage:{title:"Takk for tilbakemeldingen!",children:"Vi setter pris på at du tar deg tid til å gi oss tilbakemelding."},onSubmit:console.info},render:t=>e.jsx(R,{...t})};C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  ...
  render: args => <Feedback {...args} />
}`,...L.parameters?.docs?.source}}};const ut=["Radio","Smiley"];export{C as Radio,L as Smiley,ut as __namedExportsOrder,ot as default};
