import{j as e}from"./iframe-C-lO5Wuj.js";import{C as p}from"./Card-FjKrcwI9.js";import{F as n}from"./Flex-DtJ5CGZW.js";/* empty css               *//* empty css               *//* empty css               */import{T as r}from"./Title-BQax-e4w.js";import{T as c}from"./Text-CDxOLSFb.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./SlotComponent-B6Hb33Yr.js";import"./mergeRefs-6DgWbG7E.js";const g=["xs","s","m","l","xl"],S={title:"Komponenter/Typografi/Title",component:r,args:{srOnly:!1,size:"l",children:"Forsikringer kjøper du i banken din eller i forbundet ditt"},argTypes:{size:{control:"select",options:g,description:"Visuell størrelse på tittelen, frakoblet fra `as`-nivået.",table:{defaultValue:{summary:"l"},type:{summary:'"xs" | "s" | "m" | "l" | "xl"'}}},as:{control:"select",options:["h1","h2","h3","h4","h5","h6","label","legend"],description:"Semantisk element. Standard er h2. Bruk h1–h6 for dokument-hierarki, eller label/legend for skjema-grupperinger.",table:{defaultValue:{summary:"h2"},type:{summary:'"h1" | "h2" | "h3" | "h4" | "h5" | "h6" | "label" | "legend"'}}},srOnly:{control:"boolean",description:"Skjuler tittelen visuelt, men beholder den i skjermlesere.",table:{defaultValue:{summary:"false"}}},children:{control:"text",description:"Innholdet i tittelen."},className:{control:"text",description:"Ekstra klassenavn som legges til i tillegg til `jkl-title`.",table:{type:{summary:"string"}}}},tags:["autodocs","grouping content"]},s={},i={parameters:{controls:{disable:!0},docs:{source:{code:`<Title size="xs">…</Title>
<Title size="s">…</Title>
<Title size="m">…</Title>
<Title size="l">…</Title>
<Title size="xl">…</Title>`}}},render:()=>e.jsx(n,{direction:"column",gap:"s",children:g.map(m=>e.jsxs(r,{size:m,children:["Markedsposisjon og eierforhold — ",m]},m))})},t={parameters:{controls:{disable:!0},docs:{source:{code:`{/* Samme element (h2), ulik visuell størrelse */}
...
<Title as="h3" size="m">Bærekraft</Title>`}}},render:()=>e.jsxs(n,{direction:"column",gap:"l",children:[e.jsxs(n,{direction:"column",gap:"xs",children:[e.jsx(r,{as:"h3",size:"xs",children:"Samme element, ulik stil"}),e.jsx(r,{size:"xl",children:"Om oss (h2, xl)"}),e.jsx(r,{size:"m",children:"Om oss (h2, m)"}),e.jsx(r,{size:"xs",children:"Om oss (h2, xs)"})]}),e.jsxs(n,{direction:"column",gap:"xs",children:[e.jsx(r,{as:"h3",size:"xs",children:"Samme stil, ulikt element"}),e.jsx(r,{as:"h1",size:"m",children:"Bærekraft (h1, m)"}),e.jsx(r,{size:"m",children:"Bærekraft (h2, m)"}),e.jsx(r,{as:"h3",size:"m",children:"Bærekraft (h3, m)"})]})]})},l={parameters:{controls:{disable:!0},docs:{source:{code:`<section aria-labelledby="forsikringer">
    <Title id="forsikringer" srOnly>
        Forsikringene dine
    </Title>
    {/* Visuelt innhold for seksjonen */}
</section>`}}},render:()=>e.jsxs(n,{direction:"column",gap:"xs",style:{maxWidth:560},children:[e.jsx(r,{srOnly:!0,children:"Forsikringene dine"}),e.jsxs(n,{direction:"row",gap:"s",style:{border:"1px dashed rgba(0,0,0,.3)",borderRadius:6,padding:16},children:[e.jsx("span",{children:"🚗 Bilforsikring"}),e.jsx("span",{children:"🏠 Husforsikring"}),e.jsx("span",{children:"✈️ Reiseforsikring"})]}),e.jsx("p",{children:'Over: et visuelt kortgitter. h2-en "Forsikringene dine" er usynlig, men tilgjengelig for skjermlesere slik at landemerket er beskrevet i hierarkiet.'})]})},o={parameters:{controls:{disable:!0},docs:{source:{type:"code",language:"tsx",code:`<Card padding="l">
