import{r as l,j as e,R as B}from"./iframe-CLLyC1DJ.js";import{c as y}from"./clsx-B-dksMZM.js";import{u as Z}from"./useAnimatedHeight-D5hCvJYs.js";import{u as H}from"./useId-BOSLfwTK.js";import{E as ee}from"./Expander-adIMuzs9.js";import{u as G,a as N,b as D,T as te,c as W,d as z,e as J,f as Q,g as C}from"./_index-R44Rp8Wc.js";import{T as U}from"./TableBody-Cn6LXTuR.js";import{I as O}from"./IconButton-CRFajy3s.js";import{C as ne}from"./ChevronLeftIcon-D8vHVeEA.js";import{C as ae}from"./ChevronRightIcon-ZbYUsAUy.js";import{N as re}from"./NativeSelect-COh3KFmn.js";import{T as X}from"./TextInput-COHRrgeA.js";import{u as se}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               *//* empty css               *//* empty css               *//* empty css               */import{S as le}from"./Select-DquwrBTk.js";import{B as oe}from"./Button-CtgQD8A1.js";import{L as F}from"./Link-Dqq3bkly.js";import{b as ie,D as K,a as q}from"./DescriptionList-DIWdplb2.js";import"./preload-helper-PPVm8Dsz.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-B9BBAZcg.js";import"./usePreviousValue-DqE0w0yZ.js";import"./ChevronDownIcon-DxZBbCnt.js";import"./Icon-DaVoT3Sy.js";import"./ChevronUpIcon-CRca8_Rw.js";import"./valuePair-Bn6SadUn.js";import"./ArrowVerticalAnimated-D-EAm9wB.js";import"./ArrowDownIcon-Dlf11MbH.js";import"./InputGroup-CX8eOi12.js";import"./Label-CuQR9-Ee.js";import"./SupportLabel-DQKVf3ZM.js";import"./WarningIcon-RgYjTVXi.js";import"./BaseTextInput-CJ3Xg2zo.js";import"./useListNavigation-h-KVpD5m.js";import"./Loader-CmGIZEaL.js";import"./useDelayedRender-DFd2hA-0.js";const E=l.forwardRef(({isOpen:i,onClick:t,children:n,className:o,id:f,"aria-controls":v,...u},w)=>{if(i===void 0||typeof t!="function")throw new Error("ExpandableTableRowController must have ExpandableTableRow as parent");const{collapseToList:p}=G(),m=u["data-th"],s=p?m:void 0;return e.jsx(N,{className:y("jkl-table-cell--expand",{"jkl-table-cell--expand-without-text":!n},o),...u,ref:w,children:e.jsx(ee,{as:"button",className:y("jkl-table-row-expand-button",{"jkl-table-row-expand-button--expanded":i}),id:f,open:i,"aria-controls":v,"aria-label":n?void 0:m||"Ekspander rad",onClick:b=>{b.stopPropagation(),t()},onKeyDown:b=>{(b.key==="Enter"||b.key===" ")&&(b.stopPropagation(),b.preventDefault(),t())},children:n??s})})});E.displayName="ExpandableTableRowController";E.__docgenInfo={description:"",methods:[],displayName:"ExpandableTableRowController",props:{density:{required:!1,tsType:{name:"union",raw:'"comfortable" | "compact"',elements:[{name:"literal",value:'"comfortable"'},{name:"literal",value:'"compact"'}]},description:""},align:{required:!1,tsType:{name:"union",raw:'"left" | "center" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"center"'},{name:"literal",value:'"right"'}]},description:`Velg mellom venstrejustering og høyrejustering av innholdet. Typisk skal innholdet være venstrejustert, men for eksempel summer er høyrejustert.
