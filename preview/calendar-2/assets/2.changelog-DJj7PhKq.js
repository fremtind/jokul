import{j as e}from"./iframe-lnnRhOPS.js";import{useMDXComponents as o}from"./index-BKwjPyim.js";import{b as i,c as a}from"./blocks-BcJBwJvQ.js";import"./preload-helper-PPVm8Dsz.js";import"./index-C3FxTYbE.js";import"./index-DNoSNrcf.js";import"./index-CqbRPoTA.js";const s=`# Change Log
...
- a893c6c: Lar Select-menyen gi Popover riktig høyde, slik at Floating UI kan plassere og flippe listen riktig når det ikke er plass under triggeren.
...
- e872aa2: Matcher bredden på Select-menyen mot triggeren med Floating UI sin size-middleware i stedet for CSS Anchor Positioning.
- d83d84e: Samkjører hjørneradius for Tooltip og Help, og gir Help samme padding som Tooltip.
- 9ff0f50: Oppdaterer spacing og border-radius i Menu for å samsvare med Figma-design.
...
- 183e662: Sentrerer ikonet i \`SystemMessage\`, og legger til dokumentasjon på bruk av \`role\`
...
- 7fe2a5f: Bytt ut \`date-fns\` med \`dayjs\` for behandling av datoer i kalenderen.
  ...
  For å gjøre oss klare for å droppe CommonJS i biblioteket bytter vi vekk fra \`date-fns\` for å håndtere datoer i kalenderen i \`DateInput\`. Pakken har en del feil i genereringen av typer, som gjør at man kan få feil ved import/bygg avhengig av om man bruker CJS eller ESM.

  Siden \`date-fns\` var en relativt stor pakke var den behandlet som en _optional dependency_, slik at du selv måtte installere den for å bruke \`DateInput\`. \`dayjs\` er en så liten pakke at vi har bygget inn relevant kode i kalenderen. Dermed får du én avhengighet mindre av å bruke Jøkul 🎉
...
`;function r(t){return e.jsxs(e.Fragment,{children:[e.jsx(i,{title:"Changelog"}),`
`,e.jsx(a,{children:s})]})}function p(t={}){const{wrapper:n}={...o(),...t.components};return n?e.jsx(n,{...t,children:e.jsx(r,{...t})}):r()}export{p as default};
