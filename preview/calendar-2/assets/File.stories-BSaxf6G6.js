import{r as i,j as e}from"./iframe-Cx2puDxY.js";import{c as H}from"./cow-CdXr5BwN.js";import{c as z}from"./clsx-B-dksMZM.js";import{F as f}from"./Flex-BPxlvJx3.js";import{T as v}from"./Text-sEbx4Bnl.js";import{L as B}from"./Link-CRHF1spq.js";import{f as N}from"./formatNumber-Davy0grG.js";import{n as M}from"./unicode-DWvs0Pen.js";import{B as U}from"./Button-BNQwGDOo.js";import{T as O}from"./TrashCanIcon-BS4HnImw.js";import{S as $}from"./SupportLabel-idFLCV_F.js";function w(n,a){return n>=1e5?`${N(Number(n/1e3/1e3),{maximumFractionDigits:1,...a})}${M}MB`:`${N(n/1e3,{maximumFractionDigits:2,...a})}${M}KB`}const D=i.createContext(null),A=()=>i.useContext(D),P=({context:n,children:a})=>e.jsx(D.Provider,{value:n,children:a});P.__docgenInfo={description:"",methods:[],displayName:"FileInputContextProvider",props:{children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""},context:{required:!0,tsType:{name:"signature",type:"object",raw:`{
