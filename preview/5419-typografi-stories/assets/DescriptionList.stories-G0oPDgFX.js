import{j as s}from"./jsx-runtime-BOJBhsC5.js";import"./index-Bv6P490N.js";import{D as l,a as t}from"./DescriptionList-CqcqAV6F.js";/* empty css               */import{f as r}from"./formatNumber-C5i6XT6A.js";import"./_commonjsHelpers-DaWZu8wl.js";import"./clsx-B-dksMZM.js";const m=[{title:"Supergavekort fra GoGift",value:`${r(100150)} kr`},{title:"Gavekort fra Power",value:`${r(1e3)} kr`},{title:"Penger på konto",value:`${r(12419)} kr`}],c=[{title:"Forsikring",value:"Innboforsikring"},{title:"Skadenummer",value:"350005600006"},{title:"Egenandel?",value:`${r(1500)} kr`}],u=[{title:"Pris per år",value:`${r(1025)} kr`},{title:"Kontor",value:"2,5 årsverk"},{title:"Ikke-kontor?",value:"3 årsverk"}],f={title:"Beta/Description List",component:t,subcomponents:{DescriptionListItem:l},parameters:{layout:"padded"},args:{alignment:"horizontal",showSeparators:!1},argTypes:{alignment:{options:["horizontal","vertical","justified"]}},tags:["autodocs","grouping content"]},i={name:"Default",args:{children:c.map(e=>s.jsx(t.Item,{...e},e.title))}},a={name:"Skadesak",args:{children:c.map(e=>s.jsx(t.Item,{...e},e.title))}},o={name:"Produktkjøp",args:{children:u.map(e=>s.jsx(t.Item,{...e},e.title))}},n={name:"Oppgjør",args:{alignment:"justified",showSeparators:!0,children:m.map(e=>s.jsx(t.Item,{...e},e.title))}},p={name:"Description List med hjelpetekst",args:{alignment:"justified",showSeparators:!0,children:m.map(e=>s.jsx(t.Item,{...e,supportText:"Hjelpeteksten bør være kort"},e.title))}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  name: "Default",
  args: {
...
}`,...p.parameters?.docs?.source}}};const v=["_DescriptionList","DescriptionListClaim","DescriptionListProduct","DescriptionListStory","DescriptionListWithDescription"];export{a as DescriptionListClaim,o as DescriptionListProduct,n as DescriptionListStory,p as DescriptionListWithDescription,i as _DescriptionList,v as __namedExportsOrder,f as default};
