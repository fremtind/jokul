import{j as e}from"./jsx-runtime-CfatFE5O.js";import{R as y}from"./index-ClcD9ViR.js";import{n as k,f as F,p as T}from"./formatNumber-DzIwhxNg.js";import{S as D,F as u}from"./Flex-57jOzUo6.js";import{E as R}from"./Tag-9mG1ieHS.js";import{c as S}from"./clsx-B-dksMZM.js";/* empty css               */import"./_commonjsHelpers-Cpj98o6Y.js";import"./tokens-DyQL8Q6a.js";const f={locale:"no-NB",minimumFractionDigits:0,maximumFractionDigits:2,suffix:"kr"};function A(t,s){const n=T(t);if(Number.isNaN(n))return t.toString();const l=Number.isInteger(n)?{}:{minimumFractionDigits:2,maximumFractionDigits:2},r=f.suffix,{prefix:a,...d}={...f,...l,...s},m=a!=null&&a.length?`${a}${k}`:"",c=r!=null&&r.length?`${k}${r}`:"",p=F(n,d);return`${m}${p}${c}`}const g=y.forwardRef(function(s,n){const{className:l,clickable:r=!1,padding:a="s",variant:d="high",asChild:m,as:c="div",...p}=s,N=m?D:c;return e.jsx(N,{"data-testid":"jkl-card","data-clickable":r,"data-padding":a,className:S("jkl-card",`jkl-card--${d}`,l),...p,ref:n})});g.__docgenInfo={description:`En allsidig kortkomponent som brukes for å gruppere innhold på en side.
