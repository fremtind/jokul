import{R as p,j as k}from"./iframe-uPNgk1Tq.js";import{c as f}from"./clsx-B-dksMZM.js";import{S as c}from"./SlotComponent-DmXTtcAc.js";const e=p.forwardRef(function(a,r){const{className:l,clickable:t=!1,padding:o="s",outlined:s=!1,asChild:i,as:d="div",...m}=a,u=i?c:d;return k.jsx(u,{"data-testid":"jkl-card","data-clickable":t,"data-padding":o,className:f("jkl-card",s&&"jkl-card--outlined",l),...m,ref:r})});try{e.displayName="Card",e.__docgenInfo={description:`En allsidig kortkomponent som brukes for å gruppere innhold på en side.
