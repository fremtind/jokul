import{j as e,r as n}from"./iframe-BU_jiWCV.js";import{P as N,T as V,S as ue}from"./Button-BqelCE4B.js";import{c as I}from"./clsx-B-dksMZM.js";import{S as de}from"./Message-BIFjSrMK.js";import{R as me}from"./RadioButton-B0bJstJP.js";import{R as pe}from"./RadioButtonGroup-BS3Yxcp9.js";import{F as $}from"./FieldGroup-BkuWikkg.js";import{T as K}from"./TextArea-CeVcwHSy.js";import{C as ce}from"./Checkbox-CsQAS1bJ.js";import{u as ge}from"./useAnimatedHeight-BAvzrBM5.js";import{T as P}from"./TextInput-CNt2pjTY.js";import"./preload-helper-PPVm8Dsz.js";import"./usePreviousValue-DMpjluUs.js";import"./Loader-KS9mGP60.js";import"./useDelayedRender-CBtH6jgR.js";import"./useId-D_a0m0IF.js";import"./WarningIcon-theVSf6h.js";import"./Icon-DZVy4Pvr.js";import"./InfoIcon-eQX7Ri2m.js";import"./DismissButton-Cw6E_Vj2.js";import"./CloseIcon-DzQnopdp.js";import"./SupportLabel-DQb_eXfm.js";import"./BaseRadioButton-BD3f7I2x.js";import"./InputGroup-BXWJEnz0.js";import"./Label-W9zw1Inm.js";import"./tokens-BiWAXAgN.js";import"./useBrowserPreferences-DPrXircX.js";import"./BaseTextInput-CDsHxcxL.js";import"./IconButton--b-nkxLU.js";const ve=/^[a-zA-ZæøåÆØÅ0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-ZæøåÆØÅ0-9-]+(?:\.[a-zA-Z0-9-]+)+$/,ke=t=>ve.test(t),be=/^\d{8}$/,fe=t=>be.test(t),ye={feedbackSubmitted:!1,followupStarted:!1,followupSubmitted:!1,contactSubmitted:!1,setFeedbackSubmitted:()=>null,setFollowupStarted:()=>null,setFollowupSubmitted:()=>null,setContactSubmitted:()=>null},W=n.createContext(ye),w=()=>n.useContext(W),z=({value:t,children:s})=>e.jsx(W.Provider,{value:t,children:s});z.__docgenInfo={description:"",methods:[],displayName:"FeedbackContextProvider",props:{children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""},value:{required:!0,tsType:{name:"intersection",raw:`{
    ...
    handleDismiss: () => void;
    buttonTitle?: string;
}`,signature:{properties:[{key:"handleDismiss",value:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}},required:!0}},{key:"buttonTitle",value:{name:"string",required:!1}}]}},description:""},variant:{required:!1,tsType:{name:"union",raw:'"info" | "error" | "success" | "warning"',elements:[{name:"literal",value:'"info"'},{name:"literal",value:'"error"'},{name:"literal",value:'"success"'},{name:"literal",value:'"warning"'}]},description:""}}};const G=n.createContext(void 0),H=()=>n.useContext(G),U=({state:t,children:s})=>e.jsx(G.Provider,{value:t,children:s});U.__docgenInfo={description:"",methods:[],displayName:"FollowUpProvider",props:{children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""},state:{required:!0,tsType:{name:"signature",type:"object",raw:`{
