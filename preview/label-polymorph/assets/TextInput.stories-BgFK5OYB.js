...
nummer-baserte svar.`,...a.parameters?.docs?.description}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  ...
  render: args => {
    return <FieldGroup legend="Når er du født?" legendProps={{
      "data-size": "medium"
    }}>
                <Flex gap="xs">
