import{j as t}from"./iframe-BU_jiWCV.js";import{c as a}from"./clsx-B-dksMZM.js";import{F as l}from"./FieldGroup-BkuWikkg.js";import{R as i}from"./RadioButton-B0bJstJP.js";const r=e=>t.jsx(l,{...e,className:a("jkl-segmented-control",e.className)});r.displayName="Segmented Control";r.__docgenInfo={description:"",methods:[],displayName:"Segmented Control",props:{"data-testautoid":{required:!1,tsType:{name:"string"},description:""},legend:{required:!0,tsType:{name:"string"},description:""},legendProps:{required:!1,tsType:{name:"intersection",raw:`Omit<
