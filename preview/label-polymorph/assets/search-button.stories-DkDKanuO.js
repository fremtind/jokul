...
}`,...v.parameters?.docs?.source}}};const ae=["_Search","SearchWithDatalist","SearchWithButton","BigSearch","SearchFilter","SearchWithResultsInPopover","SearchHeaderButton","SearchToolbar"],ve=Object.freeze(Object.defineProperty({__proto__:null,BigSearch:S,SearchFilter:k,SearchHeaderButton:b,SearchToolbar:v,SearchWithButton:p,SearchWithDatalist:x,SearchWithResultsInPopover:f,_Search:j,__namedExportsOrder:ae,default:ne},Symbol.toStringTag,{value:"Module"})),se={title:"Komponenter/Search/SearchButton",component:C,parameters:{layout:"centered"},args:{label:"Søk",type:"button"},argTypes:{type:{control:"inline-radio",options:["button","submit"]}},tags:["autodocs","forms"]},m={name:"Search Button",args:{label:"Søk",type:"button"},render:r=>e.jsx(e.Fragment,{children:e.jsx(s,{...p.args,label:p.args?.label,children:e.jsx(s.Button,{...r})})})};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  name: "Search Button",
  args: {
    label: "Søk",
    type: "button"
...
}`,...m.parameters?.docs?.source}}};const te=["SearchButtonStory"],ye=Object.freeze(Object.defineProperty({__proto__:null,SearchButtonStory:m,__namedExportsOrder:te,default:se},Symbol.toStringTag,{value:"Module"}));export{ye as a,ve as s};
