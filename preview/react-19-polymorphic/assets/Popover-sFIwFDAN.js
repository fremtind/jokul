import{j as k,r as t}from"./iframe-BtPvKFLs.js";import{d as E,e as U,f as M,g as N,h as z,i as A,j as D,k as S,o as H,l as I,s as B,u as x,F as J,b as K}from"./floating-ui.react-Dj2vJ21H.js";import{c as L}from"./clsx-B-dksMZM.js";import{g as b}from"./getThemeAndSize-CIzqY74s.js";const V=({open:e,onOpenChange:n,placement:s="bottom-start",strategy:c="absolute",modal:f=!0,offset:d=4,positionReference:o,hoverOptions:u,focusOptions:r,clickOptions:m,roleOptions:a,dismissOptions:h})=>{const[y,P]=t.useState(e),g=e??y,i=n??P,l=E({open:g,onOpenChange:i,placement:s,strategy:c,middleware:[H(d),I({padding:5,fallbackPlacements:["bottom","top"]}),B({padding:12})],whileElementsMounted:S}),p=l.context,v=U(p,{enabled:!1,...m}),C=M(p,{enabled:!1,...u}),w=N(p,{enabled:!1,...r}),F=z(p,h),q=A(p,a),R=D([v,F,w,C,q]);return t.useLayoutEffect(()=>{o&&l.refs.setPositionReference(o?.current)},[o,l.refs]),t.useMemo(()=>({open:g,onOpenChange:i,modal:f,...R,...l}),[g,i,f,R,l])},T=t.createContext(null),j=()=>{const e=t.useContext(T);if(e==null)throw new Error("Popover komponenter må brukes innenfor en <Popover /> komponent");return e},O=({children:e,...n})=>{const s=V({...n});return k.jsx(T.Provider,{value:s,children:e})},_=t.forwardRef(function({children:n,asChild:s=!1,...c},f){const{refs:d,getReferenceProps:o,open:u,onOpenChange:r}=j(),m=n.ref,a=x([d.setReference,f,m]);return s&&t.isValidElement(n)?t.cloneElement(n,o({ref:a,...c,...n.props})):k.jsx("button",{ref:a,onClick:()=>r?.(!u),"aria-expanded":u,...o(c),children:n})}),$=e=>e?"contextElement"in e:!1,G=t.forwardRef(function({style:n,className:s,padding:c=0,initialFocus:f=0,returnFocus:d=!0,...o},u){const{context:r,modal:m,refs:a,open:h,floatingStyles:y,getFloatingProps:P}=j(),g=x([a.setFloating,u]),i=a.reference.current,{theme:l,size:p}=$(i)?b(i.contextElement):b(i),v=t.useRef(null);return t.useEffect(()=>{v.current=r.elements.domReference?.closest("[data-portal]")||document.body},[r.elements.domReference]),h?k.jsx(J,{root:v.current,children:k.jsx(K,{context:r,modal:m,initialFocus:f,returnFocus:d,children:k.jsx("div",{"data-theme":l,"data-size":p,className:L("jkl jkl-popover",s),ref:g,style:{...n,...y,"--popover-padding":`var(--jkl-spacing-${c})`},...P(o),children:o.children})})}):null});O.Trigger=_;O.Content=G;O.__docgenInfo={description:"",methods:[],displayName:"Popover",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},open:{required:!1,tsType:{name:"boolean"},description:`Angir om popoveren er åpen eller lukket.
...
@default 4`},positionReference:{required:!1,tsType:{name:"ReactRefObject",raw:"React.RefObject<ReferenceType | null>",elements:[{name:"union",raw:"ReferenceType | null",elements:[{name:"ReferenceType"},{name:"null"}]}]},description:`Referanse til elementet som popoveren skal posisjoneres i forhold til.
