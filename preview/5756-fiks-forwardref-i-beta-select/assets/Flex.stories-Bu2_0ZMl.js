import{j as e}from"./iframe-D2IsncKs.js";import{t as x}from"./tokens-d2GYn7oW.js";import{L as m,F as i}from"./Flex-Cg7G8yPN.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./SlotComponent-ByuCRBlY.js";import"./mergeRefs-B07sKyq1.js";const c=Object.keys(x.semanticSpacing),h=c.flatMap(l=>[l,...c.filter(n=>l!==n).map(n=>`${l} ${n}`)]),b={title:"Komponenter/Flex",component:i,argTypes:{children:{description:"`React.ReactNode`"},layout:{control:"select",options:[...m,"{ small: '1', medium: '2', large: '4' }",'{ small: "1", medium: "auto" }'],mapping:{"{ small: '1', medium: '2', large: '4' }":{small:"1",medium:"2",large:"4"},'{ small: "1", medium: "auto" }':{small:"1",medium:"auto"}},description:`Sets layout for items per row.
