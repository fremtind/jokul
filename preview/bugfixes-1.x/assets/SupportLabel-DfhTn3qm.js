import{c as y}from"./clsx-B-dksMZM.js";import{R as s}from"./index-siqcju79.js";import{E as g,S as h,W as I}from"./WarningIcon-TwjxhH69.js";const S=({id:i,helpLabel:n,errorLabel:e,label:a,labelType:r="help",density:p,className:c,srOnly:d,...u})=>{const t=e||n||a,m=r==="help"||n&&!e,f=r==="warning"||e,l=r==="error",o=r==="success",b=t?y("jkl-form-support-label",c,{"jkl-form-support-label--sr-only":d,"jkl-form-support-label--help":m,"jkl-form-support-label--error":l,"jkl-form-support-label--warning":f,"jkl-form-support-label--success":o}):"jkl-dormant-form-support-label",k=t?u:{},v=l?g:o?h:I;return s.createElement("span",{id:i,className:b,...k,"data-density":p},s.createElement(v,{variant:"small",className:"jkl-form-support-label__icon"}),s.createElement("span",null,e||n||a))};S.__docgenInfo={description:"",methods:[],displayName:"SupportLabel",props:{id:{required:!0,tsType:{name:"string"},description:`En ID er påkrevd for å kunne referere til SupportLabel med aria-describedby.
