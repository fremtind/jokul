import{R as e,r as n}from"./index-siqcju79.js";import{P as L,T as N,S as ue}from"./Button-Dng0c-UK.js";import{c as I}from"./clsx-B-dksMZM.js";import{S as de}from"./Message-BzfTRwTh.js";import{a as me}from"./RadioButton-B8l5SIpT.js";import{R as ce}from"./RadioButtonGroup-taCVMD7n.js";import{F as $}from"./FieldGroup-DvKuzy6r.js";import{T as K}from"./TextArea-D2yyfebu.js";import{C as pe}from"./Checkbox-CwfoYjrc.js";import{u as ge}from"./useAnimatedHeight-RiQMQofH.js";import{T as P}from"./TextInput-iXJRXsU-.js";import"./_commonjsHelpers-DaWZu8wl.js";import"./usePreviousValue-f0kyfTHz.js";import"./Loader-Dq-CBRAZ.js";import"./useDelayedRender-CQprwS1c.js";import"./useId-CahK3IZ3.js";import"./WarningIcon-TwjxhH69.js";import"./Icon-mINJCSxV.js";import"./InfoIcon-BUv3PgcW.js";import"./DismissButton-C_71uvrR.js";import"./CloseIcon-bvBUMA_V.js";import"./SupportLabel-DfhTn3qm.js";import"./BaseRadioButton-BbIdBf1s.js";import"./Label-tZYmh4ng.js";import"./InputGroup-Ce9ZFCYA.js";import"./tokens-CmXyXTIM.js";import"./useBrowserPreferences-B9LcbCiO.js";import"./BaseTextInput-DX5KEZZS.js";import"./IconButton-B7cUPyFx.js";const ve=/^[a-zA-ZæøåÆØÅ0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-ZæøåÆØÅ0-9-]+(?:\.[a-zA-Z0-9-]+)+$/,ke=t=>ve.test(t),be=/^\d{8}$/,fe=t=>be.test(t),ye={feedbackSubmitted:!1,followupStarted:!1,followupSubmitted:!1,contactSubmitted:!1,setFeedbackSubmitted:()=>null,setFollowupStarted:()=>null,setFollowupSubmitted:()=>null,setContactSubmitted:()=>null},W=n.createContext(ye),T=()=>n.useContext(W),G=({value:t,children:s})=>e.createElement(W.Provider,{value:t},s);G.__docgenInfo={description:"",methods:[],displayName:"FeedbackContextProvider",props:{children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""},value:{required:!0,tsType:{name:"intersection",raw:`{
...
for brukeren.`}}};const lt={title:"Komponenter/Feedback",component:R,parameters:{layout:"centered"},tags:["autodocs"]},x={args:{type:"radio",label:"Hvordan opplevde du å bestille forsikring på nett?",helpLabel:"Hjelpetekst",options:[{label:"Enkelt og greit",value:"enkelt"},{label:"Midt på treet",value:"ok"},{label:"Tungvindt",value:"tungvindt"}],addOnQuestion:{label:"Er det noe mer du vil legge til?",helpLabel:"Hjelpetekst"},successMessage:{title:"Takk for tilbakemeldingen!",children:"Vi setter pris på at du tar deg tid til å gi oss tilbakemelding."},onSubmit:console.info},render:t=>e.createElement(R,{...t})},C={args:{type:"smiley",label:"Hvordan opplevde du å bestille forsikring på nett?",helpLabel:"Hjelpetekst",options:ee,addOnQuestion:{label:"Er det noe mer du vil legge til?",helpLabel:"Hjelpetekst"},successMessage:{title:"Takk for tilbakemeldingen!",children:"Vi setter pris på at du tar deg tid til å gi oss tilbakemelding."},onSubmit:console.info},render:t=>e.createElement(R,{...t})};x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  ...
  render: args => <Feedback {...args} />
}`,...C.parameters?.docs?.source}}};const ot=["Radio","Smiley"];export{x as Radio,C as Smiley,ot as __namedExportsOrder,lt as default};
