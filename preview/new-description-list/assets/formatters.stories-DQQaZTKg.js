import{j as n}from"./jsx-runtime-DqZpzl9T.js";import"./index-siqcju79.js";import{p as F,f as m}from"./formatNumber-C5i6XT6A.js";import{N as d,n as L,f as A}from"./formatBytes-B7RSIuaZ.js";/* empty css               */import{b as l,D as i,a as t}from"./DescriptionList-DiipGfWQ.js";import"./_commonjsHelpers-DaWZu8wl.js";import"./clsx-B-dksMZM.js";const y={full:/^(\d{6})(\d{5})$/,partial:/^(\d{6})(\d{1,5})?$/};function U(e,r){const s=e.replace(/\W/g,""),o=r?.partial?y.partial:y.full,a=s.match(o);return a?a.slice(1).filter(Boolean).join(d):e}const N={full:/^(\d{4})(\d{2})(\d{5})$/,partial:/^(\d{4})(\d{1,2})?(\d{1,5})?$/};function I(e,r){const s=e.replace(/\W/g,""),o=r?.partial?N.partial:N.full,a=s.match(o);return a?a.slice(1).filter(Boolean).join(r?.separator||d):e}const v={full:/^(\d{4})(\d{4})(\d{4})(\d{4})$/,partial:/^(\d{4})(\d{1,4})?(\d{1,4})?(\d{1,4})?$/};function M(e,r){const s=e.replace(/[\s-.]/g,""),o=r?.partial?v.partial:v.full,a=s.match(o);return a?a.slice(1).filter(Boolean).join(d):e}const b={full:/^(\d{3})(\d{3})(\d{3})$/,partial:/^(\d{3})(\d{1,3})?(\d{1,5})?$/};function P(e,r){const s=e.replace(/[\s-.]/g,""),o=r?.partial?b.partial:b.full,a=s.match(o);return a?a.slice(1).filter(Boolean).join(d):e}const p={mobil:/^([8]\d{2})(\d{2})(\d{3})$/,fast:/^([2-9]\d)(\d{2})(\d{2})(\d{2})$/,mobilPartial:/^([8]\d{2})(\d{1,2})?(\d{1,3})?$/,fastPartial:/^([2-9]\d)(\d{1,2})?(\d{1,2})?(\d{1,2})?$/};function _(e,r){const s=e.replace(/\W/g,""),o=r?.partial?p.mobilPartial:p.mobil,a=r?.partial?p.fastPartial:p.fast,c=s.match(o)||s.match(a);return c?[r?.countryCode?`+${r.countryCode}`:void 0,...c.slice(1)].filter(Boolean).join(d):e}const C={style:"unit",unit:"kilometer"};function V(e,r){const s=F(e);if(!s)return e.toString();const{suffix:o,...a}={...C,...r};return[m(s,a),o].join("")}const O={locale:"no-NB",minimumFractionDigits:0,maximumFractionDigits:2,suffix:"kr"};function B(e,r){const s=F(e);if(Number.isNaN(s))return e.toString();const o=Number.isInteger(s)?{}:{minimumFractionDigits:2,maximumFractionDigits:2},a=r?.suffix!==void 0?r.suffix:O.suffix,{prefix:c,...K}={...O,...o,...r},E=c?.length?`${c}${L}`:"",$=a?.length?`${L}${a}`:"",R=m(s,K);return`${E}${R}${$}`}const Q={title:"Utils/Formatters",parameters:{layout:"centered",docs:{toc:!0,description:{component:`Eksemplene er hentet fra [Språkrådets artikkel om formattering av tid, tall og
...
}`,...k.parameters?.docs?.source}}};const Z=["Dato","Tid","Tall","Avstand","Valuta","Telefonnummer","Fodselsnummer","Kortnummer","Kontonummer","Organisasjonsnummer","Filstorrelse"];export{h as Avstand,D as Dato,k as Filstorrelse,j as Fodselsnummer,S as Kontonummer,T as Kortnummer,w as Organisasjonsnummer,g as Tall,x as Telefonnummer,u as Tid,f as Valuta,Z as __namedExportsOrder,Q as default};
