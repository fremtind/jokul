import{j as t}from"./jsx-runtime-DqZpzl9T.js";import{c as m}from"./clsx-B-dksMZM.js";import"./index-siqcju79.js";import{f as i}from"./formatNumber-CM0sh02i.js";import{f as u}from"./formatKontonummer-DTlyGr8V.js";import"./_commonjsHelpers-DaWZu8wl.js";const d=({className:e,terms:s,alwaysJustified:a=!1,...p})=>t.jsx("dl",{...p,className:m("jkl-description-list--beta",e),"data-always-justified":a,children:s.map(({title:n,value:c,description:o})=>t.jsxs("div",{className:"wrapper",children:[t.jsx("dt",{className:"title",children:n}),t.jsx("dd",{className:"value",children:c}),o&&t.jsx("dd",{className:"description",children:o})]},n))});d.__docgenInfo={description:"",methods:[],displayName:"DescriptionList",props:{terms:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
    title: string;
    value: string;
    description?: string;
