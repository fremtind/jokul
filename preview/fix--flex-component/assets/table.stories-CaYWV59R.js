import{R as e,r as w}from"./index-siqcju79.js";import{T,a as i,b as p,c as y,d as f,e as k,f as g,s as b,g as S}from"./_index-BwCY9cKh.js";import{c as h}from"./paginated-table-data-ZMeh4d0Y.js";import{u as x}from"./utils-QVdaF3ec.js";/* empty css               *//* empty css               */import"./_commonjsHelpers-DaWZu8wl.js";import"./clsx-B-dksMZM.js";import"./ArrowVerticalAnimated-CKwdVeXh.js";import"./Icon-Crh-gXYv.js";const N={title:"Komponenter/Table",component:g,subcomponents:{TableCaption:k,TableHead:f,TableHeader:y,TableBody:p,TableRow:i,TableCell:T},parameters:{layout:"centered"},tags:["autodocs","tabular data"]},m={name:"Table",args:{collapseToList:!0,fullWidth:!0,caption:e.createElement(k,{srOnly:!0},"Overskrift for skjermlesere"),children:""},render:u=>e.createElement("div",{style:{width:"90dvw"}},e.createElement(g,{...u},e.createElement(f,{sticky:!0},e.createElement(i,null,b.columns.map((a,o)=>e.createElement(y,{key:o,bold:!0},a)))),e.createElement(p,null,b.rows.map((a,o)=>e.createElement(i,{key:o},a.map((s,c)=>e.createElement(T,{key:c,"data-th":b.columns[c],align:[1,2].includes(c)?"right":"left"},s)))))))},d={name:"useSortableTableHeader",args:{caption:e.createElement(k,{srOnly:!0},"Overskrift for skjermlesere"),children:""},render:u=>{const[a,o]=w.useState(h[0]),[s,c]=w.useState("desc"),B=(t,n)=>{o(t),c(n)},{getSortProps:E}=x(a,s,B);return e.createElement(g,{caption:u.caption,fullWidth:!0},e.createElement(f,{sticky:!0},e.createElement(i,null,S.columns.slice(0,4).map((t,n)=>e.createElement(y,{key:n,bold:!0,...E(t)},t)))),e.createElement(p,null,S.rows.sort((t,n)=>{if(a==="Forfallsdato"){const l=new Date(t[0]).getTime(),r=new Date(n[0]).getTime();return s==="asc"?l-r:r-l}if(a==="Beløp"){const l=Number(t[2]),r=Number(n[2]);return s==="asc"?l-r:r-l}return 0}).map((t,n)=>e.createElement(i,{key:n},t.slice(0,4).map((l,r)=>e.createElement(T,{key:r,"data-th":h[r],align:[1,2].includes(r)?"right":"left"},l.toLocaleString()))))))}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  name: "Table",
  args: {
    collapseToList: true,
    fullWidth: true,
