import{r as b,j as e}from"./iframe--yMwdpdm.js";import{C as j}from"./Card-Dfyo9CV_.js";import{F as r}from"./Flex-CssBoikp.js";import{T as c}from"./_index-D_5XDJ4x.js";/* empty css               *//* empty css               */import{c as z}from"./clsx-B-dksMZM.js";import"./preload-helper-PPVm8Dsz.js";import"./SlotComponent-wdJAwNYL.js";import"./mergeRefs-H6wOPyUH.js";const n=b.forwardRef(function({className:g,size:u="l",as:k,srOnly:x,...h},T){const f=k||"h2";return e.jsx(f,{className:z("jkl-title",x&&"jkl-sr-only",g),"data-text-size":u,ref:T,...h})});n.__docgenInfo={description:"",methods:[],displayName:"Title",props:{as:{required:!1,tsType:{name:"ElementType"},description:`Her kan du angi hva slags element komponenten skal rendres
