import{j as e}from"./jsx-runtime-DqZpzl9T.js";import{r as n}from"./index-siqcju79.js";import{P as N,T as V,S as ue}from"./Button-DE0vxub7.js";import{c as I}from"./clsx-B-dksMZM.js";import{S as de}from"./Message-CkK4i3Um.js";import{a as me}from"./RadioButton-DTrcPWE4.js";import{R as pe}from"./RadioButtonGroup-D7RlSHbq.js";import{F as $}from"./FieldGroup-CTL-9Ppy.js";import{T as K}from"./TextArea-1hR8mkXP.js";import{C as ce}from"./Checkbox-CjNXUV26.js";import{u as ge}from"./useAnimatedHeight-BAxzwhOL.js";import{T as P}from"./TextInput-x6Pd5lqx.js";import"./_commonjsHelpers-DaWZu8wl.js";import"./usePreviousValue-f0kyfTHz.js";import"./Loader-CDpFE6wc.js";import"./useDelayedRender-CQprwS1c.js";import"./useId-CahK3IZ3.js";import"./ErrorIcon-4c1VmZaU.js";import"./Icon-DnRkF4CO.js";import"./InfoIcon--32IE4_P.js";import"./WarningIcon-Bm98p7gS.js";import"./DismissButton-BwBrtK4j.js";import"./CloseIcon-CGR_BR3u.js";import"./SupportLabel-BNvn73Dv.js";import"./BaseRadioButton-C4joAhFY.js";import"./Label-Ct8Bs2e9.js";import"./InputGroup-fvuXdu4J.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-B9LcbCiO.js";import"./BaseTextInput-DDvdNY7P.js";import"./IconButton-CwYjR4Na.js";const ve=/^[a-zA-ZæøåÆØÅ0-9.!#$%&’*+/=?^_`{|}~-]+@[a-zA-ZæøåÆØÅ0-9-]+(?:\.[a-zA-Z0-9-]+)+$/,ke=t=>ve.test(t),be=/^\d{8}$/,fe=t=>be.test(t),ye={feedbackSubmitted:!1,followupStarted:!1,followupSubmitted:!1,contactSubmitted:!1,setFeedbackSubmitted:()=>null,setFollowupStarted:()=>null,setFollowupSubmitted:()=>null,setContactSubmitted:()=>null},W=n.createContext(ye),w=()=>n.useContext(W),G=({value:t,children:s})=>e.jsx(W.Provider,{value:t,children:s});G.__docgenInfo={description:"",methods:[],displayName:"FeedbackContextProvider",props:{children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""},value:{required:!0,tsType:{name:"intersection",raw:`{
...
for brukeren.`}}};const ut={title:"Komponenter/Feedback",component:R,parameters:{layout:"centered"},tags:["autodocs"]},C={args:{type:"radio",label:"Hvordan opplevde du å bestille forsikring på nett?",helpLabel:"Hjelpetekst",options:[{label:"Enkelt og greit",value:"enkelt"},{label:"Midt på treet",value:"ok"},{label:"Tungvindt",value:"tungvindt"}],addOnQuestion:{label:"Er det noe mer du vil legge til?",helpLabel:"Hjelpetekst"},successMessage:{title:"Takk for tilbakemeldingen!",children:"Vi setter pris på at du tar deg tid til å gi oss tilbakemelding."},onSubmit:console.info},render:t=>e.jsx(R,{...t})},L={args:{type:"smiley",label:"Hvordan opplevde du å bestille forsikring på nett?",helpLabel:"Hjelpetekst",options:ee,addOnQuestion:{label:"Er det noe mer du vil legge til?",helpLabel:"Hjelpetekst"},successMessage:{title:"Takk for tilbakemeldingen!",children:"Vi setter pris på at du tar deg tid til å gi oss tilbakemelding."},onSubmit:console.info},render:t=>e.jsx(R,{...t})};C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  ...
  render: args => <Feedback {...args} />
}`,...L.parameters?.docs?.source}}};const dt=["Radio","Smiley"];export{C as Radio,L as Smiley,dt as __namedExportsOrder,ut as default};
