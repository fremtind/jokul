import{r as s,j as e}from"./iframe-CPFMEoFO.js";import{c as U}from"./cow-CdXr5BwN.js";import{c as N}from"./clsx-B-dksMZM.js";import{L as w}from"./Link-BWH-W8zk.js";import{f as L}from"./formatBytes-B7RSIuaZ.js";import{B as h}from"./Button-C7ooss_z.js";import{T as I}from"./TrashCanIcon-N-2SDjmo.js";import{S as H}from"./SupportLabel-gYHvt_NB.js";import{F as f}from"./Flex-BOX6yhqg.js";const k=s.createContext(null),C=()=>s.useContext(k),q=({context:n,children:t})=>e.jsx(k.Provider,{value:n,children:t});q.__docgenInfo={description:"",methods:[],displayName:"FileInputContextProvider",props:{children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""},context:{required:!0,tsType:{name:"signature",type:"object",raw:`{
