import{j as n}from"./iframe-DtM7RXj6.js";import{p as F,f as m}from"./formatNumber-C5i6XT6A.js";import{N as d,n as L,f as A}from"./formatBytes-B7RSIuaZ.js";/* empty css               */import{b as l,D as r,a as t}from"./DescriptionList-CYWiZxJN.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";const y={full:/^(\d{6})(\d{5})$/,partial:/^(\d{6})(\d{1,5})?$/};function U(e,i){const s=e.replace(/\W/g,""),o=i?.partial?y.partial:y.full,a=s.match(o);return a?a.slice(1).filter(Boolean).join(d):e}const N={full:/^(\d{4})(\d{2})(\d{5})$/,partial:/^(\d{4})(\d{1,2})?(\d{1,5})?$/};function I(e,i){const s=e.replace(/\W/g,""),o=i?.partial?N.partial:N.full,a=s.match(o);return a?a.slice(1).filter(Boolean).join(i?.separator||d):e}const v={full:/^(\d{4})(\d{4})(\d{4})(\d{4})$/,partial:/^(\d{4})(\d{1,4})?(\d{1,4})?(\d{1,4})?$/};function M(e,i){const s=e.replace(/[\s-.]/g,""),o=i?.partial?v.partial:v.full,a=s.match(o);return a?a.slice(1).filter(Boolean).join(d):e}const b={full:/^(\d{3})(\d{3})(\d{3})$/,partial:/^(\d{3})(\d{1,3})?(\d{1,5})?$/};function P(e,i){const s=e.replace(/[\s-.]/g,""),o=i?.partial?b.partial:b.full,a=s.match(o);return a?a.slice(1).filter(Boolean).join(d):e}const p={mobil:/^([8]\d{2})(\d{2})(\d{3})$/,fast:/^([2-9]\d)(\d{2})(\d{2})(\d{2})$/,mobilPartial:/^([8]\d{2})(\d{1,2})?(\d{1,3})?$/,fastPartial:/^([2-9]\d)(\d{1,2})?(\d{1,2})?(\d{1,2})?$/};function _(e,i){const s=e.replace(/\W/g,""),o=i?.partial?p.mobilPartial:p.mobil,a=i?.partial?p.fastPartial:p.fast,c=s.match(o)||s.match(a);return c?[i?.countryCode?`+${i.countryCode}`:void 0,...c.slice(1)].filter(Boolean).join(d):e}const C={style:"unit",unit:"kilometer"};function V(e,i){const s=F(e);if(!s)return e.toString();const{suffix:o,...a}={...C,...i};return[m(s,a),o].join("")}const O={locale:"no-NB",minimumFractionDigits:0,maximumFractionDigits:2,suffix:"kr"};function B(e,i){const s=F(e);if(Number.isNaN(s))return e.toString();const o=Number.isInteger(s)?{}:{minimumFractionDigits:2,maximumFractionDigits:2},a=i?.suffix!==void 0?i.suffix:O.suffix,{prefix:c,...K}={...O,...o,...i},E=c?.length?`${c}${L}`:"",$=a?.length?`${L}${a}`:"",R=m(s,K);return`${E}${R}${$}`}const q={title:"Utils/Formatters",parameters:{layout:"centered",docs:{toc:!0,description:{component:`Eksemplene er hentet fra [Språkrådets artikkel om formattering av tid, tall og
datoer](https://sprakradet.no/godt-og-korrekt-sprak/rettskriving-og-grammatikk/tall-tid-dato/).`}}}},D={args:{locale:"nb-NO",time:new Date("2019-06-18T16:38:00").toString()},argTypes:{locale:{options:["nb-NO","en-US"],control:"select"},time:{control:"date"}},render:e=>n.jsxs("div",{children:[n.jsx("p",{className:"jkl-heading-2",children:"Dato"}),n.jsxs(l,{children:[n.jsx(r,{children:"Dato, måned og år"}),n.jsx(t,{children:n.jsx("time",{dateTime:new Date().toString(),children:new Date(e.time).toLocaleDateString(e.locale,{year:"numeric",month:"long",day:"numeric"})})}),n.jsx(t,{children:n.jsx("time",{dateTime:new Date().toString(),children:new Date(e.time).toLocaleDateString(e.locale,{year:"numeric",month:"numeric",day:"numeric"})})}),n.jsx(t,{children:n.jsx("time",{dateTime:new Date().toString(),children:new Date(e.time).toLocaleDateString(e.locale,{year:"numeric",month:"2-digit",day:"2-digit"})})}),n.jsx(t,{children:n.jsx("time",{dateTime:new Date().toString(),children:new Date(e.time).toLocaleDateString(e.locale,{year:"2-digit",month:"2-digit",day:"2-digit"})})}),n.jsx(t,{children:n.jsx("time",{dateTime:new Date().toString(),children:new Date(e.time).toLocaleDateString(e.locale,{year:"2-digit",month:"numeric",day:"numeric"})})}),n.jsx(t,{children:n.jsx("time",{dateTime:new Date().toString(),children:new Date(e.time).toLocaleDateString(e.locale,{year:"numeric",month:"2-digit",day:"2-digit"})})}),n.jsx(r,{children:"Uten årstall"}),n.jsx(t,{children:n.jsx("time",{dateTime:new Date(e.time).toString(),children:new Date(e.time).toLocaleDateString(e.locale,{month:"numeric",day:"numeric"})})}),n.jsx(r,{children:"Ved oppramsing"}),n.jsxs(t,{children:[new Date(e.time).toLocaleDateString(e.locale,{day:"numeric"}),",",new Date(new Date(e.time).setDate(new Date(e.time).getDate()+1)).toLocaleDateString(e.locale,{day:"numeric"}),", og"," ",new Date(new Date(e.time).setDate(new Date(e.time).getDate()+2)).toLocaleDateString(e.locale,{day:"numeric",month:"long"})]}),n.jsx(r,{children:"I teknisk bruk"}),n.jsx(t,{children:n.jsxs("time",{dateTime:new Date(e.time).toString(),children:[new Date(e.time).getFullYear(),"-",new Date(e.time).getMonth(),"-",new Date(e.time).getDate()]})})]})]})},u={args:{locale:"nb-NO",time:new Date("2019-06-18T16:38:00").toString()},argTypes:{locale:{options:["nb-NO","en-US"],control:"select"},time:{control:"date"}},render:e=>n.jsxs("div",{children:[n.jsx("p",{className:"jkl-heading-2",children:"Tid"}),n.jsxs(l,{children:[n.jsx(r,{children:"Klokkeslett"}),n.jsx(t,{children:new Date(e.time).toLocaleTimeString(e.locale,{hour:"numeric",minute:"numeric"})}),n.jsx(t,{children:new Date(e.time).toLocaleTimeString(e.locale,{hour:"numeric",minute:"numeric",second:"numeric"})}),n.jsx(r,{children:"Nøyaktige klokkeslett"}),n.jsx(t,{children:new Date(e.time).toLocaleTimeString(e.locale,{hour:"numeric",minute:"numeric",second:"numeric",fractionalSecondDigits:1})}),n.jsx(t,{children:new Date(e.time).toLocaleTimeString(e.locale,{hour:"numeric",minute:"numeric",second:"numeric",fractionalSecondDigits:2})}),n.jsx(r,{children:"Tid på døgnet"}),n.jsx(t,{children:new Date(e.time).toLocaleTimeString(e.locale,{dayPeriod:"long"})}),n.jsx(t,{children:new Date(e.time).toLocaleTimeString(e.locale,{dayPeriod:"short"})}),n.jsx(t,{children:new Date(e.time).toLocaleTimeString(e.locale,{dayPeriod:"narrow"})}),n.jsx(r,{children:"Tidsrom"}),n.jsxs(t,{children:["Kl."," ",new Date(e.time).toLocaleTimeString(e.locale,{hour:"numeric",minute:"numeric"}),"–",new Date(new Date(e.time).setHours(new Date(e.time).getHours()+8)).toLocaleTimeString(e.locale,{hour:"numeric",minute:"numeric"})]}),n.jsxs(t,{children:["Fra kl."," ",new Date(e.time).toLocaleTimeString(e.locale,{hour:"numeric",minute:"numeric"})," ","til"," ",new Date(new Date(e.time).setHours(new Date(e.time).getHours()+8)).toLocaleTimeString(e.locale,{hour:"numeric",minute:"numeric"})]})]})]})},g={args:{tall:1e4},render:e=>n.jsxs("div",{children:[n.jsxs("p",{className:"jkl-heading-2",children:["Tall ",n.jsxs("small",{children:["(",m(e.tall),")"]})]}),n.jsxs(l,{children:[n.jsx(r,{children:"Små tall"}),n.jsxs(t,{children:[m("23")," år"]}),n.jsx(r,{children:"Store tall"}),n.jsxs(t,{children:[m("2500000")," passasjerer"]}),n.jsxs(t,{children:[m("4500800")," kroner"]}),n.jsxs(t,{children:[m("2500")," biler"]}),n.jsx(t,{children:m("0,00302")}),n.jsx(r,{children:"Desimaltall"}),n.jsx(t,{children:m("12345,67")})]})]})},h={args:{avstand:4e3,suffix:"",unit:"kilometer"},argTypes:{unit:{control:"select",options:["kilometer","meter","decimeter","centimeter","millimeter","micrometer","nanometer","picometer","mile","yard","foot","inch","point"]}},render:e=>n.jsxs("div",{children:[n.jsx("p",{className:"jkl-heading-2",children:"Avstand"}),n.jsxs(l,{children:[n.jsx(r,{children:"Avstand"}),n.jsx(t,{children:V(e.avstand,{unit:e.unit,suffix:e.suffix})})]})]})},f={args:{kroner:4e3,prefix:"kr",suffix:"NOK",desimaler:0},argTypes:{desimaler:{control:{type:"number",max:2,min:0}}},render:e=>n.jsxs("div",{children:[n.jsx("p",{className:"jkl-heading-2",children:"Valuta"}),n.jsxs(l,{children:[n.jsx(r,{children:"Valuta"}),n.jsx(t,{children:B(e.kroner,{prefix:e.prefix,suffix:e.suffix,minimumFractionDigits:e.desimaler})})]})]})},x={args:{telefonnummer:"91509801",countryCode:"47"},argTypes:{telefonnummer:{type:"select",options:["91509801","80022222"]}},render:e=>n.jsxs("div",{children:[n.jsx("p",{className:"jkl-heading-2",children:"Telefonnummer"}),n.jsxs(l,{children:[n.jsx(r,{children:"Telefonnummer"}),n.jsx(t,{children:_(e.telefonnummer,{countryCode:e.countryCode})})]})]})},j={args:{fodselsnummer:"01065100203",partial:!1},render:e=>n.jsxs("div",{children:[n.jsx("p",{className:"jkl-heading-2",children:"Fødselsnummer"}),n.jsxs(l,{children:[n.jsx(r,{children:"Fødselsnummer"}),n.jsx(t,{children:U(e.fodselsnummer,{partial:e.partial})})]})]})},T={args:{kortnummer:"5457623898234113",partial:!1},render:e=>n.jsxs("div",{children:[n.jsx("p",{className:"jkl-heading-2",children:"Kortnummer"}),n.jsxs(l,{children:[n.jsx(r,{children:"Kortnummer"}),n.jsx(t,{children:M(e.kortnummer,{partial:e.partial})})]})]})},S={args:{kontonummer:"915651232",partial:!1,separator:"."},render:e=>n.jsxs("div",{children:[n.jsx("p",{className:"jkl-heading-2",children:"Kontonummer"}),n.jsxs(l,{children:[n.jsx(r,{children:"Kontonummer"}),n.jsx(t,{children:I(e.kontonummer,{partial:e.partial,separator:e.separator})})]})]})},w={args:{org:"915651232",partial:!1},render:e=>n.jsxs("div",{children:[n.jsx("p",{className:"jkl-heading-2",children:"Organisasjonsnummer"}),n.jsxs(l,{children:[n.jsx(r,{children:"Organisasjonsnummer"}),n.jsx(t,{children:P(e.org,{partial:e.partial})})]})]})},k={args:{size:1e7},render:e=>n.jsxs("div",{children:[n.jsx("p",{className:"jkl-heading-2",children:"Filstørrelse"}),n.jsxs(l,{children:[n.jsx(r,{children:"Filstørrelse"}),n.jsx(t,{children:A(e.size)})]})]})};D.parameters={...D.parameters,docs:{...D.parameters?.docs,source:{originalSource:`{
  args: {
    locale: "nb-NO",
    time: new Date("2019-06-18T16:38:00").toString()
  },
  argTypes: {
    locale: {
      options: ["nb-NO", "en-US"],
  ...
  render: (args: {
    size: number;
            ...
            <DescriptionList>
                ...
                <DescriptionDetail>{formatBytes(args.size)}</DescriptionDetail>
            </DescriptionList>
        </div>
}`,...k.parameters?.docs?.source}}};const Q=["Dato","Tid","Tall","Avstand","Valuta","Telefonnummer","Fodselsnummer","Kortnummer","Kontonummer","Organisasjonsnummer","Filstorrelse"];export{h as Avstand,D as Dato,k as Filstorrelse,j as Fodselsnummer,S as Kontonummer,T as Kortnummer,w as Organisasjonsnummer,g as Tall,x as Telefonnummer,u as Tid,f as Valuta,Q as __namedExportsOrder,q as default};
