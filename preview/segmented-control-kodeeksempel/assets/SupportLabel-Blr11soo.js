...
- "success" viser SuccessIcon`,name:"labelType",required:!1,type:{name:"enum",value:[{value:'"error"'},{value:'"help"'},{value:'"warning"'},{value:'"success"'}]}},className:{defaultValue:null,description:"",name:"className",required:!1,type:{name:"string"}},srOnly:{defaultValue:null,description:"",name:"srOnly",required:!1,type:{name:"boolean"}}}}}catch{}export{u as S};
