import{j as e}from"./iframe-BoM6kF9P.js";import{L as p,F as i,S as h,a as u}from"./Flex-CIAXa9CS.js";/* empty css               */import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./SlotComponent-D-o6uVoJ.js";import"./mergeRefs-DAPS0KVT.js";const x=l=>l.flatMap(n=>[n,...l.filter(r=>r!==n).map(r=>`${n} ${r}`)]),m=x([...h]),v=x([...u]),g=[...m,...v],S={title:"Komponenter/Flex",component:i,argTypes:{children:{description:"`React.ReactNode`"},layout:{control:"select",options:[...p,"{ small: '1', medium: '2', large: '4' }",'{ small: "1", medium: "auto" }'],mapping:{"{ small: '1', medium: '2', large: '4' }":{small:"1",medium:"2",large:"4"},'{ small: "1", medium: "auto" }':{small:"1",medium:"auto"}},description:`Sets layout for items per row.
