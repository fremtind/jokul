import{j as n}from"./iframe-B9B2iQPq.js";import{c as v}from"./clsx-B-dksMZM.js";import{E as h,S as g}from"./SuccessIcon-BlA4v25Z.js";import{W as y}from"./WarningIcon-BhhhauDK.js";const I=({id:i,helpLabel:s,errorLabel:e,label:o,labelType:r="help",className:p,srOnly:c,...d})=>{const a=e||s||o,u=r==="help"||s&&!e,m=r==="warning"||e,l=r==="error",t=r==="success",f=a?v("jkl-form-support-label",p,{"jkl-form-support-label--sr-only":c,"jkl-form-support-label--help":u,"jkl-form-support-label--error":l,"jkl-form-support-label--warning":m,"jkl-form-support-label--success":t}):"jkl-dormant-form-support-label",b=a?d:{},k=l?h:t?g:y;return n.jsxs("span",{id:i,className:f,...b,children:[n.jsx(k,{variant:"small",className:"jkl-form-support-label__icon"}),n.jsx("span",{children:e||s||o})]})};I.__docgenInfo={description:"",methods:[],displayName:"SupportLabel",props:{id:{required:!0,tsType:{name:"string"},description:`En ID er påkrevd for å kunne referere til SupportLabel med aria-describedby.
