...
}`,...m.parameters?.docs?.source},description:{story:"Nummerert liste med `OrderedList` — nyttig når rekkefølgen betyr noe.",...m.parameters?.docs?.description}}};const I=["Default","SizeScale","BoldOgShort","Brødtekst","SomLabel","InlineElementer","MedListe","KunForSkjermleser","NummerertListe"];export{n as BoldOgShort,i as Brødtekst,s as Default,o as InlineElementer,d as KunForSkjermleser,l as MedListe,m as NummerertListe,t as SizeScale,a as SomLabel,I as __namedExportsOrder,F as default};
