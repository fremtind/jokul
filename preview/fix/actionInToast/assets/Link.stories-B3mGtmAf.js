import{j as n}from"./jsx-runtime-BbjHj44Y.js";import{c as x}from"./clsx-B-dksMZM.js";import{R as h,r as y}from"./index-C6mWTJJr.js";import"./_commonjsHelpers-BosuxZz1.js";const s=h.forwardRef(function(c,m){const{external:t=!1,className:d="",children:f,as:k="a",...a}=c,u=k,o=y.useId();return n.jsxs(u,{ref:m,className:x("jkl-link",d,{"jkl-link--external":t}),"aria-describedby":t?o:void 0,...a,children:[n.jsx("span",{className:"jkl-link__content",children:f}),(t||a.target==="_blank")&&n.jsx("span",{hidden:!0,id:o,children:"Ekstern lenke"})]})});s.__docgenInfo={description:"",methods:[],displayName:"Link",props:{as:{required:!1,tsType:{name:"ElementType"},description:`Her kan du angi hva slags element komponenten skal rendres
