import{r as l,j as e,R as B}from"./iframe-D_KIqJpS.js";import{c as y}from"./clsx-B-dksMZM.js";import{u as Z}from"./useAnimatedHeight-q02Nkb0y.js";import{u as H}from"./useId-COFLPwun.js";import{E as ee}from"./Expander-BFJB7xaq.js";import{u as G,a as N,b as D,T as te,c as W,d as z,e as J,f as Q,g as C}from"./_index-CNOLkarG.js";import{T as U}from"./TableBody-CxhGMA8a.js";import{I as O}from"./IconButton-oDMChP7N.js";import{C as ne}from"./ChevronLeftIcon-KuLfHzsd.js";import{C as ae}from"./ChevronRightIcon-Cq9FDLeb.js";import{N as re}from"./NativeSelect-BDoBg8-G.js";import{T as X}from"./TextInput-gNl8kjEh.js";import{u as se}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               *//* empty css               *//* empty css               *//* empty css               */import{S as le}from"./Select-YWrk2vKS.js";import{B as oe}from"./Button-FfUTLQgc.js";import{L as F}from"./Link-BWOAeIzb.js";import{b as ie,D as K,a as q}from"./DescriptionList-clOzjs5n.js";import"./preload-helper-PPVm8Dsz.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-B1wt2LLa.js";import"./usePreviousValue-Cu892WzF.js";import"./ChevronDownIcon-C6itlOqM.js";import"./Icon-30guoCL6.js";import"./ChevronUpIcon-BooOnlLM.js";import"./valuePair-Bn6SadUn.js";import"./ArrowVerticalAnimated-BZtWGzxh.js";import"./ArrowDownIcon-CMrfQkmZ.js";import"./InputGroup-iKFb48HV.js";import"./Label-DYujrYq9.js";import"./SupportLabel-CdreSeNn.js";import"./WarningIcon-Cptfvehu.js";import"./BaseTextInput-Igpw7I3i.js";import"./useListNavigation-ctOd3Ofy.js";import"./Loader-Ce-2LK_g.js";import"./useDelayedRender-B061Wq-H.js";const E=l.forwardRef(({isOpen:i,onClick:t,children:n,className:o,id:f,"aria-controls":v,...u},w)=>{if(i===void 0||typeof t!="function")throw new Error("ExpandableTableRowController must have ExpandableTableRow as parent");const{collapseToList:p}=G(),m=u["data-th"],s=p?m:void 0;return e.jsx(N,{className:y("jkl-table-cell--expand",{"jkl-table-cell--expand-without-text":!n},o),...u,ref:w,children:e.jsx(ee,{as:"button",className:y("jkl-table-row-expand-button",{"jkl-table-row-expand-button--expanded":i}),id:f,open:i,"aria-controls":v,"aria-label":n?void 0:m||"Ekspander rad",onClick:b=>{b.stopPropagation(),t()},onKeyDown:b=>{(b.key==="Enter"||b.key===" ")&&(b.stopPropagation(),b.preventDefault(),t())},children:n??s})})});E.displayName="ExpandableTableRowController";E.__docgenInfo={description:"",methods:[],displayName:"ExpandableTableRowController",props:{density:{required:!1,tsType:{name:"union",raw:'"comfortable" | "compact"',elements:[{name:"literal",value:'"comfortable"'},{name:"literal",value:'"compact"'}]},description:""},align:{required:!1,tsType:{name:"union",raw:'"left" | "center" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"center"'},{name:"literal",value:'"right"'}]},description:`Velg mellom venstrejustering og høyrejustering av innholdet. Typisk skal innholdet være venstrejustert, men for eksempel summer er høyrejustert.
