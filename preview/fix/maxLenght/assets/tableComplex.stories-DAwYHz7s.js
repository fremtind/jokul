import{r as l,j as e,R as B}from"./iframe-DvP7N9Q0.js";import{c as y}from"./clsx-B-dksMZM.js";import{u as Z}from"./useAnimatedHeight-564YsWxt.js";import{u as H}from"./useId-lHt1Depp.js";import{E as ee}from"./Expander-DMx7IoXJ.js";import{u as G,a as N,b as D,T as te,c as W,d as z,e as J,f as Q,g as C}from"./_index-C4Rw65e2.js";import{T as U}from"./TableBody-ZTVTGCp5.js";import{I as O}from"./IconButton-DVl4o37Y.js";import{C as ne}from"./ChevronLeftIcon-BZ3avXG0.js";import{C as ae}from"./ChevronRightIcon-lCUq3T77.js";import{N as re}from"./NativeSelect-DB_bPHdq.js";import{T as X}from"./TextInput-9PSJowd9.js";import{u as se}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               *//* empty css               *//* empty css               *//* empty css               */import{S as le}from"./Select-BxlDuVUA.js";import{B as oe}from"./Button-BvvDw6Vv.js";import{L as F}from"./Link-BdMhKLm3.js";import{b as ie,D as K,a as q}from"./DescriptionList-RtZFTezg.js";import"./preload-helper-PPVm8Dsz.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-kg80OnC7.js";import"./usePreviousValue-NtKQN5ul.js";import"./ChevronDownIcon-NGnW7vG8.js";import"./Icon-B4XeI8eR.js";import"./ChevronUpIcon-C6A7DEA4.js";import"./valuePair-Bn6SadUn.js";import"./ArrowVerticalAnimated-mm9W3Zf0.js";import"./ArrowDownIcon-aDOlVBlC.js";import"./InputGroup-DJNrIhqf.js";import"./Label-3F0NI7P9.js";import"./SupportLabel-CorrWaHo.js";import"./WarningIcon-D6ZoqZ14.js";import"./BaseTextInput-EKt4MbxI.js";import"./useListNavigation-CoVOxghJ.js";import"./Loader-L57BNNpo.js";import"./useDelayedRender-Bj1oSTVz.js";const E=l.forwardRef(({isOpen:i,onClick:t,children:n,className:o,id:f,"aria-controls":v,...u},w)=>{if(i===void 0||typeof t!="function")throw new Error("ExpandableTableRowController must have ExpandableTableRow as parent");const{collapseToList:p}=G(),m=u["data-th"],s=p?m:void 0;return e.jsx(N,{className:y("jkl-table-cell--expand",{"jkl-table-cell--expand-without-text":!n},o),...u,ref:w,children:e.jsx(ee,{as:"button",className:y("jkl-table-row-expand-button",{"jkl-table-row-expand-button--expanded":i}),id:f,open:i,"aria-controls":v,"aria-label":n?void 0:m||"Ekspander rad",onClick:b=>{b.stopPropagation(),t()},onKeyDown:b=>{(b.key==="Enter"||b.key===" ")&&(b.stopPropagation(),b.preventDefault(),t())},children:n??s})})});E.displayName="ExpandableTableRowController";E.__docgenInfo={description:"",methods:[],displayName:"ExpandableTableRowController",props:{density:{required:!1,tsType:{name:"union",raw:'"comfortable" | "compact"',elements:[{name:"literal",value:'"comfortable"'},{name:"literal",value:'"compact"'}]},description:""},align:{required:!1,tsType:{name:"union",raw:'"left" | "center" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"center"'},{name:"literal",value:'"right"'}]},description:`Velg mellom venstrejustering og høyrejustering av innholdet. Typisk skal innholdet være venstrejustert, men for eksempel summer er høyrejustert.
