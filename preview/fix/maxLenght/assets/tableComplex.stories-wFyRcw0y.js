import{r as l,j as e,R as B}from"./iframe-B_A73W-G.js";import{c as y}from"./clsx-B-dksMZM.js";import{u as Z}from"./useAnimatedHeight-4M279RPn.js";import{u as H}from"./useId-2X4W-6uW.js";import{E as ee}from"./Expander-mimiT-zl.js";import{u as G,a as N,b as D,T as te,c as W,d as z,e as J,f as Q,g as C}from"./_index-hQhQFcm2.js";import{T as U}from"./TableBody-CiXkWBzG.js";import{I as O}from"./IconButton-CKG4YFx6.js";import{C as ne}from"./ChevronLeftIcon-IoZheewU.js";import{C as ae}from"./ChevronRightIcon-DZz5Aykj.js";import{N as re}from"./NativeSelect-Dhv_7ApN.js";import{T as X}from"./TextInput-DOBcf1qu.js";import{u as se}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               *//* empty css               *//* empty css               *//* empty css               */import{S as le}from"./Select-BkYEan-z.js";import{B as oe}from"./Button-Bu6nqOc1.js";import{L as F}from"./Link-Ble4Zhmg.js";import{b as ie,D as K,a as q}from"./DescriptionList-R5ut2oA0.js";import"./preload-helper-PPVm8Dsz.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-DcnXeMpS.js";import"./usePreviousValue-DKvwFX6r.js";import"./ChevronDownIcon-nsu-uUJt.js";import"./Icon-CeiFtBV_.js";import"./ChevronUpIcon-BosxN7vl.js";import"./valuePair-Bn6SadUn.js";import"./ArrowVerticalAnimated-BtBrUGCA.js";import"./ArrowDownIcon-CekoELiS.js";import"./InputGroup-DYiBIODx.js";import"./Label-CXHFDtSg.js";import"./SupportLabel-BSg9yuLr.js";import"./WarningIcon-joSIZwnY.js";import"./BaseTextInput-BEeZZzEa.js";import"./useListNavigation-CtVa-Zo2.js";import"./Loader-E7GDvgbl.js";import"./useDelayedRender-Yh_DX5bL.js";const E=l.forwardRef(({isOpen:i,onClick:t,children:n,className:o,id:f,"aria-controls":v,...u},w)=>{if(i===void 0||typeof t!="function")throw new Error("ExpandableTableRowController must have ExpandableTableRow as parent");const{collapseToList:p}=G(),m=u["data-th"],s=p?m:void 0;return e.jsx(N,{className:y("jkl-table-cell--expand",{"jkl-table-cell--expand-without-text":!n},o),...u,ref:w,children:e.jsx(ee,{as:"button",className:y("jkl-table-row-expand-button",{"jkl-table-row-expand-button--expanded":i}),id:f,open:i,"aria-controls":v,"aria-label":n?void 0:m||"Ekspander rad",onClick:b=>{b.stopPropagation(),t()},onKeyDown:b=>{(b.key==="Enter"||b.key===" ")&&(b.stopPropagation(),b.preventDefault(),t())},children:n??s})})});E.displayName="ExpandableTableRowController";E.__docgenInfo={description:"",methods:[],displayName:"ExpandableTableRowController",props:{density:{required:!1,tsType:{name:"union",raw:'"comfortable" | "compact"',elements:[{name:"literal",value:'"comfortable"'},{name:"literal",value:'"compact"'}]},description:""},align:{required:!1,tsType:{name:"union",raw:'"left" | "center" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"center"'},{name:"literal",value:'"right"'}]},description:`Velg mellom venstrejustering og høyrejustering av innholdet. Typisk skal innholdet være venstrejustert, men for eksempel summer er høyrejustert.
