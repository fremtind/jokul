import{r as b,j as e}from"./iframe-Bfjf-9vw.js";import{C as j}from"./Card-wr3J8TV1.js";import{F as r}from"./Flex-BhFytTZK.js";import{T as c}from"./_index-dAlo4Qv5.js";/* empty css               *//* empty css               */import{c as z}from"./clsx-B-dksMZM.js";import"./preload-helper-PPVm8Dsz.js";import"./SlotComponent-GxBX4Fmk.js";import"./mergeRefs-DQhiGyla.js";const n=b.forwardRef(function({className:p,size:u="l",as:k,srOnly:h,...x},T){const f=k||"h2";return e.jsx(f,{className:z("jkl-title",h&&"jkl-sr-only",p),"data-text-size":u,ref:T,...x})});n.__docgenInfo={description:"",methods:[],displayName:"Title",props:{as:{required:!1,tsType:{name:"ElementType"},description:`Her kan du angi hva slags element komponenten skal rendres
