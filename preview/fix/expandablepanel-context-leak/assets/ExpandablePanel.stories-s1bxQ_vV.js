...
}`,...p.parameters?.docs?.source},description:{story:"Stroke varianten skal ikke ha mellomrom mellom panelene.",...p.parameters?.docs?.description}}};k.parameters={...k.parameters,docs:{...k.parameters?.docs,source:{originalSource:`{
    ...
    const ForsikringsRad = ({
      ...
      return <div style={{
        ...
        paddingBlock: "8px"
                    ...
                    <Expander as="button" open={open} onClick={() => setOpen(v => !v)} data-testid={\`row-\${forsikring.key}\`} style={{
          width: "100%"
        }}>
...
}`,...c.parameters?.docs?.source},description:{story:"Regresjonstest for [#5565](https://github.com/fremtind/jokul/issues/5565):\net åpent `ExpandablePanel` med en liste over forsikringer — hver\nforsikring har sin egen kontrollerte `Expander` som viser detaljer.\nHver indre Expander styrer kun sin egen state, og klikk på dem skal\nikke lukke det ytre panelet.",...c.parameters?.docs?.description}}};const U=["ExpandablePanelFilled","ExpandablePanelStroke","ExpandablePanelStrokeStandalone","ExpandablePanelFillStandalone","ExpandablePanelControlled","ExpandablePanelInitiallyOpen","ExpandablePanelLongTitle","ExpandablePanelNestedExpanders"];export{m as ExpandablePanelControlled,x as ExpandablePanelFillStandalone,g as ExpandablePanelFilled,v as ExpandablePanelInitiallyOpen,y as ExpandablePanelLongTitle,c as ExpandablePanelNestedExpanders,p as ExpandablePanelStroke,k as ExpandablePanelStrokeStandalone,U as __namedExportsOrder,$ as default};
