import{r as b,j as e}from"./iframe-5MFVBG5r.js";import{C as j}from"./Card-CYCLm7O9.js";import{F as r}from"./Flex-4xcBCsPH.js";import{T as c}from"./_index-BOmZl5pm.js";/* empty css               *//* empty css               */import{c as z}from"./clsx-B-dksMZM.js";import"./preload-helper-PPVm8Dsz.js";import"./SlotComponent-Ll7U7U2Q.js";import"./mergeRefs-DWgp1mXe.js";const n=b.forwardRef(function({className:p,size:u="l",as:k,srOnly:h,...x},T){const f=k||"h2";return e.jsx(f,{className:z("jkl-title",h&&"jkl-sr-only",p),"data-text-size":u,ref:T,...x})});n.__docgenInfo={description:"",methods:[],displayName:"Title",props:{as:{required:!1,tsType:{name:"ElementType"},description:`Her kan du angi hva slags element komponenten skal rendres
