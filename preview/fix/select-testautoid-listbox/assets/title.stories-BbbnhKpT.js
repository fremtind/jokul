import{r as b,j as e}from"./iframe-C-6dUzrk.js";import{C as j}from"./Card-B9qedL2m.js";import{F as r}from"./Flex-NDLW2PIJ.js";import{T as c}from"./_index-d1VEnV-q.js";/* empty css               *//* empty css               */import{c as z}from"./clsx-B-dksMZM.js";import"./preload-helper-PPVm8Dsz.js";import"./SlotComponent-9Esg1e6Y.js";import"./mergeRefs-BB50QmVj.js";const n=b.forwardRef(function({className:g,size:u="l",as:k,srOnly:x,...h},T){const f=k||"h2";return e.jsx(f,{className:z("jkl-title",x&&"jkl-sr-only",g),"data-text-size":u,ref:T,...h})});n.__docgenInfo={description:"",methods:[],displayName:"Title",props:{as:{required:!1,tsType:{name:"ElementType"},description:`Her kan du angi hva slags element komponenten skal rendres
