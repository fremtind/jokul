import{r as b,j as e}from"./iframe-eKxOpoJM.js";import{C as j}from"./Card-Be8xn-KI.js";import{F as r}from"./Flex-y2mxgeqb.js";import{T as c}from"./_index-D6u28-Su.js";/* empty css               *//* empty css               */import{c as z}from"./clsx-B-dksMZM.js";import"./preload-helper-PPVm8Dsz.js";import"./SlotComponent-C86zgEjU.js";import"./mergeRefs-B81mh6y_.js";const n=b.forwardRef(function({className:g,size:u="l",as:k,srOnly:x,...h},T){const f=k||"h2";return e.jsx(f,{className:z("jkl-title",x&&"jkl-sr-only",g),"data-text-size":u,ref:T,...h})});n.__docgenInfo={description:"",methods:[],displayName:"Title",props:{as:{required:!1,tsType:{name:"ElementType"},description:`Her kan du angi hva slags element komponenten skal rendres
