import{r as l,j as e,R as B}from"./iframe-Cz8I4W-K.js";import{c as y}from"./clsx-B-dksMZM.js";import{u as Z}from"./useAnimatedHeight-H-ywJuJ4.js";import{u as H}from"./useId-4igKsEhg.js";import{E as ee}from"./Expander-C_61orCx.js";import{u as G,a as N,b as D,T as te,c as W,d as z,e as J,f as Q,g as C}from"./_index-BJSU8sH6.js";import{T as U}from"./TableBody-BzN6qIMK.js";import{I as O}from"./IconButton-CBmJej0E.js";import{C as ne}from"./ChevronLeftIcon-zo78lz3T.js";import{C as ae}from"./ChevronRightIcon-DRlcmC0e.js";import{N as re}from"./NativeSelect-DxL58xkt.js";import{T as X}from"./TextInput-n8Tjuo9-.js";import{u as se}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               *//* empty css               *//* empty css               *//* empty css               */import{S as le}from"./Select-DcZfgX_D.js";import{B as oe}from"./Button-BseqzH8C.js";import{L as F}from"./Link-DNCDzZ5y.js";import{b as ie,D as K,a as q}from"./DescriptionList-C-IFEhpT.js";import"./preload-helper-PPVm8Dsz.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-CqSDcqAI.js";import"./usePreviousValue-BR2-ZaQJ.js";import"./ChevronDownIcon-VjTBUSe7.js";import"./Icon-BMv0Zb4C.js";import"./ChevronUpIcon-AQPlox6C.js";import"./valuePair-Bn6SadUn.js";import"./ArrowVerticalAnimated-CL7QsLRm.js";import"./ArrowDownIcon-DsJtdM1S.js";import"./InputGroup-Cm9q4aeK.js";import"./Label-Dowgiqlq.js";import"./SupportLabel-CM3s8SNg.js";import"./WarningIcon-ChiDTEOe.js";import"./BaseTextInput-Ddz_1JF8.js";import"./useListNavigation-DG_GkdCM.js";import"./Loader-DVdXOlfU.js";import"./useDelayedRender-Bt_SoDzc.js";const E=l.forwardRef(({isOpen:i,onClick:t,children:n,className:o,id:f,"aria-controls":v,...u},w)=>{if(i===void 0||typeof t!="function")throw new Error("ExpandableTableRowController must have ExpandableTableRow as parent");const{collapseToList:p}=G(),m=u["data-th"],s=p?m:void 0;return e.jsx(N,{className:y("jkl-table-cell--expand",{"jkl-table-cell--expand-without-text":!n},o),...u,ref:w,children:e.jsx(ee,{as:"button",className:y("jkl-table-row-expand-button",{"jkl-table-row-expand-button--expanded":i}),id:f,open:i,"aria-controls":v,"aria-label":n?void 0:m||"Ekspander rad",onClick:b=>{b.stopPropagation(),t()},onKeyDown:b=>{(b.key==="Enter"||b.key===" ")&&(b.stopPropagation(),b.preventDefault(),t())},children:n??s})})});E.displayName="ExpandableTableRowController";E.__docgenInfo={description:"",methods:[],displayName:"ExpandableTableRowController",props:{density:{required:!1,tsType:{name:"union",raw:'"comfortable" | "compact"',elements:[{name:"literal",value:'"comfortable"'},{name:"literal",value:'"compact"'}]},description:""},align:{required:!1,tsType:{name:"union",raw:'"left" | "center" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"center"'},{name:"literal",value:'"right"'}]},description:`Velg mellom venstrejustering og høyrejustering av innholdet. Typisk skal innholdet være venstrejustert, men for eksempel summer er høyrejustert.
