import{r as l,j as e,R as B}from"./iframe-s-7ILYx9.js";import{c as y}from"./clsx-B-dksMZM.js";import{u as Z}from"./useAnimatedHeight-yibjDRLM.js";import{u as H}from"./useId-Df19DeTm.js";import{E as ee}from"./Expander-CME43iJn.js";import{u as G,a as N,b as D,T as te,c as W,d as z,e as J,f as Q,g as C}from"./_index-DeUFawNn.js";import{T as U}from"./TableBody-YBZ1cp_E.js";import{I as O}from"./IconButton-CXzkoPMt.js";import{C as ne}from"./ChevronLeftIcon-w1VKkzMF.js";import{C as ae}from"./ChevronRightIcon-Bbvu8avl.js";import{N as re}from"./NativeSelect-K6Ue8fx4.js";import{T as X}from"./TextInput-Dqz0drwB.js";import{u as se}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               *//* empty css               *//* empty css               *//* empty css               */import{S as le}from"./Select-R88AtkQT.js";import{B as oe}from"./Button-CwWO_8QQ.js";import{L as F}from"./Link-D9cXXysJ.js";import{b as ie,D as K,a as q}from"./DescriptionList-Ud9funD6.js";import"./preload-helper-PPVm8Dsz.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-D2rjorTl.js";import"./usePreviousValue-Fp5c39wE.js";import"./ChevronDownIcon-D3X37F0t.js";import"./Icon-Dlsb8Vxr.js";import"./ChevronUpIcon-uSHsyN0q.js";import"./valuePair-Bn6SadUn.js";import"./ArrowVerticalAnimated-DSh2k-e9.js";import"./ArrowDownIcon-DiSJVZ1o.js";import"./InputGroup-eZAOdpIx.js";import"./Label-oxkWQkbE.js";import"./SupportLabel-BHaIEAos.js";import"./WarningIcon-D7HkoStP.js";import"./BaseTextInput-BZu9olhq.js";import"./useListNavigation-CIaYVLUD.js";import"./Loader-B2fug2BN.js";import"./useDelayedRender-CVV9hUGd.js";const E=l.forwardRef(({isOpen:i,onClick:t,children:n,className:o,id:f,"aria-controls":v,...u},w)=>{if(i===void 0||typeof t!="function")throw new Error("ExpandableTableRowController must have ExpandableTableRow as parent");const{collapseToList:p}=G(),m=u["data-th"],s=p?m:void 0;return e.jsx(N,{className:y("jkl-table-cell--expand",{"jkl-table-cell--expand-without-text":!n},o),...u,ref:w,children:e.jsx(ee,{as:"button",className:y("jkl-table-row-expand-button",{"jkl-table-row-expand-button--expanded":i}),id:f,open:i,"aria-controls":v,"aria-label":n?void 0:m||"Ekspander rad",onClick:b=>{b.stopPropagation(),t()},onKeyDown:b=>{(b.key==="Enter"||b.key===" ")&&(b.stopPropagation(),b.preventDefault(),t())},children:n??s})})});E.displayName="ExpandableTableRowController";E.__docgenInfo={description:"",methods:[],displayName:"ExpandableTableRowController",props:{density:{required:!1,tsType:{name:"union",raw:'"comfortable" | "compact"',elements:[{name:"literal",value:'"comfortable"'},{name:"literal",value:'"compact"'}]},description:""},align:{required:!1,tsType:{name:"union",raw:'"left" | "center" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"center"'},{name:"literal",value:'"right"'}]},description:`Velg mellom venstrejustering og høyrejustering av innholdet. Typisk skal innholdet være venstrejustert, men for eksempel summer er høyrejustert.
