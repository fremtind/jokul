import{r,j as e,R as I}from"./iframe-BGVx81di.js";import{B as J}from"./Button-DAlP2Kj2.js";import{p as D,q as Q,r as X,t as Y,u as Z,f as ee,b as ne,a as te,d as se,e as re,v as oe,w as ae,i as ie,j as le,m as de,x as ue,F as me,k as pe,g as ce,o as fe,h as ge,s as ke}from"./floating-ui.react-DUZxL1mj.js";import{c as he}from"./clsx-B-dksMZM.js";import{u as ye}from"./useBrowserPreferences-KBVxwY5s.js";import{S as q}from"./SlotComponent-BhmsPT1c.js";import{M as l}from"./MenuItem-CwauhHoR.js";/* empty css               */import{C as ve}from"./ChevronDownIcon-DhnOaB_9.js";import"./preload-helper-PPVm8Dsz.js";import"./usePreviousValue-DL1baDHM.js";import"./Loader-C91lYzx_.js";import"./useDelayedRender-Cnxzg8RT.js";import"./index-1eNxiAfA.js";import"./index-CG3OwooR.js";import"./mergeRefs-s6f8NbV_.js";import"./ChevronRightIcon-CvnMgfVX.js";import"./Icon-Drznu7pl.js";import"./OpenInNewIcon-HKEiiqWI.js";const Me=(t,n,d)=>{const[h,y]=r.useState(!1),[p,c]=r.useState(!1);return r.useEffect(()=>{if(!t)return;function a(){c(!1)}function i(u){n&&u.nodeId!==n&&u.parentId===d&&c(!1)}return t.events.on("click",a),t.events.on("menuopen",i),()=>{t.events.off("click",a),t.events.off("menuopen",i)}},[t,n,d]),r.useEffect(()=>{p&&t&&n&&t.events.emit("menuopen",{parentId:d,nodeId:n})},[t,p,n,d]),r.useEffect(()=>{function a({pointerType:u}){u!=="touch"&&y(!0)}function i(){y(!1)}return window.addEventListener("pointermove",a,{once:!0,capture:!0}),window.addEventListener("keydown",i,!0),()=>{window.removeEventListener("pointermove",a,{capture:!0}),window.removeEventListener("keydown",i,!0)}},[h]),{allowHover:h,open:p,setOpen:c}};function E(t,n=0){switch(t){case"top":return`0 ${n}px`;case"left":return`${n}px 0`;case"bottom":return`0 ${-n}px`;case"right":return`${-n}px 0`;default:return`0 ${n}px`}}const b=r.forwardRef((t,n)=>{const{children:d,className:h,initialPlacement:y,openOnHover:p=!1,keepOpenOnClickOutside:c=!1,triggerElement:a,open:i,onToggle:u,...A}=t,O=`"jkl-menu"${r.useId()}`,{prefersReducedMotion:C}=ye(),M=X(),x=Y(),T=D(),f=T!=null,R=r.useRef([]),[F,P]=r.useState(null),{allowHover:N,open:B,setOpen:S}=Me(M,x,T),g=i!==void 0?i:B;r.useEffect(()=>u?.(g),[g,u]);const{refs:j,placement:H,context:m,floatingStyles:K}=Z({nodeId:x,open:g,onOpenChange:S,placement:y||(f?"right-start":"bottom-start"),middleware:[fe(2),ge({fallbackAxisSideDirection:"end",crossAxis:!1}),ke({padding:8})],whileElementsMounted:ce}),{getReferenceProps:$,getFloatingProps:L,getItemProps:_}=ee([ne(m,{enabled:p&&N,delay:{open:75},handleClose:ae({requireIntent:!0,blockPointerEvents:!0})}),te(m,{event:"mousedown"}),se(m,{outsidePress:!c}),re(m,{role:"menu"}),oe(m,{listRef:R,activeIndex:F,nested:f,onNavigate:P})]),V=ie([j.setReference,n]),{theme:U,density:W}=le(j.reference.current),{isMounted:z,styles:G}=de(m,{duration:{open:C?0:250,close:C?0:150},initial:({side:s})=>({opacity:0,translate:E(s,5)}),open:({side:s})=>({opacity:1,translate:E(s,0)}),close:({side:s})=>({opacity:0,translate:E(s,5)})});return e.jsxs(ue,{id:x,children:[I.isValidElement(a)&&e.jsx(q,{...$({...A,ref:V,role:f?"menuitem":void 0,"aria-controls":O,onClick(s){s.stopPropagation()}}),children:a}),z&&e.jsx(me,{children:e.jsx(pe,{context:m,modal:!1,initialFocus:f?-1:0,returnFocus:!f,children:e.jsx("div",{className:he("jkl jkl-menu",h),"data-theme":U,"data-layout-density":W,role:"menu","data-placement":H,"aria-live":"assertive","aria-hidden":!g,ref:j.setFloating,...L({id:O,style:{...K,...G}}),children:I.Children.map(d,(s,w)=>I.isValidElement(s)?e.jsx(q,{..._({...s.props,tabIndex:F===w?0:-1,role:"menuitem",ref(o){R.current[w]=o},onClick(o){s.props.onClick?.(o),!o.defaultPrevented&&M?.events.emit("click")},onKeyDown(o){s.props.onKeyDown?.(o),!o.defaultPrevented&&(M?.events.emit("keydown"),o.currentTarget.role==="menuitemcheckbox"&&o.key==="Enter"&&S(!1))},onMouseEnter(){N&&g&&P(w)}}),children:s}):s)})})})]})});b.displayName="MenuComponent";const k=r.forwardRef((t,n)=>D()===null?e.jsx(Q,{children:e.jsx(b,{ref:n,...t})}):e.jsx(b,{ref:n,...t}));k.displayName="Menu";k.__docgenInfo={description:"",methods:[],displayName:"Menu",props:{"data-testautoid":{required:!1,tsType:{name:"string"},description:""},children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""},className:{required:!1,tsType:{name:"string"},description:""},initialPlacement:{required:!1,tsType:{name:"Placement"},description:`Initiell plassering av menyen. Dersom det ikke er plass på skjermen der du
