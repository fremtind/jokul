import{r as n,j as e,R as I}from"./iframe-DBTjUgp-.js";import{c as P}from"./clsx-B-dksMZM.js";import{u as W}from"./useAnimatedHeight-D4tOKDO8.js";import{u as O}from"./useId-bMRGRjZ0.js";import{E as G}from"./Expander-K29E67Zo.js";import{u as z,T as x,a as y,g as J,b as H,c as q,d as V,e as $,f as g}from"./_index-C7RaNmZC.js";import{T as K}from"./TableBody-B6g6o_KK.js";import{T as Q}from"./TablePagination-DVmCOEeJ.js";import{u as U}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               *//* empty css               *//* empty css               *//* empty css               */import{T as X}from"./TextInput-VJTKpz2-.js";import{S as Y}from"./Select-B3XNBPRy.js";import{B as Z}from"./Button-Dzk-K1co.js";import{L as E}from"./Link-Bn-GG8IX.js";import{b as ee,D as _,a as B}from"./DescriptionList-Cm0fbzrL.js";import"./preload-helper-PPVm8Dsz.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-7YABw3KY.js";import"./usePreviousValue-D2eVRh5A.js";import"./ChevronDownIcon-CXy2ceeS.js";import"./Icon-KRhdj7hg.js";import"./ChevronUpIcon-CJnPeh8X.js";import"./Pagination-EBTzFimB.js";import"./IconButton-D_nns4TJ.js";import"./ChevronLeftIcon-BTHsRW28.js";import"./ChevronRightIcon-DwFvaIUQ.js";import"./NativeSelect-CCLWeiVJ.js";import"./valuePair-Bn6SadUn.js";import"./ArrowVerticalAnimated-qEp9lKTn.js";import"./ArrowDownIcon-CLNUESmY.js";import"./InputGroup-CkBufFEU.js";import"./Label-hX19tVwP.js";import"./SupportLabel-BMipDmQC.js";import"./WarningIcon-DWghBC5r.js";import"./BaseTextInput-C0WLP-mC.js";import"./useListNavigation-LaK7fwzi.js";import"./Loader-CXDS803X.js";import"./useDelayedRender-B66dwaTw.js";const D=n.forwardRef(({isOpen:d,onClick:r,children:l,className:f,id:b,"aria-controls":T,...p},k)=>{if(d===void 0||typeof r!="function")throw new Error("ExpandableTableRowController must have ExpandableTableRow as parent");const{collapseToList:i}=z(),w=p["data-th"],a=i?w:void 0;return e.jsx(x,{className:P("jkl-table-cell--expand",{"jkl-table-cell--expand-without-text":!l},f),...p,ref:k,children:e.jsx(G,{as:"button",className:P("jkl-table-row-expand-button",{"jkl-table-row-expand-button--expanded":d}),id:b,open:d,"aria-controls":T,"aria-label":l?void 0:w||"Ekspander rad",onClick:o=>{o.stopPropagation(),r()},onKeyDown:o=>{(o.key==="Enter"||o.key===" ")&&(o.stopPropagation(),o.preventDefault(),r())},children:l??a})})});D.displayName="ExpandableTableRowController";D.__docgenInfo={description:"",methods:[],displayName:"ExpandableTableRowController",props:{density:{required:!1,tsType:{name:"union",raw:'"comfortable" | "compact"',elements:[{name:"literal",value:'"comfortable"'},{name:"literal",value:'"compact"'}]},description:""},align:{required:!1,tsType:{name:"union",raw:'"left" | "center" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"center"'},{name:"literal",value:'"right"'}]},description:`Velg mellom venstrejustering og høyrejustering av innholdet. Typisk skal innholdet være venstrejustert, men for eksempel summer er høyrejustert.
