import{r as l,j as e,R as B}from"./iframe-BOohXgvX.js";import{c as y}from"./clsx-B-dksMZM.js";import{u as Z}from"./useAnimatedHeight-CvqgED24.js";import{u as H}from"./useId-DR-y4Sju.js";import{E as ee}from"./Expander-D_PJOhkK.js";import{u as G,a as N,b as D,T as te,c as W,d as z,e as J,f as Q,g as C}from"./_index-B_T_ADX1.js";import{T as U}from"./TableBody-CT894US-.js";import{I as O}from"./IconButton-tINOWNzC.js";import{C as ne}from"./ChevronLeftIcon-BSVn896g.js";import{C as ae}from"./ChevronRightIcon-1xoCoUs4.js";import{N as re}from"./NativeSelect-CMVxlnzO.js";import{T as X}from"./TextInput-4zx-PS85.js";import{u as se}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               *//* empty css               *//* empty css               *//* empty css               */import{S as le}from"./Select-Csq9n1LC.js";import{B as oe}from"./Button-D9wAF1Cp.js";import{L as F}from"./Link-CsHyFmud.js";import{b as ie,D as K,a as q}from"./DescriptionList-DROW2PEw.js";import"./preload-helper-PPVm8Dsz.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-24j3Hqre.js";import"./usePreviousValue-DAsMqggU.js";import"./ChevronDownIcon-ggSrs6az.js";import"./Icon-BSYjkIWE.js";import"./ChevronUpIcon-bdH4mLwN.js";import"./valuePair-Bn6SadUn.js";import"./ArrowVerticalAnimated-BZHm1jiJ.js";import"./ArrowDownIcon-B3f1bVcn.js";import"./InputGroup-CTXveJ6b.js";import"./Label-CiFrHv3-.js";import"./SupportLabel-ZJXmljTN.js";import"./WarningIcon-Bn9SfBzt.js";import"./BaseTextInput-_-Wp_3XH.js";import"./useListNavigation-CEuJ9GVS.js";import"./Loader-BzMpzjug.js";import"./useDelayedRender-zrAXdy8h.js";const E=l.forwardRef(({isOpen:i,onClick:t,children:n,className:o,id:f,"aria-controls":v,...u},w)=>{if(i===void 0||typeof t!="function")throw new Error("ExpandableTableRowController must have ExpandableTableRow as parent");const{collapseToList:p}=G(),m=u["data-th"],s=p?m:void 0;return e.jsx(N,{className:y("jkl-table-cell--expand",{"jkl-table-cell--expand-without-text":!n},o),...u,ref:w,children:e.jsx(ee,{as:"button",className:y("jkl-table-row-expand-button",{"jkl-table-row-expand-button--expanded":i}),id:f,open:i,"aria-controls":v,"aria-label":n?void 0:m||"Ekspander rad",onClick:b=>{b.stopPropagation(),t()},onKeyDown:b=>{(b.key==="Enter"||b.key===" ")&&(b.stopPropagation(),b.preventDefault(),t())},children:n??s})})});E.displayName="ExpandableTableRowController";E.__docgenInfo={description:"",methods:[],displayName:"ExpandableTableRowController",props:{density:{required:!1,tsType:{name:"union",raw:'"comfortable" | "compact"',elements:[{name:"literal",value:'"comfortable"'},{name:"literal",value:'"compact"'}]},description:""},align:{required:!1,tsType:{name:"union",raw:'"left" | "center" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"center"'},{name:"literal",value:'"right"'}]},description:`Velg mellom venstrejustering og høyrejustering av innholdet. Typisk skal innholdet være venstrejustert, men for eksempel summer er høyrejustert.
