import{r as m,j as t}from"./iframe-CF4AVgx1.js";import{P as o}from"./Pagination-iv4yPAzc.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./IconButton-DMK6nMGe.js";import"./ChevronLeftIcon-07Ho1B1w.js";import"./Icon-D4-b-6ai.js";import"./ChevronRightIcon-BaiimZNQ.js";const x={title:"Komponenter/Pagination",component:o},e={args:{currentPage:1,numberOfPages:10,onPageChange:()=>{}},decorators:[(u,r)=>{const[s,g]=m.useState(r.args.currentPage),a=r.args.numberOfPages,P=n=>{n>0&&n<=a&&g(n)};return t.jsx("div",{children:t.jsx(o,{currentPage:s,numberOfPages:a,onPageChange:P})})}]};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    currentPage: 1,
    numberOfPages: 10,
    onPageChange: () => {}
