import{r as n,j as e,R as I}from"./iframe-DVuwCucA.js";import{c as P}from"./clsx-B-dksMZM.js";import{u as W}from"./useAnimatedHeight-CmqJkaey.js";import{u as O}from"./useId-x7qrK8aY.js";import{E as G}from"./Expander-BwfjggEX.js";import{u as z,T as x,a as y,g as J,b as H,c as q,d as V,e as $,f as g}from"./_index-mH6HJlJq.js";import{T as K}from"./TableBody-WdRDqUjh.js";import{T as Q}from"./TablePagination-DL7h0vtI.js";import{u as U}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               *//* empty css               *//* empty css               *//* empty css               */import{T as X}from"./TextInput-Cs5O5HbT.js";import{S as Y}from"./Select-DE7c5kny.js";import{B as Z}from"./Button-DB5r_dXF.js";import{L as E}from"./Link-i4jYg0W7.js";import{b as ee,D as _,a as B}from"./DescriptionList-Cz3q2Mfs.js";import"./preload-helper-PPVm8Dsz.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-C1CxG1J6.js";import"./usePreviousValue-B-gSGwjc.js";import"./ChevronDownIcon-BXB8h9Rw.js";import"./Icon-BvCYJseA.js";import"./ChevronUpIcon-DF5ONCDk.js";import"./Pagination-C49jlr63.js";import"./IconButton-CU-4PVAZ.js";import"./ChevronLeftIcon-BeryDKQN.js";import"./ChevronRightIcon-DV2rweib.js";import"./NativeSelect-IagPT6d0.js";import"./valuePair-Bn6SadUn.js";import"./ArrowVerticalAnimated-BWPnfxJ1.js";import"./ArrowDownIcon-fu6qQCEM.js";import"./InputGroup-Dqr-u7Od.js";import"./Label-DvCgVV4-.js";import"./SupportLabel-Rzski8XH.js";import"./WarningIcon-CajCtnwA.js";import"./BaseTextInput-DL8dm1_a.js";import"./useListNavigation-DKgec-XY.js";import"./Loader-C4LBy92m.js";import"./useDelayedRender-BlEZZ8Ry.js";const D=n.forwardRef(({isOpen:d,onClick:r,children:l,className:f,id:b,"aria-controls":T,...p},k)=>{if(d===void 0||typeof r!="function")throw new Error("ExpandableTableRowController must have ExpandableTableRow as parent");const{collapseToList:i}=z(),w=p["data-th"],a=i?w:void 0;return e.jsx(x,{className:P("jkl-table-cell--expand",{"jkl-table-cell--expand-without-text":!l},f),...p,ref:k,children:e.jsx(G,{as:"button",className:P("jkl-table-row-expand-button",{"jkl-table-row-expand-button--expanded":d}),id:b,open:d,"aria-controls":T,"aria-label":l?void 0:w||"Ekspander rad",onClick:o=>{o.stopPropagation(),r()},onKeyDown:o=>{(o.key==="Enter"||o.key===" ")&&(o.stopPropagation(),o.preventDefault(),r())},children:l??a})})});D.displayName="ExpandableTableRowController";D.__docgenInfo={description:"",methods:[],displayName:"ExpandableTableRowController",props:{density:{required:!1,tsType:{name:"union",raw:'"comfortable" | "compact"',elements:[{name:"literal",value:'"comfortable"'},{name:"literal",value:'"compact"'}]},description:""},align:{required:!1,tsType:{name:"union",raw:'"left" | "center" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"center"'},{name:"literal",value:'"right"'}]},description:`Velg mellom venstrejustering og høyrejustering av innholdet. Typisk skal innholdet være venstrejustert, men for eksempel summer er høyrejustert.
