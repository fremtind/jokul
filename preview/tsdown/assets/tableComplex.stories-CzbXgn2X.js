import{r as n,j as e,R as I}from"./iframe-L6kck8Nc.js";import{c as P}from"./clsx-B-dksMZM.js";import{u as W}from"./useAnimatedHeight-DtiaWkK3.js";import{u as O}from"./useId-BK4xM_v4.js";import{E as G}from"./Expander-CZbkQ1C_.js";import{u as z,T as x,a as y,g as J,b as H,c as q,d as V,e as $,f as g}from"./_index-B0zEdAfl.js";import{T as K}from"./TableBody-BCgHTV5Q.js";import{T as Q}from"./TablePagination-Bq5HjCb5.js";import{u as U}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               *//* empty css               *//* empty css               *//* empty css               */import{T as X}from"./TextInput-C3CrMGir.js";import{S as Y}from"./Select-DYCXZwUg.js";import{B as Z}from"./Button-DQJNp4-C.js";import{L as E}from"./Link-lECGD6oo.js";import{b as ee,D as _,a as B}from"./DescriptionList-DSTcLeyT.js";import"./preload-helper-PPVm8Dsz.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-DRuz8LTU.js";import"./usePreviousValue-D_uyQGHU.js";import"./ChevronDownIcon-D-PzpEwB.js";import"./Icon-CznP8Z9Z.js";import"./ChevronUpIcon-DGass5BH.js";import"./Pagination-DQ03l_VP.js";import"./IconButton-DheyqwKl.js";import"./ChevronLeftIcon-B95lGiXX.js";import"./ChevronRightIcon-BVC0jFOd.js";import"./NativeSelect-BN0wRjWF.js";import"./valuePair-Bn6SadUn.js";import"./ArrowVerticalAnimated-BLMaiZu6.js";import"./ArrowDownIcon-CuEwOBZa.js";import"./InputGroup-B3-pjkt7.js";import"./Label-uq_umgy-.js";import"./SupportLabel-BpXidhZU.js";import"./WarningIcon-DEzVcHO6.js";import"./BaseTextInput-C5e3dQHT.js";import"./useListNavigation-k7I_iZkT.js";import"./Loader-BBUeA0-K.js";import"./useDelayedRender-DUrXZg6I.js";const D=n.forwardRef(({isOpen:d,onClick:r,children:l,className:f,id:b,"aria-controls":T,...p},k)=>{if(d===void 0||typeof r!="function")throw new Error("ExpandableTableRowController must have ExpandableTableRow as parent");const{collapseToList:i}=z(),w=p["data-th"],a=i?w:void 0;return e.jsx(x,{className:P("jkl-table-cell--expand",{"jkl-table-cell--expand-without-text":!l},f),...p,ref:k,children:e.jsx(G,{as:"button",className:P("jkl-table-row-expand-button",{"jkl-table-row-expand-button--expanded":d}),id:b,open:d,"aria-controls":T,"aria-label":l?void 0:w||"Ekspander rad",onClick:o=>{o.stopPropagation(),r()},onKeyDown:o=>{(o.key==="Enter"||o.key===" ")&&(o.stopPropagation(),o.preventDefault(),r())},children:l??a})})});D.displayName="ExpandableTableRowController";D.__docgenInfo={description:"",methods:[],displayName:"ExpandableTableRowController",props:{density:{required:!1,tsType:{name:"union",raw:'"comfortable" | "compact"',elements:[{name:"literal",value:'"comfortable"'},{name:"literal",value:'"compact"'}]},description:""},align:{required:!1,tsType:{name:"union",raw:'"left" | "center" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"center"'},{name:"literal",value:'"right"'}]},description:`Velg mellom venstrejustering og høyrejustering av innholdet. Typisk skal innholdet være venstrejustert, men for eksempel summer er høyrejustert.
