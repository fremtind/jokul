import{r as l,j as e,R as B}from"./iframe-Bgbk8A8w.js";import{c as y}from"./clsx-B-dksMZM.js";import{u as Z}from"./useAnimatedHeight-BqxoK_q1.js";import{u as H}from"./useId-BepAFXbc.js";import{E as ee}from"./Expander-DUD8zkVT.js";import{u as G,a as N,b as D,T as te,c as W,d as z,e as J,f as Q,g as C}from"./_index-Cp7qAxgf.js";import{T as U}from"./TableBody-Dhc11zA0.js";import{I as O}from"./IconButton-UmBYA40D.js";import{C as ne}from"./ChevronLeftIcon-B9MYEDpB.js";import{C as ae}from"./ChevronRightIcon-DqP_J_z8.js";import{N as re}from"./NativeSelect-CipHuor8.js";import{T as X}from"./TextInput-BhoIyTWd.js";import{u as se}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               *//* empty css               *//* empty css               *//* empty css               */import{S as le}from"./Select-BA2ZnMJ5.js";import{B as oe}from"./Button-Cz7PjLgP.js";import{L as F}from"./Link-C3qsOy_z.js";import{b as ie,D as K,a as q}from"./DescriptionList-DTP95JUj.js";import"./preload-helper-PPVm8Dsz.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-Dg2kYqDQ.js";import"./usePreviousValue-BC70uycc.js";import"./ChevronDownIcon-CNDuXVw4.js";import"./Icon-DESNu5Cp.js";import"./ChevronUpIcon-DRvSCVbE.js";import"./valuePair-Bn6SadUn.js";import"./ArrowVerticalAnimated-C3DJpyve.js";import"./ArrowDownIcon-BSczm2ks.js";import"./InputGroup-BmIcIgxw.js";import"./Label-Cs-HSq_H.js";import"./SupportLabel-BDO1ZkW6.js";import"./WarningIcon-BXDRy6cv.js";import"./BaseTextInput-DBKzpa5T.js";import"./useListNavigation-fLrqmSLu.js";import"./Loader-Dpw_LgPn.js";import"./useDelayedRender-Cq7ZvIjP.js";const E=l.forwardRef(({isOpen:i,onClick:t,children:n,className:o,id:f,"aria-controls":v,...u},w)=>{if(i===void 0||typeof t!="function")throw new Error("ExpandableTableRowController must have ExpandableTableRow as parent");const{collapseToList:p}=G(),m=u["data-th"],s=p?m:void 0;return e.jsx(N,{className:y("jkl-table-cell--expand",{"jkl-table-cell--expand-without-text":!n},o),...u,ref:w,children:e.jsx(ee,{as:"button",className:y("jkl-table-row-expand-button",{"jkl-table-row-expand-button--expanded":i}),id:f,open:i,"aria-controls":v,"aria-label":n?void 0:m||"Ekspander rad",onClick:b=>{b.stopPropagation(),t()},onKeyDown:b=>{(b.key==="Enter"||b.key===" ")&&(b.stopPropagation(),b.preventDefault(),t())},children:n??s})})});E.displayName="ExpandableTableRowController";E.__docgenInfo={description:"",methods:[],displayName:"ExpandableTableRowController",props:{density:{required:!1,tsType:{name:"union",raw:'"comfortable" | "compact"',elements:[{name:"literal",value:'"comfortable"'},{name:"literal",value:'"compact"'}]},description:""},align:{required:!1,tsType:{name:"union",raw:'"left" | "center" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"center"'},{name:"literal",value:'"right"'}]},description:`Velg mellom venstrejustering og høyrejustering av innholdet. Typisk skal innholdet være venstrejustert, men for eksempel summer er høyrejustert.
