import{r as l,j as e,R as B}from"./iframe-Cc8xX6xK.js";import{c as y}from"./clsx-B-dksMZM.js";import{u as Z}from"./useAnimatedHeight-CnQskcdm.js";import{u as H}from"./useId-CXWyAOZ8.js";import{E as ee}from"./Expander-DhNaPTXg.js";import{u as G,a as N,b as D,T as te,c as W,d as z,e as J,f as Q,g as C}from"./_index-qIA3ofvm.js";import{T as U}from"./TableBody-CngGLFwX.js";import{I as O}from"./IconButton-qhozIRBb.js";import{C as ne}from"./ChevronLeftIcon-BTpOSUZ7.js";import{C as ae}from"./ChevronRightIcon-DjAd7xuP.js";import{N as re}from"./NativeSelect-CxBwkiYy.js";import{T as X}from"./TextInput-CM1jAf9X.js";import{u as se}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               *//* empty css               *//* empty css               *//* empty css               */import{S as le}from"./Select-ClgvSssj.js";import{B as oe}from"./Button-BNWXP-aH.js";import{L as F}from"./Link-UppTuUDr.js";import{b as ie,D as K,a as q}from"./DescriptionList-CUlwMrfx.js";import"./preload-helper-PPVm8Dsz.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-BDneUgjZ.js";import"./usePreviousValue-CWB2JE3l.js";import"./ChevronDownIcon-r7nmwe0-.js";import"./Icon-BPCpfmLm.js";import"./ChevronUpIcon-DuIj97Qo.js";import"./valuePair-Bn6SadUn.js";import"./ArrowVerticalAnimated-78R6FsM7.js";import"./ArrowDownIcon-CSVfj_5v.js";import"./InputGroup-ET0RrVPh.js";import"./Label-BlTzyfBi.js";import"./SupportLabel-BosRvcV3.js";import"./WarningIcon-DgioOhn-.js";import"./BaseTextInput-BRuiNkKw.js";import"./useListNavigation-KmNgsixa.js";import"./Loader-BQ7ime7V.js";import"./useDelayedRender-CZKWXmRr.js";const E=l.forwardRef(({isOpen:i,onClick:t,children:n,className:o,id:f,"aria-controls":v,...u},w)=>{if(i===void 0||typeof t!="function")throw new Error("ExpandableTableRowController must have ExpandableTableRow as parent");const{collapseToList:p}=G(),m=u["data-th"],s=p?m:void 0;return e.jsx(N,{className:y("jkl-table-cell--expand",{"jkl-table-cell--expand-without-text":!n},o),...u,ref:w,children:e.jsx(ee,{as:"button",className:y("jkl-table-row-expand-button",{"jkl-table-row-expand-button--expanded":i}),id:f,open:i,"aria-controls":v,"aria-label":n?void 0:m||"Ekspander rad",onClick:b=>{b.stopPropagation(),t()},onKeyDown:b=>{(b.key==="Enter"||b.key===" ")&&(b.stopPropagation(),b.preventDefault(),t())},children:n??s})})});E.displayName="ExpandableTableRowController";E.__docgenInfo={description:"",methods:[],displayName:"ExpandableTableRowController",props:{density:{required:!1,tsType:{name:"union",raw:'"comfortable" | "compact"',elements:[{name:"literal",value:'"comfortable"'},{name:"literal",value:'"compact"'}]},description:""},align:{required:!1,tsType:{name:"union",raw:'"left" | "center" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"center"'},{name:"literal",value:'"right"'}]},description:`Velg mellom venstrejustering og høyrejustering av innholdet. Typisk skal innholdet være venstrejustert, men for eksempel summer er høyrejustert.
