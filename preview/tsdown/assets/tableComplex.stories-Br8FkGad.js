import{r as n,j as e,R as I}from"./iframe-R6aOaHTp.js";import{c as P}from"./clsx-B-dksMZM.js";import{u as W}from"./useAnimatedHeight-CvlOyteF.js";import{u as O}from"./useId-BUKv216K.js";import{E as G}from"./Expander-Go0dXI_H.js";import{u as z,T as x,a as y,g as J,b as H,c as q,d as V,e as $,f as g}from"./_index-DvmlmQUT.js";import{T as K}from"./TableBody-ClLcJdst.js";import{T as Q}from"./TablePagination-C5M_2vrz.js";import{u as U}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               *//* empty css               *//* empty css               *//* empty css               */import{T as X}from"./TextInput-BRRNG59a.js";import{S as Y}from"./Select-DA9OBP9M.js";import{B as Z}from"./Button-C0SOP0LI.js";import{L as E}from"./Link-BcUAr24T.js";import{b as ee,D as _,a as B}from"./DescriptionList-ek3yTIcg.js";import"./preload-helper-PPVm8Dsz.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-DL-fg1I9.js";import"./usePreviousValue-CCARFBdV.js";import"./ChevronDownIcon-C12FInFu.js";import"./Icon-C_eqd1IE.js";import"./ChevronUpIcon-fnpcaIO7.js";import"./Pagination-qjc5jISP.js";import"./IconButton-CFeFpgTl.js";import"./ChevronLeftIcon-Bu9kvmGc.js";import"./ChevronRightIcon-B6ZueDCh.js";import"./NativeSelect-DOjdW9Gg.js";import"./valuePair-Bn6SadUn.js";import"./ArrowVerticalAnimated-BPrNSXtA.js";import"./ArrowDownIcon-BTjL8Hh8.js";import"./InputGroup-CC2tJpd7.js";import"./Label-DcGKuD_n.js";import"./SupportLabel-BXNMeyuh.js";import"./WarningIcon-BajwyuyY.js";import"./BaseTextInput-Bp-ifYh-.js";import"./useListNavigation-xYUbo_Bt.js";import"./Loader-QOLoLy5_.js";import"./useDelayedRender-BujkK-5i.js";const D=n.forwardRef(({isOpen:d,onClick:r,children:l,className:f,id:b,"aria-controls":T,...p},k)=>{if(d===void 0||typeof r!="function")throw new Error("ExpandableTableRowController must have ExpandableTableRow as parent");const{collapseToList:i}=z(),w=p["data-th"],a=i?w:void 0;return e.jsx(x,{className:P("jkl-table-cell--expand",{"jkl-table-cell--expand-without-text":!l},f),...p,ref:k,children:e.jsx(G,{as:"button",className:P("jkl-table-row-expand-button",{"jkl-table-row-expand-button--expanded":d}),id:b,open:d,"aria-controls":T,"aria-label":l?void 0:w||"Ekspander rad",onClick:o=>{o.stopPropagation(),r()},onKeyDown:o=>{(o.key==="Enter"||o.key===" ")&&(o.stopPropagation(),o.preventDefault(),r())},children:l??a})})});D.displayName="ExpandableTableRowController";D.__docgenInfo={description:"",methods:[],displayName:"ExpandableTableRowController",props:{density:{required:!1,tsType:{name:"union",raw:'"comfortable" | "compact"',elements:[{name:"literal",value:'"comfortable"'},{name:"literal",value:'"compact"'}]},description:""},align:{required:!1,tsType:{name:"union",raw:'"left" | "center" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"center"'},{name:"literal",value:'"right"'}]},description:`Velg mellom venstrejustering og høyrejustering av innholdet. Typisk skal innholdet være venstrejustert, men for eksempel summer er høyrejustert.
