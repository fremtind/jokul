import{j as e,r as k}from"./iframe-BrNtw50k.js";import{a as p,T as c,s as b,f as T}from"./_index-CZgG51cb.js";import{b as h,a as f,c as x,T as y}from"./TableHeader-B6cGNxCT.js";import{T as g}from"./TableBody-B9ZR4qY8.js";import{c as j}from"./paginated-table-data-ZMeh4d0Y.js";import{u as B}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               */import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./ChevronDownIcon-DXycLckL.js";import"./Icon-5AbHA9Gm.js";import"./ChevronUpIcon-Crx8VH-M.js";const P={title:"Komponenter/Table",component:y,subcomponents:{TableCaption:x,TableHead:f,TableHeader:h,TableBody:g,TableRow:c,TableCell:p}},d={name:"Table",args:{collapseToList:!0,fullWidth:!0,caption:e.jsx(x,{srOnly:!0,children:"Overskrift for skjermlesere"}),children:""},render:u=>e.jsx("div",{style:{width:"90dvw"},children:e.jsxs(y,{...u,children:[e.jsx(f,{sticky:!0,children:e.jsx(c,{children:b.columns.map((a,s)=>e.jsx(h,{bold:!0,children:a},s))})}),e.jsx(g,{children:b.rows.map((a,s)=>e.jsx(c,{children:a.map((l,i)=>e.jsx(p,{"data-th":b.columns[i],align:[1,2].includes(i)?"right":"left",children:l},i))},s))})]})})},m={name:"useSortableTableHeader",args:{caption:e.jsx(x,{srOnly:!0,children:"Overskrift for skjermlesere"}),children:""},render:u=>{const[a,s]=k.useState(T.columns[0]),[l,i]=k.useState("desc"),w=(r,t)=>{s(r),i(t)},{getSortProps:S}=B(a,l,w);return e.jsxs(y,{caption:u.caption,fullWidth:!0,children:[e.jsx(f,{sticky:!0,children:e.jsx(c,{children:T.columns.slice(0,4).map((r,t)=>e.jsx(h,{bold:!0,...S(r),children:r},t))})}),e.jsx(g,{children:T.rows.sort((r,t)=>{if(a==="Forfallsdato"){const o=new Date(r[0]).getTime(),n=new Date(t[0]).getTime();return l==="asc"?o-n:n-o}if(a==="Beløp"){const o=Number(r[2]),n=Number(t[2]);return l==="asc"?o-n:n-o}return 0}).map((r,t)=>e.jsx(c,{children:r.slice(0,4).map((o,n)=>e.jsx(p,{"data-th":j[n],align:[1,2].includes(n)?"right":"left",children:o.toLocaleString()},n))},t))})]})}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  name: "Table",
  args: {
    collapseToList: true,
    fullWidth: true,
