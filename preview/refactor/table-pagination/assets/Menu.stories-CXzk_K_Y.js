...
@default false`},onToggle:{required:!1,tsType:{name:"signature",type:"function",raw:"(isOpen: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"isOpen"}],return:{name:"void"}}},description:"Callback som kalles når menyen åpnes eller lukkes."}},composes:["Omit"]};const $e={title:"Komponenter/Menu/Menu",component:k,parameters:{layout:"centered"},tags:["autodocs"]},v={argTypes:{isOpen:{control:{disable:!0}}},args:{triggerElement:e.jsx(J,{variant:"ghost",icon:e.jsx(ve,{bold:!0}),iconPosition:"right","data-testid":"open-menu",children:"Meny"}),keepOpenOnClickOutside:!1,children:e.jsxs(e.Fragment,{children:[e.jsx(l,{as:"a",href:"#forsikringene-dine",children:"Forsikringene dine"}),e.jsx(l,{as:"a",href:"#meld-skade",children:"Meld skade"}),e.jsx(l,{as:"a",href:"#skadesakene-dine",children:"Skadesakene dine"}),e.jsxs(k,{triggerElement:e.jsx(l,{expandable:!0,children:"Skjemaoppgaver"}),children:[e.jsx(l,{as:"a",href:"#flytte-forsikring",children:"Flytte forsikring"}),e.jsx(l,{as:"a",href:"#endre-forsikring",children:"Endre forsikring"}),e.jsx(l,{as:"a",href:"#oppsigelse",children:"Oppsigelse av forsikring"})]}),e.jsx(l,{as:"a",href:"#kontakt-oss",children:"Kontakt oss"})]})},render:({isOpen:t,...n})=>e.jsx(k,{...n})};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  argTypes: {
    isOpen: {
      control: {
        disable: true
