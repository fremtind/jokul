import{j as e}from"./iframe-CQxc51jJ.js";import{L as h,F as i,t as x}from"./Flex-DcxXERvY.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./SlotComponent-CW46vavE.js";import"./mergeRefs-pfJQRkXq.js";const p=l=>l.flatMap(n=>[n,...l.filter(r=>r!==n).map(r=>`${n} ${r}`)]),u=p(Object.keys(x.semanticSpacing)),m=p(Object.keys(x.staticSpacing)),v=[...u,...m],w={title:"Komponenter/Flex",component:i,argTypes:{children:{description:"`React.ReactNode`"},layout:{control:"select",options:[...h,"{ small: '1', medium: '2', large: '4' }",'{ small: "1", medium: "auto" }'],mapping:{"{ small: '1', medium: '2', large: '4' }":{small:"1",medium:"2",large:"4"},'{ small: "1", medium: "auto" }':{small:"1",medium:"auto"}},description:`Sets layout for items per row.
