import{j as e}from"./iframe-CWu2Kwvd.js";import{L as h,F as i,t as x}from"./Flex-senEy_2m.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./SlotComponent-Da4_sNSd.js";import"./mergeRefs-2ASujW6F.js";const p=l=>l.flatMap(n=>[n,...l.filter(r=>r!==n).map(r=>`${n} ${r}`)]),u=p(Object.keys(x.semanticSpacing)),m=p(Object.keys(x.staticSpacing)),v=[...u,...m],w={title:"Komponenter/Flex",component:i,argTypes:{children:{description:"`React.ReactNode`"},layout:{control:"select",options:[...h,"{ small: '1', medium: '2', large: '4' }",'{ small: "1", medium: "auto" }'],mapping:{"{ small: '1', medium: '2', large: '4' }":{small:"1",medium:"2",large:"4"},'{ small: "1", medium: "auto" }':{small:"1",medium:"auto"}},description:`Sets layout for items per row.
...
}`,...c.parameters?.docs?.source}}};const F=["Default","Responsive","Nested","Fill","Center"];export{c as Center,s as Default,o as Fill,a as Nested,t as Responsive,F as __namedExportsOrder,w as default};
