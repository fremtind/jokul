import{j as e,r as k}from"./iframe-eu7EW-jD.js";import{a as p,T as c,s as b,f as T}from"./_index-CM1BSwZ_.js";import{c as h,b as f,a as x,d as y,T as g}from"./TableHeader-CFwlKOtQ.js";import{c as j}from"./paginated-table-data-ZMeh4d0Y.js";import{u as B}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               */import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./ChevronDownIcon-BFeflM5A.js";import"./Icon-kXuHUYXu.js";import"./ChevronUpIcon-CrrcorY1.js";const K={title:"Komponenter/Table",component:g,subcomponents:{TableCaption:y,TableHead:x,TableHeader:f,TableBody:h,TableRow:c,TableCell:p}},d={name:"Table",args:{collapseToList:!0,fullWidth:!0,caption:e.jsx(y,{srOnly:!0,children:"Overskrift for skjermlesere"}),children:""},render:u=>e.jsx("div",{style:{width:"90dvw"},children:e.jsxs(g,{...u,children:[e.jsx(x,{sticky:!0,children:e.jsx(c,{children:b.columns.map((a,o)=>e.jsx(f,{bold:!0,children:a},o))})}),e.jsx(h,{children:b.rows.map((a,o)=>e.jsx(c,{children:a.map((l,i)=>e.jsx(p,{"data-th":b.columns[i],align:[1,2].includes(i)?"right":"left",children:l},i))},o))})]})})},m={name:"useSortableTableHeader",args:{caption:e.jsx(y,{srOnly:!0,children:"Overskrift for skjermlesere"}),children:""},render:u=>{const[a,o]=k.useState(T.columns[0]),[l,i]=k.useState("desc"),w=(r,t)=>{o(r),i(t)},{getSortProps:S}=B(a,l,w);return e.jsxs(g,{caption:u.caption,fullWidth:!0,children:[e.jsx(x,{sticky:!0,children:e.jsx(c,{children:T.columns.slice(0,4).map((r,t)=>e.jsx(f,{bold:!0,...S(r),children:r},t))})}),e.jsx(h,{children:T.rows.sort((r,t)=>{if(a==="Forfallsdato"){const s=new Date(r[0]).getTime(),n=new Date(t[0]).getTime();return l==="asc"?s-n:n-s}if(a==="Beløp"){const s=Number(r[2]),n=Number(t[2]);return l==="asc"?s-n:n-s}return 0}).map((r,t)=>e.jsx(c,{children:r.slice(0,4).map((s,n)=>e.jsx(p,{"data-th":j[n],align:[1,2].includes(n)?"right":"left",children:s.toLocaleString()},n))},t))})]})}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  name: "Table",
  args: {
    collapseToList: true,
    fullWidth: true,
