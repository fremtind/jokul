import{R as h,j as e}from"./iframe-Cru4whJ1.js";import{c as k}from"./clsx-B-dksMZM.js";import{S as j}from"./SlotComponent-DMhw6AiB.js";import{I as v}from"./Image-DLQ0566z.js";import{C as a}from"./Card-BuStFPNz.js";import{F as r}from"./Flex-BKOYqa_s.js";import{C as F}from"./CheckIcon-Dvp76pVv.js";import{C as b}from"./CopyIcon-DWkQBc4l.js";import"./preload-helper-PPVm8Dsz.js";import"./mergeRefs-CPYnfmWS.js";import"./tokens-d2GYn7oW.js";import"./Icon-Dpt06_Dx.js";const g=h.forwardRef(function({as:c,asChild:s,className:p,placement:m="top",...f},x){const C=s?j:c||"img";return e.jsx(C,{ref:x,className:k("jkl-card-image",`jkl-card-image--${m}`,p),...f})});g.__docgenInfo={description:"Bildekomponent som kan brukes i `Card` for å sørge for at bildet\nblør helt ut i kantene av kortet. Rendres normalt som et `<img>`-\nelement, men du kan overstyre dette med `as` dersom du f.eks. har\nen egen komponent for å håndtere responsive bilder.",methods:[],displayName:"CardImage",props:{as:{required:!1,tsType:{name:"ElementType"},description:`Her kan du angi hva slags element komponenten skal rendres
