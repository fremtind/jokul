import{R as h,j as e}from"./iframe-G8YrbEwB.js";import{c as k}from"./clsx-B-dksMZM.js";import{S as j}from"./SlotComponent-CvYv5Kkj.js";import{I as v}from"./Image-CG8N1qLY.js";import{C as a}from"./Card-BPU2CnM2.js";import{F as r}from"./Flex-D-HTOBpw.js";import{C as F}from"./CheckIcon-D87YbEcB.js";import{C as b}from"./CopyIcon-B_aV-rEe.js";import"./preload-helper-PPVm8Dsz.js";import"./mergeRefs-e1MV8EOw.js";import"./tokens-d2GYn7oW.js";import"./Icon-2iH_OLKZ.js";const g=h.forwardRef(function({as:c,asChild:s,className:p,placement:m="top",...f},x){const C=s?j:c||"img";return e.jsx(C,{ref:x,className:k("jkl-card-image",`jkl-card-image--${m}`,p),...f})});g.__docgenInfo={description:"Bildekomponent som kan brukes i `Card` for å sørge for at bildet\nblør helt ut i kantene av kortet. Rendres normalt som et `<img>`-\nelement, men du kan overstyre dette med `as` dersom du f.eks. har\nen egen komponent for å håndtere responsive bilder.",methods:[],displayName:"CardImage",props:{as:{required:!1,tsType:{name:"ElementType"},description:`Her kan du angi hva slags element komponenten skal rendres
