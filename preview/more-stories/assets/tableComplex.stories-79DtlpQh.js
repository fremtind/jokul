import{r as s,j as e}from"./iframe-Cru4whJ1.js";import{b as J,u as Q,a as y,T as R,f as T}from"./_index-DELco7Vs.js";import{a as U,E as X}from"./ExpandableTableRow-CeO9M-3Y.js";import{c as M,b as V,a as K,d as G,T as W}from"./TableHeader-Bh7ViHaq.js";import{c as L}from"./clsx-B-dksMZM.js";import{u as Y}from"./useId-ycqqCLmD.js";import{I as H}from"./IconButton-BC--l0Hd.js";import{C as Z}from"./ChevronLeftIcon-B7dyJu2x.js";import{C as ee}from"./ChevronRightIcon-BadtE584.js";import{N as te}from"./NativeSelect-DL703G6c.js";import{T as O}from"./TextInput-BLiC-a-q.js";import{u as ne}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               *//* empty css               *//* empty css               *//* empty css               */import{S as ae}from"./Select-DIgb6OY2.js";import{B as re}from"./Button-DwcLJ3dY.js";import{L as A}from"./Link-y6P4Ef93.js";import{b as se,D as $,a as E}from"./DescriptionList-DfctJU3p.js";import"./preload-helper-PPVm8Dsz.js";import"./useAnimatedHeight-JSgFg-Nh.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-D5bp6lLa.js";import"./usePreviousValue-usPQ3-Cp.js";import"./Expander-CUyazp1K.js";import"./ChevronDownIcon-CtW5Z0Yt.js";import"./Icon-Dpt06_Dx.js";import"./ChevronUpIcon-C1NcOu10.js";import"./valuePair-Bn6SadUn.js";import"./ArrowVerticalAnimated-Dd9FVFV5.js";import"./ArrowDownIcon-oBoi-m2o.js";import"./InputGroup-CdA43xN6.js";import"./Label-DvWgDWI6.js";import"./SupportLabel-DEQQx1e1.js";import"./WarningIcon-Br93SZNJ.js";import"./BaseTextInput-DpJOvhAG.js";import"./useListNavigation-Dlh7A4x6.js";import"./Loader-D4vdKdzs.js";import"./useDelayedRender-K7Gcz6g2.js";const F=s.forwardRef(({className:g,...n},a)=>e.jsx(J,{state:{isTableHead:!1,isTableBody:!1,isTableFooter:!0},children:e.jsx("tfoot",{className:L("jkl-table-foot",g),...n,ref:a})}));F.displayName="TableFooter";F.__docgenInfo={description:"",methods:[],displayName:"TableFooter",composes:["HTMLAttributes"]};function le(g,n,a){return n<g?g:n>a?a:n}const q=s.forwardRef((g,n)=>{const{activePage:a=0,totalNumberOfRows:c,rowsPerPage:b,rowsPerPageItems:P,className:f,density:x,id:w,withGoToPage:h=!1,onChange:l,onChangeRowsPerPage:S,labels:d={rowsPerPage:"Rader per side",previous:"Forrige",next:"Neste"},...C}=g,k=Y(w||"jkl-table-pagination",{generateSuffix:!w}),{density:I}=Q(),j=b<=0?1:Math.ceil(c/b),[r,t]=s.useState(le(0,a,j-1)),m=s.useCallback(i=>{const o=Number.parseInt(i.currentTarget.dataset.number);l(i,o,r),t(o),u(String(o+1))},[l,r]),[p,u]=s.useState(String(r+1)),B=s.useCallback(i=>{u(i.target.value);try{const o=Number.parseInt(i.target.value)-1;if(Number.isNaN(o))return;o>=0&&o<j&&(l(i,o,r),t(o))}catch{return}},[l,r,j]),_=s.useCallback(i=>{if(r===0){l(i,r,r);return}const o=r-1;l(i,o,r),t(o),u(String(o+1))},[l,r]),z=s.useCallback(i=>{if(r===j-1){l(i,r,r);return}const o=r+1;l(i,o,r),t(o),u(String(o+1))},[l,j,r]);return e.jsxs("div",{className:L("jkl-table-pagination",f),...C,id:k,"data-density":x||I,ref:n,children:[e.jsx("div",{className:"jkl-table-pagination__left",children:e.jsxs("div",{className:"jkl-table-pagination__picker jkl-table-pagination__picker--rows",children:[e.jsxs("span",{className:"jkl-table-pagination__picker-label","aria-hidden":"true",children:[d.rowsPerPage,":"]}),e.jsx(te,{className:"jkl-table-pagination__picker-input",label:d.rowsPerPage,labelProps:{srOnly:!0},name:`${k}-rows-per-page`,items:P.map(i=>typeof i=="number"?String(i):{label:i.label,value:String(i.value)}),value:String(b),onChange:S,width:"min(8rem, 100%)",inline:!0})]})}),e.jsxs("span",{className:"jkl-table-pagination__total-rows",children:["Treff: ",c]}),e.jsx("div",{className:"jkl-table-pagination__right",children:j!==1&&e.jsxs("nav",{className:"jkl-table-pagination__nav",children:[h&&e.jsxs("div",{className:"jkl-table-pagination__picker jkl-table-pagination__picker--page",children:[e.jsxs("span",{className:"jkl-table-pagination__picker-label","aria-hidden":"true",children:[typeof h=="object"?h.gotoLabel:"Gå til side",":"]}),e.jsx(O,{className:"jkl-table-pagination__picker-input",label:typeof h=="object"?h.gotoLabel:"Gå til side",labelProps:{srOnly:!0},name:`${k}-go-to-page`,value:p,width:"min(4rem, 100%)",onChange:B,"aria-invalid":p&&p!==String(r+1)?"true":void 0})]}),e.jsxs("ul",{children:[e.jsx("li",{children:e.jsx(H,{className:"jkl-table-pagination__previous",title:d.previous,onClick:_,children:e.jsx(Z,{})})}),e.jsx(ie,{id:k,activePage:a,numberOfPages:j,onPageClick:m}),e.jsx("li",{children:e.jsx(H,{className:"jkl-table-pagination__next",title:d.next,onClick:z,children:e.jsx(ee,{})})})]})]})})]})}),ie=({id:g,activePage:n,numberOfPages:a,onPageClick:c})=>{if(a<=7)return e.jsx(e.Fragment,{children:Array.from({length:a}).map((S,d)=>e.jsx("li",{children:e.jsx("button",{className:L("jkl-table-pagination__page",{"jkl-table-pagination__page--active":n===d}),type:"button","data-number":d,onClick:c,children:d+1})},`${g}-page-${d}`))});const b=n>3&&a>7,P=n<a-4&&a>7,f=Math.min(Math.max(n-2,1),a-6),x=Math.min(f+1,a-5),w=Math.min(x+1,a-4),h=Math.min(x+2,a-3),l=Math.min(x+3,a-2);return e.jsxs(e.Fragment,{children:[e.jsx("li",{children:e.jsx(v,{isActive:n===0,number:0,onClick:c})}),e.jsx("li",{children:b?e.jsx("span",{className:"jkl-table-pagination__ellipsis","aria-hidden":!0,children:"..."}):e.jsx(v,{isActive:n===f,number:f,onClick:c})}),e.jsx("li",{children:e.jsx(v,{isActive:n===x,number:x,onClick:c})}),e.jsx("li",{children:e.jsx(v,{isActive:n===w,number:w,onClick:c})}),e.jsx("li",{children:e.jsx(v,{isActive:n===h,number:h,onClick:c})}),e.jsx("li",{children:P?e.jsx("span",{className:"jkl-table-pagination__ellipsis","aria-hidden":!0,children:"..."}):e.jsx(v,{isActive:n===l,number:l,onClick:c})}),e.jsx("li",{children:e.jsx(v,{isActive:n===a-1,number:a-1,onClick:c})})]})},v=({isActive:g,number:n,onClick:a,...c})=>e.jsx("button",{className:L("jkl-table-pagination__page",{"jkl-table-pagination__page--active":g}),type:"button","data-number":n,onClick:a,...c,children:n+1});q.displayName="TablePagination";q.__docgenInfo={description:"",methods:[],displayName:"TablePagination",props:{className:{required:!1,tsType:{name:"string"},description:""},id:{required:!1,tsType:{name:"string"},description:""},density:{required:!1,tsType:{name:"union",raw:'"comfortable" | "compact"',elements:[{name:"literal",value:'"comfortable"'},{name:"literal",value:'"compact"'}]},description:""},activePage:{required:!1,tsType:{name:"number"},description:"@default 0"},rowsPerPage:{required:!0,tsType:{name:"number"},description:'Null eller negativt tall tolkes som "vis alle".'},rowsPerPageItems:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:"number | { label: string; value: number }",elements:[{name:"number"},{name:"signature",type:"object",raw:"{ label: string; value: number }",signature:{properties:[{key:"label",value:{name:"string",required:!0}},{key:"value",value:{name:"number",required:!0}}]}}]}],raw:"Array<number | { label: string; value: number }>"},description:""},totalNumberOfRows:{required:!0,tsType:{name:"number"},description:""},withGoToPage:{required:!1,tsType:{name:"union",raw:"boolean | { gotoLabel: string }",elements:[{name:"boolean"},{name:"signature",type:"object",raw:"{ gotoLabel: string }",signature:{properties:[{key:"gotoLabel",value:{name:"string",required:!0}}]}}]},description:`Viser et valgfritt inputfelt for å hoppe raskt til en spesifik side.
...
}`,...N.parameters?.docs?.source}}};const Ue=["TableComplex"];export{N as TableComplex,Ue as __namedExportsOrder,Qe as default};
