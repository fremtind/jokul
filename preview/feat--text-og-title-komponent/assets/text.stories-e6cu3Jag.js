import{r as b,j as e}from"./iframe-BJKLVHBW.js";/* empty css               *//* empty css               *//* empty css               */import{c as z}from"./clsx-B-dksMZM.js";import{L as p}from"./Link-BdlRv3jD.js";import{L as v,a as d,O as y,b as o}from"./ListItem-BAr3fAOi.js";import"./preload-helper-PPVm8Dsz.js";const r=b.forwardRef(function({as:k,className:u,size:g,bold:x,tight:h,srOnly:f,...T},j){const L=k||"p";return e.jsx(L,{className:z("jkl-text",f&&"jkl-sr-only",u),"data-text-size":g,"data-bold":x||void 0,"data-tight":h||void 0,ref:j,...T})});r.__docgenInfo={description:"",methods:[],displayName:"Text",props:{as:{required:!1,tsType:{name:"ElementType"},description:`Her kan du angi hva slags element komponenten skal rendres
