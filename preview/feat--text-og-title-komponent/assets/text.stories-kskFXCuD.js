...
}`,...a.parameters?.docs?.source},description:{story:"Nummerert liste med `OrderedList` — nyttig når rekkefølgen betyr noe.",...a.parameters?.docs?.description}}};const K=["Default","SizeScale","BoldOgTight","Brødtekst","InlineElementer","MedListe","KunForSkjermleser","NummerertListe"];export{n as BoldOgTight,c as Brødtekst,l as Default,s as InlineElementer,i as KunForSkjermleser,t as MedListe,a as NummerertListe,m as SizeScale,K as __namedExportsOrder,R as default};
