import{r as g,j as e}from"./iframe-D8skWxng.js";import{F as i}from"./Flex-D4TQdaoT.js";/* empty css               *//* empty css               */import{c as u}from"./clsx-B-dksMZM.js";import"./preload-helper-PPVm8Dsz.js";import"./SlotComponent-CyzULi7I.js";import"./mergeRefs-mwfphkx9.js";const s=g.forwardRef(function({className:o,size:m="xl",as:c,srOnly:x,...h},p){const k=c||"h2";return e.jsx(k,{className:u("jkl-title",x&&"jkl-sr-only",o),"data-text-size":m,ref:p,...h})});s.__docgenInfo={description:"",methods:[],displayName:"Title",props:{as:{required:!1,tsType:{name:"ElementType"},description:`Her kan du angi hva slags element komponenten skal rendres
