import{r as L,j as e}from"./iframe-DZBSsJnD.js";/* empty css               *//* empty css               *//* empty css               */import{c as v}from"./clsx-B-dksMZM.js";import{L as c}from"./Link-Dz1XH6nE.js";import{L as y,a as m,O as z,b as p}from"./ListItem-BuZaFTnA.js";import"./preload-helper-PPVm8Dsz.js";const r=L.forwardRef(function({as:k,className:u,size:g,bold:x,short:f,srOnly:h,...T},j){const b=k||"p";return e.jsx(b,{className:v("jkl-text",h&&"jkl-sr-only",u),"data-text-size":g,"data-bold":x||void 0,"data-short":f||void 0,ref:j,...T})});r.__docgenInfo={description:"",methods:[],displayName:"Text",props:{as:{required:!1,tsType:{name:"ElementType"},description:`Her kan du angi hva slags element komponenten skal rendres
