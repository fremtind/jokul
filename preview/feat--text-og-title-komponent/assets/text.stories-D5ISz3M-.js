import{j as e}from"./iframe-Bq_zWpjG.js";import{T as r}from"./_index-Ce5w3Yyu.js";/* empty css               *//* empty css               */import{L as k}from"./Link-DscC3Ej1.js";import{L as x,a as c,O as g,b as p}from"./ListItem-CU9y3OMc.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";const y={title:"Komponenter/Typografi/Text",component:r,args:{bold:!1,srOnly:!1,short:!1,size:"m",children:"Fremtind er ett av Norges største forsikringsselskap og står for nær en femtedel av det totale skadeforsikringsmarkedet."},argTypes:{size:{control:"radio",options:["xs","s","m","l"],description:"Visuell størrelse.",table:{defaultValue:{summary:"m"},type:{summary:'"xs" | "s" | "m" | "l"'}}},bold:{control:"boolean",description:"Uthever teksten (font-weight: bold).",table:{defaultValue:{summary:"false"}}},short:{control:"boolean",description:"Tettere linjehøyde. Bruk når teksten i all hovedsak går over én linje (f.eks. i tabellceller eller knapper).",table:{defaultValue:{summary:"false"}}},srOnly:{control:"boolean",description:"Skjuler elementet visuelt, men beholder det for skjermlesere.",table:{defaultValue:{summary:"false"}}},as:{control:"select",options:["p","span","label","small","strong","em","code","kbd","samp","var"],description:"Hvilket HTML-element Text rendres som. Begrenset til typografisk relevante inline-elementer og <p>.",table:{defaultValue:{summary:"p"},type:{summary:'"p" | "span" | "label" | "small" | "strong" | "em" | "code" | "kbd" | "samp" | "var"'}}},className:{control:"text",description:"Ekstra klassenavn som legges til i tillegg til `jkl-text`.",table:{type:{summary:"string"}}}},tags:["autodocs","grouping content"]},s={},t={parameters:{controls:{disable:!0},docs:{source:{code:`<Text size="xs">Fontstørrelse xs</Text>
...
</List>`}}},render:()=>e.jsxs(e.Fragment,{children:[e.jsx(r,{children:"I arbeidet med bærekraft prioriterer Fremtind:"}),e.jsxs(x,{children:[e.jsx(c,{children:e.jsx(r,{as:"span",children:"Klimagassutslipp og ressursbruk"})}),e.jsx(c,{children:e.jsx(r,{as:"span",children:"Fysisk klimarisiko og skadeforebygging"})}),e.jsx(c,{children:e.jsx(r,{as:"span",children:"Ansvarlighet i verdikjeden"})}),e.jsx(c,{children:e.jsx(r,{as:"span",children:"Helse og forebygging"})})]})]})},d={parameters:{controls:{disable:!0},docs:{source:{code:`<Text>
    Last ned{" "}
...
</OrderedList>`}}},render:()=>e.jsxs(e.Fragment,{children:[e.jsx(r,{children:"Slik kommer du i gang:"}),e.jsxs(g,{children:[e.jsx(p,{children:e.jsx(r,{as:"span",children:"Logg inn på Min side i banken din"})}),e.jsx(p,{children:e.jsx(r,{as:"span",children:"Velg Meld skade fra menyen"})}),e.jsx(p,{children:e.jsx(r,{as:"span",children:"Velg forsikringen det gjelder og følg veiviseren"})})]})]})};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:"{}",...s.parameters?.docs?.source},description:{story:"Default-tilstand. Lek gjerne med propsene i kontrollpanelet for å se\nhvordan `size`, `bold`, `short`, `srOnly` og `as` påvirker resultatet.",...s.parameters?.docs?.description}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  parameters: {
    controls: {
      disable: true
    },
