...
}`,...a.parameters?.docs?.source},description:{story:"Bruk `as` til å rendre Text som semantiske inline-elementer som\n`strong`, `em`, `kbd` og `code`.",...a.parameters?.docs?.description}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  render: () => <>
...
}`,...l.parameters?.docs?.source},description:{story:'Bruk `Text` sammen med liste-komponentene (`List`, `OrderedList`,\n`ListItem`, `CheckListItem`) fremfor å sende `as="ul"` til Text.',...l.parameters?.docs?.description}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  render: () => <Text as="p" size="medium">
            Last ned{" "}
...
}`,...o.parameters?.docs?.source},description:{story:"Nummerert liste med `OrderedList` — nyttig når rekkefølgen betyr noe.",...o.parameters?.docs?.description}}};const H=["Default","SizeScale","BoldOgShort","Brødtekst","InlineElementer","MedListe","KunForSkjermleser","NummerertListe"];export{t as BoldOgShort,i as Brødtekst,s as Default,a as InlineElementer,d as KunForSkjermleser,l as MedListe,o as NummerertListe,n as SizeScale,H as __namedExportsOrder,V as default};
