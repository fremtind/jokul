import{r as L,j as e}from"./iframe-NfZ23ZEj.js";/* empty css               *//* empty css               *//* empty css               */import{c as v}from"./clsx-B-dksMZM.js";import{L as k}from"./Link-B7SdzCtB.js";import{L as z,a as p,O as F,b as c}from"./ListItem-Bgc8otsU.js";import"./preload-helper-PPVm8Dsz.js";const r=L.forwardRef(function({as:u,className:g,size:x,bold:f,short:h,srOnly:b,...T},j){const y=u||"p";return e.jsx(y,{className:v("jkl-text",b&&"jkl-sr-only",g),"data-text-size":x,"data-bold":f||void 0,"data-short":h||void 0,ref:j,...T})});r.__docgenInfo={description:"",methods:[],displayName:"Text",props:{as:{required:!1,tsType:{name:"ElementType"},description:`Her kan du angi hva slags element komponenten skal rendres
