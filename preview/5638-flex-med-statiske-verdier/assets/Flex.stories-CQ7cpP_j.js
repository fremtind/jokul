import{j as e}from"./iframe-DjRU5Cma.js";import{t as m}from"./tokens-d2GYn7oW.js";import{L as p,F as i}from"./Flex-D1QA1Uzy.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./SlotComponent-nBPyP3SV.js";import"./mergeRefs-CRv-kfT-.js";const x=Object.keys(m.semanticSpacing),h=x.flatMap(l=>[l,...x.filter(n=>l!==n).map(n=>`${l} ${n}`)]),C={title:"Komponenter/Flex",component:i,argTypes:{children:{description:"`React.ReactNode`"},layout:{control:"select",options:[...p,"{ small: '1', medium: '2', large: '4' }",'{ small: "1", medium: "auto" }'],mapping:{"{ small: '1', medium: '2', large: '4' }":{small:"1",medium:"2",large:"4"},'{ small: "1", medium: "auto" }':{small:"1",medium:"auto"}},description:`Sets layout for items per row.
