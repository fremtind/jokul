import{j as e}from"./iframe-ieofgYFi.js";import{t as x}from"./tokens-CMcKomMy.js";import{L as u,F as i}from"./Flex-De0HPn7F.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./SlotComponent-BmU8Ry5J.js";import"./mergeRefs-DSxygX1Z.js";const p=l=>l.flatMap(n=>[n,...l.filter(r=>r!==n).map(r=>`${n} ${r}`)]),m=p(Object.keys(x.semanticSpacing)),h=p(Object.keys(x.spacing)),v=[...m,...h],F={title:"Komponenter/Flex",component:i,argTypes:{children:{description:"`React.ReactNode`"},layout:{control:"select",options:[...u,"{ small: '1', medium: '2', large: '4' }",'{ small: "1", medium: "auto" }'],mapping:{"{ small: '1', medium: '2', large: '4' }":{small:"1",medium:"2",large:"4"},'{ small: "1", medium: "auto" }':{small:"1",medium:"auto"}},description:`Sets layout for items per row.
