import{j as e}from"./iframe-Df_g0_Xe.js";import{t as m}from"./tokens-d2GYn7oW.js";import{L as p,F as i}from"./Flex-BUvdgcPt.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./SlotComponent-CwSI_V6u.js";import"./mergeRefs-BTUP9AfP.js";const x=Object.keys(m.semanticSpacing),h=x.flatMap(l=>[l,...x.filter(n=>l!==n).map(n=>`${l} ${n}`)]),C={title:"Komponenter/Flex",component:i,argTypes:{children:{description:"`React.ReactNode`"},layout:{control:"select",options:[...p,"{ small: '1', medium: '2', large: '4' }",'{ small: "1", medium: "auto" }'],mapping:{"{ small: '1', medium: '2', large: '4' }":{small:"1",medium:"2",large:"4"},'{ small: "1", medium: "auto" }':{small:"1",medium:"auto"}},description:`Sets layout for items per row.
...
}`,...o.parameters?.docs?.source}}};const w=["Default","Responsive","Nested","Fill","Center"];export{o as Center,d as Default,a as Fill,t as Nested,s as Responsive,w as __namedExportsOrder,C as default};
