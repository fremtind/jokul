import{r as l,j as e,R as B}from"./iframe-BkUFrIqG.js";import{c as y}from"./clsx-B-dksMZM.js";import{u as Z}from"./useAnimatedHeight-aieWVQWb.js";import{u as H}from"./useId-Cwv6dpQ-.js";import{E as ee}from"./Expander-BlW-J6sR.js";import{u as G,a as N,b as D,T as te,c as W,d as z,e as J,f as Q,g as C}from"./_index-BMQHbYJJ.js";import{T as U}from"./TableBody-BHl2_Rp6.js";import{I as O}from"./IconButton-C_dLh9xf.js";import{C as ne}from"./ChevronLeftIcon-V2CahZG_.js";import{C as ae}from"./ChevronRightIcon-B1cDo4Fv.js";import{N as re}from"./NativeSelect-E6DS-s2Z.js";import{T as X}from"./TextInput-BrnC4kcN.js";import{u as se}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               *//* empty css               *//* empty css               *//* empty css               */import{S as le}from"./Select-xUDAgyFx.js";import{B as oe}from"./Button-31nSmsNB.js";import{L as F}from"./Link-Cb4vaLua.js";import{b as ie,D as K,a as q}from"./DescriptionList-sP44BS45.js";import"./preload-helper-PPVm8Dsz.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-CipU2E76.js";import"./usePreviousValue-CA7Tdj9w.js";import"./ChevronDownIcon-C4Il4V_o.js";import"./Icon-D3zN9Hfi.js";import"./ChevronUpIcon-DPP3oKYK.js";import"./valuePair-Bn6SadUn.js";import"./ArrowVerticalAnimated-BqgoLHto.js";import"./ArrowDownIcon-C-cgksFO.js";import"./InputGroup-soLjnrLJ.js";import"./Label-CyWGL7ty.js";import"./SupportLabel-DlxuN8wM.js";import"./WarningIcon-D8f111Sa.js";import"./BaseTextInput-DRyEsV1F.js";import"./useListNavigation-CypiBTbC.js";import"./Loader-CQHzec3M.js";import"./useDelayedRender-DFFzekKL.js";const E=l.forwardRef(({isOpen:i,onClick:t,children:n,className:o,id:f,"aria-controls":v,...u},w)=>{if(i===void 0||typeof t!="function")throw new Error("ExpandableTableRowController must have ExpandableTableRow as parent");const{collapseToList:p}=G(),m=u["data-th"],s=p?m:void 0;return e.jsx(N,{className:y("jkl-table-cell--expand",{"jkl-table-cell--expand-without-text":!n},o),...u,ref:w,children:e.jsx(ee,{as:"button",className:y("jkl-table-row-expand-button",{"jkl-table-row-expand-button--expanded":i}),id:f,open:i,"aria-controls":v,"aria-label":n?void 0:m||"Ekspander rad",onClick:b=>{b.stopPropagation(),t()},onKeyDown:b=>{(b.key==="Enter"||b.key===" ")&&(b.stopPropagation(),b.preventDefault(),t())},children:n??s})})});E.displayName="ExpandableTableRowController";E.__docgenInfo={description:"",methods:[],displayName:"ExpandableTableRowController",props:{density:{required:!1,tsType:{name:"union",raw:'"comfortable" | "compact"',elements:[{name:"literal",value:'"comfortable"'},{name:"literal",value:'"compact"'}]},description:""},align:{required:!1,tsType:{name:"union",raw:'"left" | "center" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"center"'},{name:"literal",value:'"right"'}]},description:`Velg mellom venstrejustering og høyrejustering av innholdet. Typisk skal innholdet være venstrejustert, men for eksempel summer er høyrejustert.
