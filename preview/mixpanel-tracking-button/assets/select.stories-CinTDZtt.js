import{r as i,j as e}from"./iframe-A5c2Wqvk.js";import{u as L}from"./index.esm-mdq-c9xQ.js";import{c as F}from"./cow-CdXr5BwN.js";import{l as x}from"./landkoder-DlcCquOp.js";import{S as o,g as I}from"./Select-B787s6cx.js";import{B as w}from"./Button-CFV1ExI7.js";import{F as y}from"./Flex-4q2H_Iw0.js";/* empty css               */import{T as j}from"./Text-DChhKQum.js";import"./preload-helper-PPVm8Dsz.js";import"./clsx-B-dksMZM.js";import"./mergeRefs-C1zYPesy.js";import"./serializeTracking-CnAc4iKu.js";import"./InputGroup-CI-q_9N6.js";import"./useId-BqJ3Mudq.js";import"./Label-B8MgGNDM.js";import"./SupportLabel-CkMYJ3oD.js";import"./SuccessIcon-PvcmUODX.js";import"./Icon-aN8z_x5R.js";import"./WarningIcon-BGoIXnrD.js";import"./Search-BMPQ_FcE.js";import"./Title-DHd5KV4g.js";import"./useListNavigation-DRHIFzsb.js";import"./ArrowDownIcon-P7TVz6LG.js";import"./CloseIcon-B9re0XTl.js";import"./usePreviousValue-BpHgvnAJ.js";import"./Loader-DB4OEe16.js";import"./useDelayedRender-k-4tZbkM.js";import"./SlotComponent-RUIXAPm3.js";const V=""+new URL("cat-CQlfcJin.jpg",import.meta.url).href,T=""+new URL("dog-oLAuIUOU.jpg",import.meta.url).href,H=""+new URL("guinea-BF22JSZW.jpg",import.meta.url).href,D=""+new URL("horse-pTldkTf4.jpg",import.meta.url).href,A=[{value:"apple",label:"Apple"},{value:"samsung",label:"Samsung"},{value:"google",label:"Google"},{value:"oneplus",label:"OnePlus"},{value:"nothing",label:"Nothing"},{value:"nokia",label:"Nokia"},{value:"annet",label:"Annet"}],C=[{value:"hund",label:"Hund",description:"Trofast og glad",media:e.jsx("img",{src:T,alt:"",width:"50",height:"50"})},{value:"katt",label:"Katt",description:"Selvstendig og nysgjerrig",media:e.jsx("img",{src:V,alt:"",width:"50",height:"50"})},{value:"marsvin",label:"Marsvin",description:"Vennlig og sjenert",media:e.jsx("img",{src:H,alt:"",width:"50",height:"50"})},{value:"hest",label:"Hest",description:"Kraftig og intelligent",media:e.jsx("img",{src:D,alt:"",width:"50",height:"50"})},{value:"ku",label:"Ku",description:"Stø og rolig",media:e.jsx("img",{src:F,alt:"",width:"50",height:"50"})}];function O(n){const t=Array.from(n.target.selectedOptions,a=>a.value);console.log(t)}const me={title:"Komponenter/Select",component:o,parameters:{layout:"centered"},argTypes:{name:{table:{disable:!1}},items:{table:{disable:!0}}},args:{name:"phone-brand",label:"Hvilket merke er telefonen?",description:"Du kan kun velge ett merke",placeholder:"Velg",searchable:!1,multiple:!1,required:!1,disabled:!1,items:A,onChange:O},tags:["autodocs","forms"]},u={name:"Select"},c={name:"Select med mange valg",args:{label:"Hvilket land skjedde skaden i?",placeholder:"Velg land",description:void 0,items:x.map(({navn:n,kode:t})=>({label:n,value:t}))}},p={name:"Egendefinert filterfunksjon",args:{label:"Hvilket land skjedde skaden i?",placeholder:"Velg land",description:"Søker i både navn og landkode",items:x.map(({navn:n,kode:t})=>({label:n,value:t})),searchable:!0,filterFunction:(n,t)=>n.label.toLowerCase().includes(t.toLowerCase())||n.value.toLowerCase().includes(t.toLowerCase())}},g={name:"Kontrollert Select",render:n=>{const[t,a]=i.useState("samsung");return e.jsxs(e.Fragment,{children:[e.jsxs("label",{children:[e.jsxs(j,{children:["Sett ",e.jsx("code",{children:"value"})," for kontrollert Select:"]}),e.jsxs("select",{value:t,onChange:r=>a(r.target.value),children:[e.jsx("option",{value:""}),n.items.map(r=>{const{value:s}=I(r);return e.jsx("option",{value:s,children:s},s)})]})]}),e.jsx(o,{...n,multiple:!1,value:t,onChange:r=>{n.onChange?.(r),a(r.target.value)},className:"jkl-spacing-24--top"})]})}},v={name:"Select multiple",args:{name:"multiselect",id:"min-select",label:"Hvilke dyr liker du?",description:"Velg så mange du vil fra listen",placeholder:void 0,multiple:!0,items:C}},k={name:"I skjema",args:{},render:n=>{const[t,a]=i.useState("");return e.jsxs(y,{direction:"column",alignItems:"start",gap:"s",as:"form",onSubmit:r=>{r.preventDefault(),a(`Innsendt verdi for "${n.name||"feltet"}":
  ...
  tags: ["dev"]
}`,...b.parameters?.docs?.source}}};const ue=["SelectStory","ManyOptions","CustomFilter","Controlled","Multiple","ISkjema","ReactHookForm","SlowLoad","AsyncSearch","InvalidStory"];export{f as AsyncSearch,g as Controlled,p as CustomFilter,k as ISkjema,b as InvalidStory,c as ManyOptions,v as Multiple,h as ReactHookForm,u as SelectStory,S as SlowLoad,ue as __namedExportsOrder,me as default};
