import{R as p,j as k}from"./iframe-BBQ_8FxR.js";import{c as f}from"./clsx-B-dksMZM.js";import{S as c}from"./SlotComponent-Bbh2VytA.js";const n=p.forwardRef(function(r,t){const{className:l,clickable:e=!1,padding:o="s",outlined:s=!1,asChild:d,as:i="div",...m}=r,u=d?c:i;return k.jsx(u,{"data-testid":"jkl-card","data-clickable":e,"data-padding":o,"data-jkl-tracked":e?"Card":void 0,className:f("jkl-card",s&&"jkl-card--outlined",l),...m,ref:t})});try{n.displayName="Card",n.__docgenInfo={description:`En allsidig kortkomponent som brukes for å gruppere innhold på en side.
...
// Rendrer følgende:
<Child foo="bar" baz="qux" />
\`\`\``,name:"asChild",required:!1,type:{name:"boolean"}}}}}catch{}export{n as C};
