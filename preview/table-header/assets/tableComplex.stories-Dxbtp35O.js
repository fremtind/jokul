import{r as l,j as e,R as B}from"./iframe-DY6F1u9l.js";import{c as y}from"./clsx-B-dksMZM.js";import{u as Z}from"./useAnimatedHeight-DA1Xg9P1.js";import{u as H}from"./useId-BpOmZkHM.js";import{E as ee}from"./Expander-Dpk4taGA.js";import{u as G,a as N,b as D,T as te,c as W,d as z,e as J,f as Q,g as C}from"./_index-BedUAPoQ.js";import{T as U}from"./TableBody-CbuK2hJM.js";import{I as O}from"./IconButton-Cklq9aBb.js";import{C as ne}from"./ChevronLeftIcon-D2oPjXuD.js";import{C as ae}from"./ChevronRightIcon-axv4kSji.js";import{N as re}from"./NativeSelect-C-TQOtLC.js";import{T as X}from"./TextInput-NchE6EwF.js";import{u as se}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               *//* empty css               *//* empty css               *//* empty css               */import{S as le}from"./Select-B0vL7hOG.js";import{B as oe}from"./Button-DyNEvI1s.js";import{L as F}from"./Link-tT-Xp4Vo.js";import{b as ie,D as K,a as q}from"./DescriptionList-DuaSZgEe.js";import"./preload-helper-PPVm8Dsz.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-UcTnhyEa.js";import"./usePreviousValue-DZRa6cPE.js";import"./ChevronDownIcon-DODzanWl.js";import"./Icon-Dq6U2rBX.js";import"./ChevronUpIcon-CKO7rvYx.js";import"./valuePair-Bn6SadUn.js";import"./ArrowVerticalAnimated-DPPPaMRV.js";import"./ArrowDownIcon-BdaE38aZ.js";import"./InputGroup-L0xdEAq4.js";import"./Label-CH93HefZ.js";import"./SupportLabel-CL5Qmh5u.js";import"./WarningIcon-BUuez_6B.js";import"./BaseTextInput-uAAbxuV9.js";import"./useListNavigation-BbU7lBfU.js";import"./Loader-DpaLsUKO.js";import"./useDelayedRender-CERZQn_S.js";const E=l.forwardRef(({isOpen:i,onClick:t,children:n,className:o,id:f,"aria-controls":v,...u},w)=>{if(i===void 0||typeof t!="function")throw new Error("ExpandableTableRowController must have ExpandableTableRow as parent");const{collapseToList:p}=G(),m=u["data-th"],s=p?m:void 0;return e.jsx(N,{className:y("jkl-table-cell--expand",{"jkl-table-cell--expand-without-text":!n},o),...u,ref:w,children:e.jsx(ee,{as:"button",className:y("jkl-table-row-expand-button",{"jkl-table-row-expand-button--expanded":i}),id:f,open:i,"aria-controls":v,"aria-label":n?void 0:m||"Ekspander rad",onClick:b=>{b.stopPropagation(),t()},onKeyDown:b=>{(b.key==="Enter"||b.key===" ")&&(b.stopPropagation(),b.preventDefault(),t())},children:n??s})})});E.displayName="ExpandableTableRowController";E.__docgenInfo={description:"",methods:[],displayName:"ExpandableTableRowController",props:{density:{required:!1,tsType:{name:"union",raw:'"comfortable" | "compact"',elements:[{name:"literal",value:'"comfortable"'},{name:"literal",value:'"compact"'}]},description:""},align:{required:!1,tsType:{name:"union",raw:'"left" | "center" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"center"'},{name:"literal",value:'"right"'}]},description:`Velg mellom venstrejustering og høyrejustering av innholdet. Typisk skal innholdet være venstrejustert, men for eksempel summer er høyrejustert.
