import{r as l,j as e,R as B}from"./iframe-KBuXSPRb.js";import{c as y}from"./clsx-B-dksMZM.js";import{u as Z}from"./useAnimatedHeight-BfBoEL4O.js";import{u as H}from"./useId-BjRjsyhH.js";import{E as ee}from"./Expander-CpFHBsCD.js";import{u as G,T as N,a as D,h as te,b as W,c as z,d as J,e as Q,f as U,g as C}from"./_index-BOHdzFPa.js";import{I as O}from"./IconButton-Cg8w-m06.js";import{C as ne}from"./ChevronLeftIcon-DOBFIGIZ.js";import{C as ae}from"./ChevronRightIcon-jFN8SveY.js";import{N as re}from"./NativeSelect-BXWkCrce.js";import{T as X}from"./TextInput-BJkvX7N2.js";import{u as se}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               *//* empty css               *//* empty css               *//* empty css               */import{S as le}from"./Select-Brz-q87T.js";import{B as oe}from"./Button-BaLG3bot.js";import{L as F}from"./Link-6ZsEK9Iq.js";import{b as ie,D as K,a as q}from"./DescriptionList-BVYG3ACN.js";import"./preload-helper-PPVm8Dsz.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-Db5nUBem.js";import"./usePreviousValue-Dw2hbakb.js";import"./ChevronDownIcon-sS2eEB3Y.js";import"./Icon-BH6s9Awv.js";import"./ChevronUpIcon-DdPmPqKy.js";import"./valuePair-Bn6SadUn.js";import"./ArrowVerticalAnimated-BpISqRhd.js";import"./ArrowDownIcon-CdvJql-7.js";import"./InputGroup-CokBZu_E.js";import"./Label-9upv82HJ.js";import"./SupportLabel-Cz00_Izr.js";import"./WarningIcon-wh0TceHi.js";import"./BaseTextInput-Du-TmjxB.js";import"./useListNavigation-BWEtjNuz.js";import"./Loader-BishsQUv.js";import"./useDelayedRender-iXdu-Htj.js";const E=l.forwardRef(({isOpen:i,onClick:t,children:n,className:o,id:f,"aria-controls":v,...p},w)=>{if(i===void 0||typeof t!="function")throw new Error("ExpandableTableRowController must have ExpandableTableRow as parent");const{collapseToList:u}=G(),m=p["data-th"],s=u?m:void 0;return e.jsx(N,{className:y("jkl-table-cell--expand",{"jkl-table-cell--expand-without-text":!n},o),...p,ref:w,children:e.jsx(ee,{as:"button",className:y("jkl-table-row-expand-button",{"jkl-table-row-expand-button--expanded":i}),id:f,open:i,"aria-controls":v,"aria-label":n?void 0:m||"Ekspander rad",onClick:b=>{b.stopPropagation(),t()},onKeyDown:b=>{(b.key==="Enter"||b.key===" ")&&(b.stopPropagation(),b.preventDefault(),t())},children:n??s})})});E.displayName="ExpandableTableRowController";E.__docgenInfo={description:"",methods:[],displayName:"ExpandableTableRowController",props:{density:{required:!1,tsType:{name:"union",raw:'"comfortable" | "compact"',elements:[{name:"literal",value:'"comfortable"'},{name:"literal",value:'"compact"'}]},description:""},align:{required:!1,tsType:{name:"union",raw:'"left" | "center" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"center"'},{name:"literal",value:'"right"'}]},description:`Velg mellom venstrejustering og høyrejustering av innholdet. Typisk skal innholdet være venstrejustert, men for eksempel summer er høyrejustert.
...
@default { rowsPerPage: "Rader per side", previous: "Forrige", next: "Neste" }`}}};const Ue={title:"Komponenter/Table",component:U,subcomponents:{TableCaption:Q,TableHead:J,TableHeader:z,TableBody:W,TableRow:D,TableCell:N}},I={name:"Kompleks Table",args:{collapseToList:!0,fullWidth:!0,caption:e.jsx(Q,{srOnly:!0,children:"Overskrift for skjermlesere"}),children:""},render:i=>{const t=l.useRef(null),[n,o]=l.useState(0),[f,v]=l.useState(6),[p,w]=l.useState(C.columns[0]),[u,m]=l.useState("desc"),[s,b]=l.useState(""),[g,S]=l.useState(""),[T,_]=l.useState(C.rows),P=n*f,j=(a,x)=>{w(a),m(x)},{getSortProps:r}=se(p,u,j);return l.useEffect(()=>{_(C.rows.filter(a=>a.toString().toLowerCase().includes(s.toLowerCase())).filter(a=>a[3].toString().toLowerCase().includes(g.toLowerCase())).slice(P,P+f))},[P,f,s,g]),e.jsxs(e.Fragment,{children:[e.jsxs("aside",{style:{display:"flex",gap:"24px",alignItems:"end",marginBlockEnd:"24px"},children:[e.jsx(X,{label:"Søk",value:s,placeholder:"Søk",onChange:a=>b(a.target.value)}),e.jsx(le,{items:[{label:"Alle statuser",value:""},"Faktura","Påminnelse","Inkasso"],label:"Status",name:"status",value:g,onChange:a=>S(a.target.value)}),e.jsx(oe,{onClick:()=>{b(""),S("")},children:"Fjern filter"})]}),e.jsx("div",{style:{width:"90dvw"},children:e.jsxs(U,{...i,children:[e.jsx(J,{sticky:!0,children:e.jsx(D,{children:C.columns.slice(0,6).map((a,x)=>e.jsx(z,{bold:!0,...r(a),children:a},x))})}),e.jsx(W,{children:T.length!==0?T.sort((a,x)=>{if(p==="Forfallsdato"){const k=new Date(a[0]).getTime(),h=new Date(x[0]).getTime();return u==="asc"?k-h:h-k}if(p==="Beløp"){const k=Number(a[2]),h=Number(x[2]);return u==="asc"?k-h:h-k}return 0}).map((a,x)=>e.jsxs(M,{clickable:!1,expandedChildren:e.jsxs(ie,{children:[C.columns.map((k,h)=>a.map((A,L)=>h===L&&e.jsxs(l.Fragment,{children:[e.jsx(K,{children:k}),e.jsx(q,{children:A.toLocaleString()})]},L))),e.jsx(K,{children:"Faktura"}),e.jsx(q,{children:e.jsx(F,{external:!0,target:"_blank",href:"#",children:"Åpne i ny fane"})}),e.jsx(q,{children:e.jsx(F,{download:`${a[3]} ${new Date(a[0]).toLocaleDateString()}`,href:"#",children:"Last ned"})})]}),children:[e.jsx(N,{children:e.jsx(F,{download:`${a[3]} ${new Date(a[0]).toLocaleDateString()}`,href:"#",children:new Date(a[0]).toLocaleDateString()})}),a.slice(1,6).map((k,h)=>e.jsx(N,{"data-th":C.columns[h],children:k.toLocaleString()},h)),e.jsx(E,{children:"Vis detaljer"})]},x)):e.jsx(D,{children:e.jsx(N,{colSpan:99,children:"Fant ingen fakturaer."})})}),e.jsx(V,{children:e.jsx(D,{children:e.jsx(N,{colSpan:99,children:e.jsx($,{activePage:n,totalNumberOfRows:C.rows.length,rowsPerPage:f,rowsPerPageItems:[6,12,24,{label:"Alle",value:T.length}],onChangeRowsPerPage:a=>{const x=Number.parseInt(a.target.value);v(x),o(0),t.current&&t.current.scrollIntoView({behavior:"smooth"})},onChange:(a,x)=>{o(x),t.current&&t.current.scrollIntoView({behavior:"smooth"})}})})})})]})})]})}};I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
  name: "Kompleks Table",
  args: {
    collapseToList: true,
    fullWidth: true,
...
}`,...I.parameters?.docs?.source}}};const Xe=["TableComplex"];export{I as TableComplex,Xe as __namedExportsOrder,Ue as default};
