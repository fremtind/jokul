import{j as e,r as v}from"./iframe-vBol8UFS.js";import{a as B,S as t}from"./Search-N4FrT8KH.js";import{F as s}from"./Flex-DtL0Q7sJ.js";import{C as b}from"./Card-C8eASH6g.js";import{u as I}from"./useModal-9A3YU7M9.js";import{B as F}from"./Button-Bq04epRT.js";import{S as M}from"./SearchIcon-B4M9k3zI.js";import{I as _}from"./Icon-CM-bZq8k.js";import{a as N,b as P,M as L,f as R}from"./Modal-D62fbIMZ.js";import{L as O,b as T}from"./ListItem-DhHx9Ns2.js";import{S as w}from"./Select-bkNjLlDm.js";import{P as f}from"./Popover-C63BkeA2.js";import{M as W}from"./MenuItem-zwB0rhMu.js";const K={title:"Komponenter/Search",component:t,subcomponents:{SearchButton:B},parameters:{layout:"centered"},args:{spellCheck:!1,label:"Søk",placeholder:"Søk",icon:"search",description:"",required:!0,disabled:!1,labelProps:{srOnly:!0}},argTypes:{icon:{control:"select",options:["search","filter_list","filter_alt"],table:{defaultValue:{summary:"search"}}}},tags:["autodocs","forms"]},u={name:"Søk"},$=["Layout","Tekst","Gruppering","Alle"].sort(),l=["Button","Autosuggest","Card","Breadcrumbs","Help","Image","List","Pagination","Modal","Icon","Search","Flex","Table","Expander","Alle"].sort(),h={name:"Søk med autosuggest",args:{list:"components"},render:r=>e.jsx(e.Fragment,{children:e.jsx(t,{...r,children:e.jsx("datalist",{id:r.list,children:l.map(a=>e.jsx("option",{children:a},a))})})})},d={name:"Søk med knapp",args:{label:"Søk",placeholder:""},render:r=>e.jsx(s,{gap:"xl",wrap:"wrap",children:e.jsx(s,{direction:"column",gap:"m",children:e.jsx(t,{...r,children:e.jsx(t.Button,{...m.args})})})})},g={name:"Søk som hovedhandling på en side",parameters:{layout:"centered"},args:{labelProps:{srOnly:!0},placeholder:""},render:r=>e.jsxs(s,{as:"form",direction:"column",justifyContent:"center",alignItems:"center",children:[e.jsx("h2",{className:"jkl-heading-2",children:"Hva leter du etter?"}),e.jsx(t,{...r,children:e.jsx(t.Button,{type:"submit"})})]})},j={name:"Søk som filter",args:{placeholder:"Filtrer etter navn",label:"Filtrer etter navn",icon:"filter_list"},parameters:{layout:"padded"},render:r=>{const[a,o]=v.useState(l);return e.jsxs(s,{direction:"column",gap:"s",children:[e.jsx(t,{...r,onChange:n=>{o(l.filter(c=>c.toLowerCase().includes(n.target.value.toLowerCase())))}}),e.jsxs("section",{"aria-live":"polite",children:[e.jsx("p",{className:a.length?"jkl-sr-only":"",children:`${a.length} komponenter funnet`}),e.jsx(s,{as:"ul",gap:"xs",direction:"column",style:{padding:0,margin:0},children:!!a.length&&a.map(n=>e.jsxs(b,{as:"li",children:[e.jsx("p",{className:"jkl-heading-5",children:n}),e.jsxs("div",{style:{color:"var(--jkl-color-text-subdued)"},children:[e.jsx("p",{className:"jkl-small",children:"Komponent"}),e.jsx("p",{className:"jkl-small",children:"Mer informasjon"})]})]},n))})]})]})}},x={name:"Popover med søk",render:r=>{const[a,o]=v.useState(!1),[n,c]=v.useState(l);return e.jsxs(f,{open:a,children:[e.jsx(f.Trigger,{"aria-expanded":a,asChild:!0,children:e.jsx(t,{...r,onChange:i=>{i.target.value.length!==0&&o(!0),c(l.filter(y=>y.toLowerCase().includes(i.target.value.toLowerCase())))}})}),e.jsxs(f.Content,{padding:8,role:"menu",style:{maxWidth:"25ch"},"aria-live":"polite",children:[e.jsx("p",{className:"jkl-sr-only",children:`${n.length} komponenter funnet`}),n.map(i=>e.jsx(W,{as:"a",href:"#",children:i},i))]})]})}},S={name:"Header med søkeknapp",parameters:{layout:"centered"},args:{labelProps:{variant:"large"},placeholder:"Søk i hele Jøkul"},render:r=>{const[a,o]=v.useState(""),[n,{overlay:c,container:i,modal:y}]=I({title:""}),C=l.filter(p=>p.includes(a));return e.jsxs(e.Fragment,{children:[e.jsxs(s,{as:"header",alignItems:"center",justifyContent:"space-between",style:{minInlineSize:"50cqi",padding:"var(--jkl-spacing-s) var(--jkl-spacing-m)",background:"var(--jkl-color-background-container)"},children:[e.jsx("p",{className:"jkl-heading-4",children:"Jøkul"}),e.jsxs(s,{gap:"xs",children:[e.jsx(F,{variant:"ghost",onClick:()=>n.show(),icon:e.jsx(M,{}),"aria-label":"Åpne søk"}),e.jsx(F,{variant:"ghost",icon:e.jsx(_,{children:"menu"}),"aria-label":"Meny"})]})]}),e.jsxs(N,{...i,children:[e.jsx(P,{...c}),e.jsx(L,{...y,children:e.jsxs(s,{as:R,gap:"m",direction:"column",children:[e.jsx(t,{...r,value:a,onChange:p=>o(p.target.value)}),e.jsxs("div",{"aria-live":"polite",children:[e.jsx("p",{className:"jkl-sr-only",children:`${C.length} komponenter funnet`}),e.jsx(O,{children:C.map(p=>e.jsx(T,{children:p},p))})]})]})})]})]})}},k={name:"Toolbar med søkefilter",parameters:{layout:"fullscreen"},args:{label:"Filtrer etter navn",placeholder:"",labelProps:{srOnly:!1},icon:"filter_list"},render:r=>{const[a,o]=v.useState(l);return e.jsxs(s,{direction:"column",gap:"s",children:[e.jsx(b,{asChild:!0,children:e.jsxs(s,{as:"menu",alignItems:"end",justifyContent:"space-between",gap:"xl",style:{display:"flex",minInlineSize:"50cqi",padding:"var(--jkl-spacing-m) var(--jkl-spacing-m)",background:"var(--jkl-color-background-container)"},children:[e.jsx(s,{gap:"xs",children:e.jsx(t,{...r,onChange:n=>o(l.filter(c=>c.toLowerCase().includes(n.target.value.toLowerCase())))})}),e.jsxs(s,{gap:"s",children:[e.jsx(w,{label:"Komponent",children:l.map(n=>e.jsx("option",{value:n,children:n},n))}),e.jsx(w,{label:"Gruppe",children:$.map(n=>e.jsx("option",{value:n,children:n},n))})]})]})}),!!a.length&&a.map(n=>e.jsxs(b,{as:"li",children:[e.jsx("p",{className:"jkl-heading-5",children:n}),e.jsxs("div",{style:{color:"var(--jkl-color-text-subdued)"},children:[e.jsx("p",{className:"jkl-small",children:"Komponent"}),e.jsx("p",{className:"jkl-small",children:"Mer informasjon"})]})]},n))]})}};u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  name: "Søk"
  ...
  render: args => {
    ...
    return <Flex direction="column" gap="s">
          ...
          background: "var(--jkl-color-background-container)"
                        ...
                        <Flex gap="s">
                            <Select label="Komponent">
                                {components.map(word => <option value={word} key={word}>
                                        {word}
                                    </option>)}
                            </Select>
                            <Select label="Gruppe">
