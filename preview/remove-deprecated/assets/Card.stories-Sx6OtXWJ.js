import{j as e}from"./jsx-runtime-D9p_MChh.js";import{R as y}from"./index-CRL2yuNo.js";import{p as F,n as k,f as T}from"./formatNumber-DzIwhxNg.js";import{S as D,F as u}from"./Flex-DXV4vvFO.js";import{E as R}from"./Tag-CDfcxRZt.js";import{c as S}from"./clsx-B-dksMZM.js";/* empty css               */import"./_commonjsHelpers-gnU0ypJ3.js";import"./tokens-CvksrKef.js";const f={locale:"no-NB",minimumFractionDigits:0,maximumFractionDigits:2,suffix:"kr"};function A(t,s){const n=F(t);if(Number.isNaN(n))return t.toString();const l=Number.isInteger(n)?{}:{minimumFractionDigits:2,maximumFractionDigits:2},r=f.suffix,{prefix:a,...d}={...f,...l,...s},m=a!=null&&a.length?`${a}${k}`:"",c=r!=null&&r.length?`${k}${r}`:"",p=T(n,d);return`${m}${p}${c}`}const g=y.forwardRef(function(s,n){const{className:l,clickable:r=!1,padding:a="s",variant:d="high",asChild:m,as:c="div",...p}=s,N=m?D:c;return e.jsx(N,{"data-testid":"jkl-card","data-clickable":r,"data-padding":a,className:S("jkl-card",`jkl-card--${d}`,l),...p,ref:n})});g.__docgenInfo={description:`En allsidig kortkomponent som brukes for å gruppere innhold på en side.
...
@default "high"`},clickable:{required:!1,tsType:{name:"boolean"},description:"Angir om kortet visuelt skal fremstå som klikkbart. Du må selv rendre\nkortet som et klikkbart element (f.eks. `<a>` eller en `<Link>` fra\net ruting-bibliotek) og gi det en `href` eller `onClick`-handler.\nHUSK: Sett aria-label for at støtteverktøy, som skjermlesere, ikke\nskal lese alt innholdet i kortet."}}};const E=["s","m","l","xl"],$=["outlined","high","low"],K={title:"Komponenter/Card",component:g,parameters:{layout:"centered"},tags:["autodocs"],args:{},argTypes:{variant:{control:"select",options:$},padding:{control:"select",options:E}}},o={args:{padding:"m",variant:"outlined",children:"Hei, verden!"}},i={args:{padding:"m",clickable:!0,variant:"outlined",children:""},render:({asChild:t,as:s,...n})=>e.jsx(g,{asChild:!0,...n,children:e.jsxs(u,{as:"a",href:"#test",colGap:40,children:[e.jsxs(u,{direction:"column",gap:4,children:[e.jsxs("p",{className:"jkl-heading-2",children:[A(18856),e.jsx("span",{"aria-hidden":!0,children:" →"})]}),e.jsx("p",{className:"jkl-body",children:"Frist 20.03.2023"})]}),e.jsxs(u,{direction:"column",gap:12,children:[e.jsx(R,{children:"Ubetalt"}),e.jsx("p",{className:"jkl-body",children:"Purring"})]})]})})};var h,b,x;o.parameters={...o.parameters,docs:{...(h=o.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    padding: "m",
    variant: "outlined",
    children: "Hei, verden!"
