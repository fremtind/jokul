...
| "onChange"`,elements:[{name:"literal",value:'"type"'},{name:"literal",value:'"children"'},{name:"literal",value:'"className"'},{name:"literal",value:'"name"'},{name:"literal",value:'"defaultValue"'},{name:"literal",value:'"value"'},{name:"literal",value:'"placeholder"'},{name:"literal",value:'"width"'},{name:"literal",value:'"onFocus"'},{name:"literal",value:'"onBlur"'},{name:"literal",value:'"onChange"'}]}],raw:`Omit<
    ...
    | "onBlur"
    | "onChange"
>`},description:"Props som sendes direkte til komponentens TextInput"}},composes:["Omit"]};const Ht={title:"Komponenter/DatePicker",component:ge,parameters:{layout:"padded"},tags:["autodocs"]},J={args:{}};var De,we,Oe;J.parameters={...J.parameters,docs:{...(De=J.parameters)==null?void 0:De.docs,source:{originalSource:`{
  args: {}
}`,...(Oe=(we=J.parameters)==null?void 0:we.docs)==null?void 0:Oe.source}}};const Vt=["DatePicker"];export{J as DatePicker,Vt as __namedExportsOrder,Ht as default};
