import{R as e,r as n}from"./index-siqcju79.js";import{P as L,T as N,S as ue}from"./Button-Bm5jRD6q.js";import{c as I}from"./clsx-B-dksMZM.js";import{S as de}from"./Message-RajZ2aqN.js";import{a as me}from"./RadioButton-BEaJQk1K.js";import{R as ce}from"./RadioButtonGroup-BKhQwQk8.js";import{F as $}from"./FieldGroup-jrp1MMow.js";import{T as K}from"./TextArea-DLQO0gvo.js";import{C as pe}from"./Checkbox-CwfoYjrc.js";import{u as ge}from"./useAnimatedHeight-BiaBG1a8.js";import{T as P}from"./TextInput-ziLWZWeG.js";import"./_commonjsHelpers-DaWZu8wl.js";import"./usePreviousValue-f0kyfTHz.js";import"./Loader-Dq-CBRAZ.js";import"./useDelayedRender-CQprwS1c.js";import"./useId-CahK3IZ3.js";import"./ErrorIcon-BUXYVAIL.js";import"./Icon-mINJCSxV.js";import"./InfoIcon-BUv3PgcW.js";import"./WarningIcon-CnuYLHnq.js";import"./DismissButton-C_71uvrR.js";import"./CloseIcon-bvBUMA_V.js";import"./SupportLabel-Bm3W2hYF.js";import"./BaseRadioButton-BbIdBf1s.js";import"./Label-tZYmh4ng.js";import"./InputGroup-BJwbXp8L.js";import"./tokens-CvksrKef.js";import"./useBrowserPreferences-B9LcbCiO.js";import"./BaseTextInput-BcWqlF22.js";import"./IconButton-BsqD9nTf.js";const ve={feedbackSubmitted:!1,followupStarted:!1,followupSubmitted:!1,contactSubmitted:!1,setFeedbackSubmitted:()=>null,setFollowupStarted:()=>null,setFollowupSubmitted:()=>null,setContactSubmitted:()=>null},W=n.createContext(ve),T=()=>n.useContext(W),G=({value:t,children:s})=>e.createElement(W.Provider,{value:t},s);G.__docgenInfo={description:"",methods:[],displayName:"FeedbackContextProvider",props:{children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""},value:{required:!0,tsType:{name:"intersection",raw:`{
...
}`,computed:!1}}}};const se=t=>{switch(t){case"radio":return _;case"checkbox":return J;case"text":return Y;case"smiley":return ne;default:return _}},xe=(t,s)=>{const[o,i]=n.useState(),[p,g]=n.useState({number:0,question:t[0],isLast:t.length===1}),[u,r]=n.useState(!1),[l,d]=n.useState(!1),[a,v]=n.useState(),c=n.useRef({values:o,submitted:l,onSubmit:s});n.useEffect(()=>{c.current={...c.current,values:o,submitted:l}},[o,l]);const m=n.useCallback(()=>{!c.current.submitted&&c.current.values!==void 0&&c.current.onSubmit(c.current.values)},[]);function k(f){f?.preventDefault();const y=Array.isArray(a)?a.map(h=>h.value.toString()):a?.value,E={...p.question,name:p.question.name||p.question.label,value:y};i(h=>[...h?.filter(M=>M.name!==E.name)||[],E]),v(void 0),p.isLast?r(!0):g(h=>{const q=h.number+1;return{number:q,question:t[q],isLast:q+1>=t.length}})}function b(){i(void 0),v(void 0),g({number:0,question:t[0],isLast:t.length===1}),d(!0)}return n.useEffect(()=>{u&&(m(),d(!0))},[u,m]),n.useEffect(()=>(typeof window<"u"&&window.addEventListener("beforeunload",m),()=>{m(),window.removeEventListener("beforeunload",m)}),[m]),{questions:t,values:o,step:p,currentValue:a,setCurrentValue:v,submitted:l,handleNext:k,handleAbort:b}},Ae={title:"Takk, igjen!",children:"Vi setter pris på at du tok deg tid til å svare på flere spørsmål. Det hjelper oss med å gjøre nettsidene bedre for deg og alle andre som bruker dem."},ie=({questions:t,successMessage:s=Ae,onSubmit:o})=>{const[i,p]=n.useState(!1),g=n.useRef(null),u=xe(t,o),{handleAbort:r,handleNext:l,step:d,submitted:a}=u,{followupStarted:v,setFollowupStarted:c,setFollowupSubmitted:m,contactSubmitted:k,landmarkLabel:b}=T();n.useEffect(()=>{d.number!==0&&g.current?.focus()},[d]),n.useEffect(()=>{m(a)},[a,m]);const f=se(t[d.number].type),y=d.isLast?L:ue;return i?null:e.createElement("div",{"aria-live":"polite"},e.createElement(z,{state:u},!v&&e.createElement("div",{className:"jkl-feedback__fade-in"},e.createElement("p",{className:"jkl-heading-4 jkl-spacing-xl--top jkl-spacing-xs--bottom"},"Har du tid til å svare på noen flere spørsmål?"),e.createElement("p",{className:"jkl-body jkl-spacing-xl--bottom"},"Det tar kun et minutt, og hjelper oss å lage bedre løsninger for deg."),e.createElement(L,{onClick:()=>c(!0),className:"jkl-spacing-xl--right"},"Jeg har tid!"),e.createElement(N,{onClick:()=>p(!0)},"Nei takk")),!a&&v&&e.createElement("form",{onSubmit:l,className:"jkl-feedback__fade-in","aria-label":b},e.createElement("p",{className:"jkl-feedback__step-counter",ref:g},"Steg ",d.number+1," av ",t.length),e.createElement(f,{...t[d.number],autoFocus:!0,key:d.number}),e.createElement("div",{className:"jkl-spacing-xl--top","aria-live":"off"},e.createElement(y,{type:"submit"},d.isLast?"Send inn":"Neste"),e.createElement(N,{onClick:r,className:"jkl-spacing-xl--left"},"Avbryt"))),a&&!k&&e.createElement(V,{...s})))};ie.__docgenInfo={description:"",methods:[],displayName:"Followup",props:{questions:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:"MainQuestion | TextQuestion | CheckboxQuestion",elements:[{name:"union",raw:"RadioQuestion | SmileyQuestion",elements:[{name:"RadioQuestion"},{name:"SmileyQuestion"}]},{name:"TextQuestion"},{name:"CheckboxQuestion"}]}],raw:"FollowupQuestion[]"},description:"Spørsmålet/ene som skal stilles. Kan være av typen radio, checkbox eller text"},successMessage:{required:!1,tsType:{name:"signature",type:"object",raw:`{
    title: string;
    children: ReactNode;
...
for brukeren.`}}};const ot={title:"Komponenter/Feedback",component:R,parameters:{layout:"centered"},tags:["autodocs"]},A={args:{type:"radio",label:"Hvordan opplevde du å bestille forsikring på nett?",helpLabel:"Hjelpetekst",options:[{label:"Enkelt og greit",value:"enkelt"},{label:"Midt på treet",value:"ok"},{label:"Tungvindt",value:"tungvindt"}],addOnQuestion:{label:"Er det noe mer du vil legge til?",helpLabel:"Hjelpetekst"},successMessage:{title:"Takk for tilbakemeldingen!",children:"Vi setter pris på at du tar deg tid til å gi oss tilbakemelding."},onSubmit:console.info},render:t=>e.createElement(R,{...t})},C={args:{type:"smiley",label:"Hvordan opplevde du å bestille forsikring på nett?",helpLabel:"Hjelpetekst",options:ee,addOnQuestion:{label:"Er det noe mer du vil legge til?",helpLabel:"Hjelpetekst"},successMessage:{title:"Takk for tilbakemeldingen!",children:"Vi setter pris på at du tar deg tid til å gi oss tilbakemelding."},onSubmit:console.info},render:t=>e.createElement(R,{...t})};A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  args: {
    type: "radio",
  ...
  render: args => <Feedback {...args} />
}`,...C.parameters?.docs?.source}}};const ut=["Radio","Smiley"];export{A as Radio,C as Smiley,ut as __namedExportsOrder,ot as default};
