import{r as l,j as e,R as B}from"./iframe-Bv7LMU6l.js";import{c as y}from"./clsx-B-dksMZM.js";import{u as Z}from"./useAnimatedHeight-Bi8ddasT.js";import{u as H}from"./useId-dGUThTlM.js";import{E as ee}from"./Expander-wrmdMydg.js";import{u as G,a as N,b as D,T as te,c as W,d as z,e as J,f as Q,g as C}from"./_index-C3AQlzHH.js";import{T as U}from"./TableBody-BRz3O8Nj.js";import{I as O}from"./IconButton-1LiuaLeS.js";import{C as ne}from"./ChevronLeftIcon-TieUnhJn.js";import{C as ae}from"./ChevronRightIcon-BQHr6lBT.js";import{N as re}from"./NativeSelect-CEYbsi6i.js";import{T as X}from"./TextInput-B9t5tifd.js";import{u as se}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               *//* empty css               *//* empty css               *//* empty css               */import{S as le}from"./Select-CArYNITO.js";import{B as oe}from"./Button-CFJ4hIao.js";import{L as F}from"./Link-CvteKr1v.js";import{b as ie,D as K,a as q}from"./DescriptionList-s5S2XY5Y.js";import"./preload-helper-PPVm8Dsz.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-DkPrRMgJ.js";import"./usePreviousValue-IE3jCIN5.js";import"./ChevronDownIcon-DAz0_BPZ.js";import"./Icon-B48KsVuT.js";import"./ChevronUpIcon-DjgZ6cew.js";import"./valuePair-Bn6SadUn.js";import"./ArrowVerticalAnimated-XidSVZiW.js";import"./ArrowDownIcon-HH_bjTf_.js";import"./InputGroup-CplB2iNL.js";import"./Label-CUsTONqQ.js";import"./SupportLabel-D2fcnhBk.js";import"./WarningIcon-8NJ-Eevq.js";import"./BaseTextInput-BLwkAAH5.js";import"./useListNavigation-BCeYyLXB.js";import"./Loader-C0GjiYkN.js";import"./useDelayedRender-CkibMecQ.js";const E=l.forwardRef(({isOpen:i,onClick:t,children:n,className:o,id:f,"aria-controls":v,...u},w)=>{if(i===void 0||typeof t!="function")throw new Error("ExpandableTableRowController must have ExpandableTableRow as parent");const{collapseToList:p}=G(),m=u["data-th"],s=p?m:void 0;return e.jsx(N,{className:y("jkl-table-cell--expand",{"jkl-table-cell--expand-without-text":!n},o),...u,ref:w,children:e.jsx(ee,{as:"button",className:y("jkl-table-row-expand-button",{"jkl-table-row-expand-button--expanded":i}),id:f,open:i,"aria-controls":v,"aria-label":n?void 0:m||"Ekspander rad",onClick:b=>{b.stopPropagation(),t()},onKeyDown:b=>{(b.key==="Enter"||b.key===" ")&&(b.stopPropagation(),b.preventDefault(),t())},children:n??s})})});E.displayName="ExpandableTableRowController";E.__docgenInfo={description:"",methods:[],displayName:"ExpandableTableRowController",props:{density:{required:!1,tsType:{name:"union",raw:'"comfortable" | "compact"',elements:[{name:"literal",value:'"comfortable"'},{name:"literal",value:'"compact"'}]},description:""},align:{required:!1,tsType:{name:"union",raw:'"left" | "center" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"center"'},{name:"literal",value:'"right"'}]},description:`Velg mellom venstrejustering og høyrejustering av innholdet. Typisk skal innholdet være venstrejustert, men for eksempel summer er høyrejustert.
