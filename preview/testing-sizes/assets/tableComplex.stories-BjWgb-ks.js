import{r as l,j as e,R as B}from"./iframe-Y1OcjnNo.js";import{c as y}from"./clsx-B-dksMZM.js";import{u as Z}from"./useAnimatedHeight-CO9R08fy.js";import{u as H}from"./useId-i3O22uCG.js";import{E as ee}from"./Expander-DxrzC7lx.js";import{u as G,a as N,b as D,T as te,c as W,d as z,e as J,f as Q,g as C}from"./_index-CsiqgCKJ.js";import{T as U}from"./TableBody-D0PSq5uY.js";import{I as O}from"./IconButton-BENjpXjN.js";import{C as ne}from"./ChevronLeftIcon-BIQ1wPm6.js";import{C as ae}from"./ChevronRightIcon-Bpp7k2Mo.js";import{N as re}from"./NativeSelect-mUsNVQr3.js";import{T as X}from"./TextInput-Dftw4BNh.js";import{u as se}from"./utils-DYxs2h-a.js";/* empty css               *//* empty css               *//* empty css               *//* empty css               *//* empty css               */import{S as le}from"./Select-DX35Sy53.js";import{B as oe}from"./Button-BdSr4osm.js";import{L as F}from"./Link-CMLYyzaD.js";import{b as ie,D as K,a as q}from"./DescriptionList-px0VvYMQ.js";import"./preload-helper-PPVm8Dsz.js";import"./tokens-d2GYn7oW.js";import"./useBrowserPreferences-DuhjO623.js";import"./usePreviousValue-CZ_PVXKc.js";import"./ChevronDownIcon-8Hw4swri.js";import"./Icon-DOc9L9Ko.js";import"./ChevronUpIcon-CZbkGL5u.js";import"./valuePair-Bn6SadUn.js";import"./ArrowVerticalAnimated-ebtM8VDD.js";import"./ArrowDownIcon-HRyETMKz.js";import"./InputGroup-DvohUVmx.js";import"./Label-CNv6mMbg.js";import"./SupportLabel-CNFfRxpc.js";import"./WarningIcon-CrXzAM-n.js";import"./BaseTextInput-31a_PWv1.js";import"./useListNavigation-0lvc_s1v.js";import"./Loader-B9YF6j_m.js";import"./useDelayedRender-Cpdobcwp.js";const E=l.forwardRef(({isOpen:i,onClick:t,children:n,className:o,id:f,"aria-controls":v,...u},w)=>{if(i===void 0||typeof t!="function")throw new Error("ExpandableTableRowController must have ExpandableTableRow as parent");const{collapseToList:p}=G(),m=u["data-th"],s=p?m:void 0;return e.jsx(N,{className:y("jkl-table-cell--expand",{"jkl-table-cell--expand-without-text":!n},o),...u,ref:w,children:e.jsx(ee,{as:"button",className:y("jkl-table-row-expand-button",{"jkl-table-row-expand-button--expanded":i}),id:f,open:i,"aria-controls":v,"aria-label":n?void 0:m||"Ekspander rad",onClick:b=>{b.stopPropagation(),t()},onKeyDown:b=>{(b.key==="Enter"||b.key===" ")&&(b.stopPropagation(),b.preventDefault(),t())},children:n??s})})});E.displayName="ExpandableTableRowController";E.__docgenInfo={description:"",methods:[],displayName:"ExpandableTableRowController",props:{density:{required:!1,tsType:{name:"union",raw:'"comfortable" | "compact"',elements:[{name:"literal",value:'"comfortable"'},{name:"literal",value:'"compact"'}]},description:""},align:{required:!1,tsType:{name:"union",raw:'"left" | "center" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"center"'},{name:"literal",value:'"right"'}]},description:`Velg mellom venstrejustering og høyrejustering av innholdet. Typisk skal innholdet være venstrejustert, men for eksempel summer er høyrejustert.
