import{r as b,j as e}from"./iframe-C-Pd17hD.js";import{C as j}from"./Card-BKg9HvqM.js";import{F as r}from"./Flex-B-ChpHIW.js";import{T as c}from"./_index-X-X-2wdy.js";/* empty css               *//* empty css               */import{c as z}from"./clsx-B-dksMZM.js";import"./preload-helper-PPVm8Dsz.js";import"./SlotComponent-BisDAvXX.js";import"./mergeRefs-CKDLcjOC.js";const n=b.forwardRef(function({className:g,size:u="l",as:k,srOnly:x,...h},T){const f=k||"h2";return e.jsx(f,{className:z("jkl-title",x&&"jkl-sr-only",g),"data-text-size":u,ref:T,...h})});n.__docgenInfo={description:"",methods:[],displayName:"Title",props:{as:{required:!1,tsType:{name:"ElementType"},description:`Her kan du angi hva slags element komponenten skal rendres
