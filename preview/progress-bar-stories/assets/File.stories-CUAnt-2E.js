import{r as m,j as e}from"./iframe-BLkUpd90.js";import{c as R}from"./cow-CdXr5BwN.js";import{c as k}from"./clsx-B-dksMZM.js";import{L as M}from"./Link-CA68bS8O.js";import{f as _}from"./formatBytes-B7RSIuaZ.js";import{B as j}from"./Button-BfPiboqO.js";import{T as S}from"./TrashCanIcon-D2Dc5Vk4.js";import{S as b}from"./SupportLabel-PqwXe1Hg.js";const x=m.createContext(null),C=()=>m.useContext(x),I=({context:t,children:s})=>e.jsx(x.Provider,{value:t,children:s});I.__docgenInfo={description:"",methods:[],displayName:"FileInputContextProvider",props:{children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""},context:{required:!0,tsType:{name:"signature",type:"object",raw:`{
