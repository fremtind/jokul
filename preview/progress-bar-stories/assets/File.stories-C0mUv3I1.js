import{r as m,j as e}from"./iframe-DORlHZ2J.js";import{c as R}from"./cow-CdXr5BwN.js";import{c as k}from"./clsx-B-dksMZM.js";import{L as M}from"./Link-DkIdmwud.js";import{f as _}from"./formatBytes-B7RSIuaZ.js";import{B as j}from"./Button-BcwDirt5.js";import{T as S}from"./TrashCanIcon-gAiS0HRe.js";import{S as b}from"./SupportLabel-Bo3ukNf6.js";const x=m.createContext(null),C=()=>m.useContext(x),I=({context:t,children:s})=>e.jsx(x.Provider,{value:t,children:s});I.__docgenInfo={description:"",methods:[],displayName:"FileInputContextProvider",props:{children:{required:!0,tsType:{name:"union",raw:"ReactNode | ReactNode[]",elements:[{name:"ReactNode"},{name:"Array",elements:[{name:"ReactNode"}],raw:"ReactNode[]"}]},description:""},context:{required:!0,tsType:{name:"signature",type:"object",raw:`{
