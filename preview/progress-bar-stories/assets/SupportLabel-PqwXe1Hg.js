import{j as n}from"./iframe-BLkUpd90.js";import{c as y}from"./clsx-B-dksMZM.js";import{E as h,S as g,W as I}from"./WarningIcon-Kq_VDe4Y.js";const j=({id:i,helpLabel:s,errorLabel:e,label:a,labelType:r="help",density:p,className:c,srOnly:d,...u})=>{const o=e||s||a,m=r==="help"||s&&!e,f=r==="warning"||e,l=r==="error",t=r==="success",b=o?y("jkl-form-support-label",c,{"jkl-form-support-label--sr-only":d,"jkl-form-support-label--help":m,"jkl-form-support-label--error":l,"jkl-form-support-label--warning":f,"jkl-form-support-label--success":t}):"jkl-dormant-form-support-label",k=o?u:{},v=l?h:t?g:I;return n.jsxs("span",{id:i,className:b,...k,"data-density":p,children:[n.jsx(v,{variant:"small",className:"jkl-form-support-label__icon"}),n.jsx("span",{children:e||s||a})]})};j.__docgenInfo={description:"",methods:[],displayName:"SupportLabel",props:{id:{required:!0,tsType:{name:"string"},description:`En ID er påkrevd for å kunne referere til SupportLabel med aria-describedby.
