import{R as h,j as e}from"./iframe-BLkUpd90.js";import{c as k}from"./clsx-B-dksMZM.js";import{S as j}from"./SlotComponent-jVST4kCf.js";import{I as v}from"./Image-Bifl5IE2.js";import{C as a}from"./Card-EFOPMGJc.js";import{F as r}from"./Flex-C3tD5e2N.js";import{C as F}from"./CheckIcon-CF8cSdA4.js";import{C as b}from"./CopyIcon-BOX7apJr.js";import"./preload-helper-PPVm8Dsz.js";import"./mergeRefs-a3vf9HQc.js";import"./tokens-d2GYn7oW.js";import"./Icon-C5BUtbpO.js";const g=h.forwardRef(function({as:c,asChild:s,className:p,placement:m="top",...f},x){const C=s?j:c||"img";return e.jsx(C,{ref:x,className:k("jkl-card-image",`jkl-card-image--${m}`,p),...f})});g.__docgenInfo={description:"Bildekomponent som kan brukes i `Card` for å sørge for at bildet\nblør helt ut i kantene av kortet. Rendres normalt som et `<img>`-\nelement, men du kan overstyre dette med `as` dersom du f.eks. har\nen egen komponent for å håndtere responsive bilder.",methods:[],displayName:"CardImage",props:{as:{required:!1,tsType:{name:"ElementType"},description:`Her kan du angi hva slags element komponenten skal rendres
