...
function parse(uuid) {
    ...
    arr[9] = v & 255;
    arr[10] =
        ((v = Number.parseInt(uuid.slice(24, 36), 16)) / 1099511627776) & 255;
...
var require_lib = __commonJS({
    "../../node_modules/.pnpm/@actions+http-client@2.1.0/node_modules/@actions/http-client/lib/index.js"(
        ...
        ((HttpCodes2) => {
            ...
            HttpCodes2[(HttpCodes2["MultipleChoices"] = 300)] =
                "MultipleChoices";
            HttpCodes2[(HttpCodes2["MovedPermanently"] = 301)] =
                "MovedPermanently";
            ...
            HttpCodes2[(HttpCodes2["PaymentRequired"] = 402)] =
                "PaymentRequired";
            HttpCodes2[(HttpCodes2["Forbidden"] = 403)] = "Forbidden";
            HttpCodes2[(HttpCodes2["NotFound"] = 404)] = "NotFound";
            HttpCodes2[(HttpCodes2["MethodNotAllowed"] = 405)] =
                "MethodNotAllowed";
            ...
            HttpCodes2[(HttpCodes2["TooManyRequests"] = 429)] =
                "TooManyRequests";
        ...
        var HttpClient = class {
            ...
            _prepareRequest(method, requestUrl, headers) {
                ...
                info2.options.port = info2.parsedUrl.port
                    ? Number.parseInt(info2.parsedUrl.port)
                    : defaultPort;
                info2.options.path =
                    (info2.parsedUrl.pathname || "") +
...
var require_oidc_utils = __commonJS({
    "../../node_modules/.pnpm/@actions+core@1.10.0/node_modules/@actions/core/lib/oidc-utils.js"(
        ...
        Error Message: ${error.result.message}`);
                    ...
                    const id_token =
                        (_a2 = res.result) === null || _a2 === void 0
                            ? void 0
                            : _a2.value;
                    if (!id_token) {
                        throw new Error(
...
var require_fill_range = __commonJS({
    "../../node_modules/.pnpm/fill-range@7.0.1/node_modules/fill-range/index.js"(
        ...
        var transform = (toNumber2) => {
            return (value) =>
                toNumber2 === true ? Number(value) : String(value);
        };
            ...
            while (index < length) {
                ...
                if (value === CHAR_COMMA && depth > 0) {
                    if (block.ranges > 0) {
                        ...
                        block.nodes = [
                            open,
                            { type: "text", value: stringify2(block) },
                        ];
                    }
    ...
    "../../node_modules/.pnpm/micromatch@4.0.5/node_modules/micromatch/index.js"(
        ...
        micromatch2.not = (list, patterns, options = {}) => {
            ...
            const matches = new Set(
                micromatch2(list, patterns, { ...options, onResult }),
            );
        ...
        micromatch2.contains = (str, pattern, options) => {
            ...
            if (Array.isArray(pattern)) {
                return pattern.some((p) =>
                    micromatch2.contains(str, p, options),
                );
            }
            ...
            new LineParser(
                ...
                (result, [changes, insertions, deletions]) => {
                    ...
                    result.summary.insertions =
                        Number.parseInt(insertions, 10) || 0;
                    result.summary.deletions =
                        Number.parseInt(deletions, 10) || 0;
                },
            ),
            new LineParser(
                /^(\d+)[^,]*(?:,\s*(\d+)[^(]+\(([+-]))?/,
...
// src/git.ts
async function findChangedFiles(patterns, options) {
    const git = simpleGit();
    ...
    const paths = status.files.map((file) => {
        core.debug(
            `${file.index} ${file.from ? `${file.from} -> ` : ""} ${file.path} ${file.working_dir}`,
        );
        return file.path;
    });
    ...
    const matches = (0, import_micromatch.default)(paths, patterns, options);
...
async function run() {
    try {
        const patterns = toList(
            validatePatternsInput(
                core2.getInput("patterns", { required: true }),
            ),
        );
        core2.debug(`Got "patterns" ${patterns}`);
        const ignoreInput = core2.getInput("ignore");
        const ignore = ignoreInput ? toList(core2.getInput("ignore")) : void 0;
        if (ignore) {
            core2.debug(`Got "ignore" ${ignore}`);
        }
        const output = validateOutputInput(core2.getInput("output"));
        core2.debug(`Got "output" ${output}`);
        const paths = await findChangedFiles(patterns, { ignore });
        core2.setOutput("has_changed_files", paths.length > 0);
        switch (output) {
            case "array":
                core2.setOutput("changed_files", paths);
                break;
            case "string":
            default:
                core2.setOutput("changed_files", paths.join("\n"));
                break;
        }
    } catch (error) {
