...
export class TestHelper {
    ...
    async init() {
        console.log(path.resolve(".", "packages", "jokul", "src", "components", this.package, "documentation"));
        this.server = await createServer({
            ...
            root: path.resolve(".", "packages", "jokul", "src", "components", this.package, "documentation"),
            define: {
                __CI__: "true",
            },
        });
