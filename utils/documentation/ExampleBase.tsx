...
import { Dictionary, ChoiceProp, ExampleComponentProps, BoolProp, CodeExample } from "./index";
                    ...
                    <aside data-layout-density="compact" className="jkl-portal-component-example__example-options">
                        <>
                            ...
                            >
                                ...
                                >
                                    <RadioButton data-testid={"theme-light"} value="light">
                                        Light
                                    </RadioButton>
                                    <RadioButton data-testid={"theme-dark"} value="dark">
                                        Dark
                                    </RadioButton>
                                </RadioButtonGroup>
                                {noDensity ? null : (
                                    ...
                                    >
                                        <RadioButton data-testid={"density-default"} value="comfortable">
                                            Default
                                        </RadioButton>
                                        <RadioButton data-testid={"density-compact"} value="compact">
                                            Compact
                                        </RadioButton>
                                    </RadioButtonGroup>
                                )}
