...
<ComponentExample title="Liste" knobs={listExamplesProps} component={ListExamples} codeExample={listExamplesCode} />
...
Om listeelementet ditt starter med en bold tekst og et kolon er det et godt tegn på at du kanskje heller bør bruke [Description list](/komponenter/descriptionlist).
