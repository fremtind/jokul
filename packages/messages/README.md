# [`@fremtind/jkl-messages`](https://fremtind.github.io/jokul/komponenter/messages)

# Meldinger

En melding er en beskjed til brukeren. Det kan være et varsel om at noe er feil, informasjon om at noe mangler i et skjema, eller en bekreftelse på at noe har blitt oppdatert.

I Jøkul finnes det flere typer meldinger, med forskjellig formål:

-   System meldinger er permanente meldinger som skal fortelle om f.eks. system feil, eller brukes som et globalt varsel med en beskrivende tekst.
-   Meldinger er en lokal melding, som består av en overskrift og en meldingstekst.
