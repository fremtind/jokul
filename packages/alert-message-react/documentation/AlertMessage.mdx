...
Vi har fire ulike varsler, med fargene blå, rød, gul og grønn. Fargene i varselmeldinger har en betydning på samme måte som [Message box](/komponenter/messagebox):
...
## Når bruker vi en varselmelding?

Før bruker en varselmelding er det greit å ha tatt stilling til noen spørsmål:
...
Varsler skal vises plassert øverst på siden og ta opp hele sidebredden. Bruk [Message box](/komponenter/messagebox) om du skal vise en beskjed i en annen kontekst.
