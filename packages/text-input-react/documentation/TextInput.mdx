...
<ComponentExample
    ...
    knobs={{
        boolProps: ["Kompakt", "Med hjelpetekst", "Med feil", "Med handling", "Inline", "Invertert"],
        choiceProps: [
            {
                name: "Variant",
...
-   Om vi har forhåndsvalg å gi brukeren er det [Radio buttons](/komponenter/radiobutton), [Checkbox](/komponenter/checkbox) eller [Select](/komponenter/select) som gjelder
