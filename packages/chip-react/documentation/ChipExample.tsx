...
export const chipExampleCode: CodeExample = ({ choiceValues }) => {
    return `
<Chip
    variant="${choiceValues?.Variant as ChipVariant}"
    size="${choiceValues?.Size}"
    ${choiceValues?.Variant === "filter" ? `selected={true/false}` : ""}
/>
`;
};
