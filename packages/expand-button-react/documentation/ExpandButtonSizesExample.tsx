...
export const expandButtonSizesExampleKnobs: ExampleKnobsProps = {
    choiceProps: [
        {
            name: "Variant",
            values: ["heading-3", "heading-2", "heading-1"],
            defaultValue: 1,
        },
    ],
};

export const ExpandButtonSizesExample = ({
    choiceValues,
}: ExampleComponentProps) => {
            ...
            >
                <div className="jkl-expand-section__content">
                    ...
                    <p className="jkl-spacing-l--bottom">
                        ...
                        <code>aria-controls</code>. Denne komponenten kan være
                        nyttig i for eksempel ekspanderbare tabellrader.
                    </p>
                </div>
            </div>
        </div>
