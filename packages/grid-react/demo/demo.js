...
const Buttons = () => (
    <Grid>
        ...
        <GridElement cols={{ small: 0, medium: 1, large: 1 }}>
        ...
        <GridElement cols={{ small: 0, medium: 0, large: 1 }}>
        ...
        <GridElement cols={{ small: 1, medium: 2, large: 3 }}>
        ...
        <GridElement cols={{ small: 1, medium: 2, large: 3 }} />
        <GridElement cols={{ small: 2, medium: 4, large: 6 }}>
