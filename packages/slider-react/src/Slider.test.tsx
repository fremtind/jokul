...
describe("Slider", () => {
    it("renders correct label", () => {
        render(<Slider label="Velg verdi" name="verdi" onChange={dummyFunc} />);
    ...
    it("renders with given values", () => {
        render(<Slider label="Velg verdi" from={4} to={6} name="verdi" onChange={dummyFunc} />);
    ...
    it("is a11y compliant", async () => {
        const { container } = render(<Slider label="Velg verdi" name="verdi" onChange={dummyFunc} />);
