...
<ComponentExample component={DropdownExample} codeExample={dropdownExampleCode} knobs={dropdownExampleKnobs} />
...
## Når bruker vi Dropdown?

Før du bruker Dropdown er det greit å ha tatt stilling til noen spørsmål:
