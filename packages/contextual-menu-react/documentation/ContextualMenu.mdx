...
import ContextualMenuExample, { contextual-menuExampleCode, contextual-menuExampleKnobs } from "./ContextualMenuExample";
...
Før du bruker ContextualMenu er det greit å ha tatt stilling til noen spørsmål:
