...
group: meldinger
images:
    - "../../alert-message-react/documentation/alert-message-dont-1.png"
---

import { MessageBoxExample, messageBoxExampleCode } from "./MessageBoxExample";
...
<ComponentExample
    ...
    knobs={{
        boolProps: ["Full width", "Dismissable"],
        choiceProps: [
            {
                name: "Variant",
...
<Grid>
    <DoDontExample type="do" description="Vis meldingen i kontekst av innholdet" image={props.images[0]} />
</Grid>
