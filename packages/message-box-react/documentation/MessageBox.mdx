...
Som beskrevet i [Skjemavalidering](/guider/skjemadesign#skjemavalidering) bruker vi en ErrorMessageBox til å oppsummere valideringsfeil. Det finnes en ferdig variant `FormErrorMessageBox` som animeres, og skjules på små skjermer. Se [eksempelet på skjemavalidering](/demoer/skjemavalidering) for å se komponenten i bruk.
