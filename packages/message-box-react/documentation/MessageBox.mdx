...
Meldingene består av en overskrift og en meldingstekst.
...
Om meldingen er helt selvstendig (ikke tilknyttet noe av innholdet på siden) skal vi bruke [Alert message](/komponenter/alertmessage).
