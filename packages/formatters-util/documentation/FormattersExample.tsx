...
import {
    ...
    DescriptionTerm,
    DescriptionDetail,
} from "../../description-list-react/src";
import {
    formatAvstand,
    formatDate,
    formatFodselsnummer,
...
export const FormattersExample: FC<ExampleComponentProps> = () => (
    <DescriptionList>
        ...
        <DescriptionDetail>
            {formatTelefonnummer("98651731", { countryCode: "47" })}
        </DescriptionDetail>
        <DescriptionDetail>
            {formatTelefonnummer("22438634", { countryCode: "47" })}
        </DescriptionDetail>
        <DescriptionDetail>
            {formatTelefonnummer("81549300", { countryCode: "47" })}
        </DescriptionDetail>
        ...
        <DescriptionDetail>
            {formatValuta("5000", { suffix: "kr per måned" })}
        </DescriptionDetail>
        <DescriptionDetail>
            {formatValuta("859", {
                prefix: "kr",
