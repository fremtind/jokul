...
import { DatepickerExample, datepickerCode } from "./DatepickerExample";

<Ingress>
    Vi bruker datovelgeren til å gi brukerne mulighet til å skrive inn eller velge en dato. Ledeteksten beskriver
    hvilken dato brukeren skal fylle inn, for eksempel: "Oppgi datoen da skaden skjedde".
</Ingress>
<ComponentExample
    title="DatePicker"
