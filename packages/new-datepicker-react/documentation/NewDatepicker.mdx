---
title: NewDatepicker
react: new-datepicker-react
scss: new-datepicker
group: edit me!
---

import NewDatepickerExample, { new-datepickerExampleCode, new-datepickerExampleKnobs } from "./NewDatepickerExample";

<Ingress>Ingress med kort beskrivelse av komponenten</Ingress>

<ComponentExample component={NewDatepickerExample} codeExample={new-datepickerExampleCode} knobs={new-datepickerExampleKnobs} />
...
## Når bruker vi NewDatepicker?

Før du bruker NewDatepicker er det greit å ha tatt stilling til noen spørsmål:
