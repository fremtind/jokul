...
Gi brukeren tilbakemelding dersom handlingen tar lang tid (over fem sekunder). Om du har en målbar prosess, for eksempel [filopplasting](/komponenter/fileuploader), bør du gi brukeren tilbakemelding på hvor langt prosessen har kommet, og hvor langt de har igjen. Se [ProgressBar](/komponenter/progressbar).
