...
<ComponentExample component={TransitionsExample} codeExample={transitionsExampleCode} knobs={transitionsExampleKnobs} />
...
## Når bruker vi Transitions?

Før du bruker Transitions er det greit å ha tatt stilling til noen spørsmål:
