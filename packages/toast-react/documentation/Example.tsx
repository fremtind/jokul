...
import { ToastStickerSheet, toastStickerSheetKnobs, toastStickerSheetCode } from "./ToastStickerSheet";
...
export default function Example() {
    return (
        <>
            <DevExample component={ToastExample} codeExample={toastStickerSheetCode} knobs={toastExampleKnobs} />
            <DevExample
