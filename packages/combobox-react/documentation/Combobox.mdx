...
<Ingress>Combobox-komponenten lar brukeren velge flere valg fra en nedtrekksliste.</Ingress>
...
Før du bruker Combobox er det greit å ha tatt stilling til noen spørsmål:
