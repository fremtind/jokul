...
<ComponentExample title="Tag" component={TagExample} codeExample={tagExampleCode} knobs={tagExampleKnobs} />
...
<div>
    <DoDontExample
        ...
        content={<Tag className="jkl-spacing-2xs--right jkl-spacing-2xs--top">E-kunde</Tag>}
    />
    <DoDontExample
        type="dont"
        description="Lang tekst"
        content={<Tag className="jkl-spacing-2xs--right jkl-spacing-2xs--top">Kunden er e-kunde</Tag>}
    />
</div>
<div>
    <DoDontExample
        ...
        content={<Tag className="jkl-spacing-2xs--right jkl-spacing-2xs--top">PDF</Tag>}
    />
    <DoDontExample
        type="dont"
...
Fargene i statustags har en betydning på samme måte som [MessageBox](/komponenter/messagebox):
...
<div>
    <DoDontExample
        type="do"
        description="Status"
        content={<SuccessTag className="jkl-spacing-2xs--right jkl-spacing-2xs--top">Registrert</SuccessTag>}
    />
    <DoDontExample
        type="dont"
        description="Statusfarge for emne"
        content={<SuccessTag className="jkl-spacing-2xs--right jkl-spacing-2xs--top">Miljøvennlig</SuccessTag>}
    />
</div>
<div>
    <DoDontExample
        type="do"
        description="Status"
        content={<InfoTag className="jkl-spacing-2xs--right jkl-spacing-2xs--top">Behandles</InfoTag>}
    />
    <DoDontExample
        type="dont"
        description="Emnefarge for status"
        content={<Tag className="jkl-spacing-2xs--right jkl-spacing-2xs--top">Behandles</Tag>}
    />
</div>
<div>
    <DoDontExample
        type="do"
        description="Emne"
        content={<Tag className="jkl-spacing-2xs--right jkl-spacing-2xs--top">Flom</Tag>}
    />
    <DoDontExample
        type="dont"
        description="Statusfarge for emne"
        content={<InfoTag className="jkl-spacing-2xs--right jkl-spacing-2xs--top">Flom</InfoTag>}
    />
</div>
