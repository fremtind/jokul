...
Vi har fire ulike varsler, med fargene blå, rød, gul og grønn. Fargene i varselmeldinger har en betydning på samme måte som [Message](/komponenter/message):
...
Varsler skal vises plassert øverst på siden og ta opp hele sidebredden. Bruk [Message](/komponenter/message) om du skal vise en beskjed i en annen kontekst.
