...
import { H1, H2, H3, H4, H5, LeadParagraph, BodyParagraph, SmallParagraph, MicroParagraph, Link } from "../src";
...
const Example = () => (
    <section className="jkl-spacing--top-3 jkl-spacing--bottom-3">
        ...
        <BodyParagraph>
            BodyParagraph: The sky of a deep dark blue was hung with innumerable stars, which seemed to float in the
        ...
        <MicroParagraph>
            MicroParagraph: The unwonted sadness of her tone reminded me of her devoted life, and I turned towards her
        ...
        <div style={{ backgroundColor: "#000", color: "#fafafa" }}>
            <BodyParagraph>
                BodyParagraph: The sky of a deep dark blue was hung with innumerable stars, which seemed to float in the
                limpid ether, and the rolling vapours through which we had passed were drawn like a sable curtain
