...
import AnimationBetweenExample, {
    animationBetweenExampleCode,
} from "./AnimationBetweenExample";
import AutoAnimationExample, {
    autoAnimationExampleCode,
} from "./AutoAnimationExample";

<Ingress>
    Animering av ting inn og ut av DOMet i React er ikke lett, men med
    useAnimatedHeight blir jobben en god del lettere.
</Ingress>

<ComponentExample
    title="useAnimatedHeight"
    component={AnimationExample}
    codeExample={animationExampleCode}
/>
