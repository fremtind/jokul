...
<aside className="jkl-portal-paragraph">
    <InfoMessage
        ...
        fullWidth
        title="Om fontskalaen og semantikk"
    >
        Selv om navnene i fontskalaen kanskje ikke gir det inntrykket, så står
        du fritt til å velge hvilket overskriftsnivå som skal ha hvilket
        utseende. Om du vil bruke <code>heading-5</code> på <code>h3</code>{" "}
