...
For å bruke mixin-ene må du ha satt opp støtte for Sass i prosjektet ditt, og importere Jøkul der du skal bruke dem, f.eks. slik: `@use "~@forbrukerradet/jkl-core/jkl";`. Nøyaktig syntaks kan variere ut fra byggoppsettet ditt.
