...
Du kan importere alle mixins, eller kun de du trenger, fra `jkl-core`. Nøyaktig syntaks vil variere ut fra oppsettet i prosjektet ditt, men vil sannsynligvis likne på dette: `@import "~@forbrukerradet/jkl-core/mixins/_all.scss;"`.

## Bevegelse

`@import "~@forbrukerradet/jkl-core/mixins/_motion.scss;"`
...
`@import "~@forbrukerradet/jkl-core/mixins/_screenreader.scss;"`
...
`@import "~@forbrukerradet/jkl-core/mixins/_helpers.scss;"`
...
`@import "~@forbrukerradet/jkl-core/_functions.scss;"`
...
```scss
@use '@forbrukerradet/jkl-core/mixins/navigation';
