...
import { Action, Primary, Secondary, Tertiary } from "./Example";
...
**Handlingsknapp:** brukes i stedet for primærknapp på en handling som er ekstra ønskelig, for eksempel kjøp. Det skal kun være én handligsknapp per side.
...
Hvis du skal bruke lastemodus i knappen må du sørge for at `@fremtind/jkl-loader.min.css` er lastet inn i klienten.

## Knappetyper

Disse fire hovedknappetypene har et hierarki. Når brukeren har flere valg samtidig, skal vi kun ha én primær- eller handlingsknapp.
