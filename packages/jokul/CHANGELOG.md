...
- 2c9c91f: Fikser en bug der `onClick`-eventet sendt inn til `MenuItem` ble trigget to ganger.
- dc5ea6b: Endrer automatisk lengde på `TextInput` når man setter `maxLength`, slik at innholdet i feltet ikke blir kuttet av.
...
- f78dd2e: Legger tilbake fontskalering for iOS basert på brukerinnstillinger, på en måte om ikke overskriver fonten vår i designsystemet.

## 2.1.1

### Patch Changes

- 613688d: **Feilretting: Fjerner CSS som overskrev Fremtind Grotesk font**
...
- 9046363: Legg til ny versjon av Description List som beta-komponent:
