...
export {
    FODSELSNUMMER_REGEX,
    formatFodselsnummer,
} from "./fodselsnummer/formatFodselsnummer.js";
export {
...
export {
    KONTONUMMER_REGEX,
    formatKontonummer,
} from "./kontonummer/formatKontonummer.js";
export {
    KORTNUMMER_REGEX,
    formatKortnummer,
} from "./kortnummer/formatKortnummer.js";
export {
    TELEFONNUMMER_REGEX,
    formatTelefonnummer,
} from "./telefonnummer/formatTelefonnummer.js";
