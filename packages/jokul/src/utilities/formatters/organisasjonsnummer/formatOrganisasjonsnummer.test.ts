...
describe("formatOrganisasjonsnummer", () => {
    it("correctly formats 9 digit numbers", () => {
        expect(formatOrganisasjonsnummer("915651232")).toEqual(
            `915${nbsp}651${nbsp}232`,
        );
    });
...
describe("formatOrganisasjonsnummer with partial option", () => {
    it("correctly formats numbers over 2 digits", () => {
        ...
        expect(formatOrganisasjonsnummer("91565", { partial: true })).toEqual(
            `915${nbsp}65`,
        );
        expect(formatOrganisasjonsnummer("915651", { partial: true })).toEqual(
            `915${nbsp}651`,
        );
        expect(formatOrganisasjonsnummer("9156512", { partial: true })).toEqual(
            `915${nbsp}651${nbsp}2`,
        );
        expect(
            formatOrganisasjonsnummer("91565123", { partial: true }),
        ).toEqual(`915${nbsp}651${nbsp}23`);
        expect(
            formatOrganisasjonsnummer("915651232", { partial: true }),
        ).toEqual(`915${nbsp}651${nbsp}232`);
    });
    ...
    it("ignores spaces in otherwise valid inputs", () => {
        ...
        ).toEqual(`915${nbsp}651`);
        expect(
            formatOrganisasjonsnummer("91 5 651 2", { partial: true }),
        ).toEqual(`915${nbsp}651${nbsp}2`);
        expect(
            formatOrganisasjonsnummer("9 1 5 6 5 1 2 3 2", { partial: true }),
        ).toEqual(`915${nbsp}651${nbsp}232`);
    });
});
