...
export const DateInput = forwardRef<HTMLInputElement, DateInputProps>(
    (props, forwardedInputRef) => {
        ...
        const calendarId = `jkl-date-input-calendar-${useId()}`;
        ...
        // min/max kan komme inn som number (bl.a. fra react-hook-forms register),
        // men både native feltet og kalenderen forholder seg til ISO-strenger.
        ...
        return (
            <InputGroup
                ...
                render={(inputProps) => (
                    <div className="jkl-date-input__wrapper">
                        <input
                            ref={setInputRef}
