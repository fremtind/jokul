...
export const Calendar = (props: CalendarProps) => {
    ...
    const parsedInitialDate = parseDateString(initialDate);
    const [day, setDay] = useState<Date | undefined>(parsedInitialDate);

    const minDate = useMemo(
        () => parseDateString(min || disableBeforeDate),
        [min, disableBeforeDate],
    );
    const maxDate = useMemo(
        () => parseDateString(max || disableAfterDate),
    ...
    const [decorator, setDecorator] = useState<{
        ...
        month: parsedInitialDate
            ? parsedInitialDate.getMonth()
            : new Date().getMonth(),
        year: parsedInitialDate
