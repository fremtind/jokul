...
describe("Calendar", () => {
    it("calls onChange once when selecting a date", async () => {
        ...
        await userEvent.click(getByLabelText("15.03.2026"));
    ...
    it("disables weekends when disableWeekends is set", () => {
        ...
        expect(getByLabelText("14.03.2026")).toBeDisabled();
        expect(getByLabelText("16.03.2026")).not.toBeDisabled();
    });
    ...
    it("disables dates outside min and max", () => {
        ...
        expect(getByLabelText("09.03.2026")).toBeDisabled();
        expect(getByLabelText("10.03.2026")).not.toBeDisabled();
        expect(getByLabelText("20.03.2026")).not.toBeDisabled();
        expect(getByLabelText("21.03.2026")).toBeDisabled();
    });
