                ...
                <form>
                    <ModalHeader>
                        <ModalTitle {...modalConfig.title}>
                            Kan vi bruke valgfrie informasjonskapsler?
                        </ModalTitle>
                    </ModalHeader>
                    <ModalBody>
                        <Flex direction="column" gap={24}>
                            <p>
                                Hvis du svarer ja, bruker vi
                                informasjons­­kapsler og lignende teknologi til
                                statistikk, analyse, spørreundersøkelser og
                                bruker­tester. Målet er å forstå hvordan du og
                                andre bruker løsningen, slik at vi kan forbedre
                                nettsidene og tjenestene våre.
                            </p>
                            <p>
                                Merk at vi alltid lagrer tekniske
                                informasjonskapsler for at nettsidene skal
                                fungere.{" "}
                                <Link href={aboutPage}>
