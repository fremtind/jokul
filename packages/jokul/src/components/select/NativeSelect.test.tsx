...
describe("NativeSelect", () => {
    ...
    it("should render the correct number of options", () => {
        const { getAllByTestId } = render(
            <NativeSelect label="testing" items={["1", "2", "3"]} />,
        );
    ...
    it("should render correct label and value when given values as strings", () => {
        ...
        const { getAllByTestId } = render(
            <NativeSelect label="testing" items={items} />,
        );

        expect(getAllByTestId("jkl-select__option")[0]).toHaveAttribute(
            "value",
            "item 1",
        );
        expect(getAllByTestId("jkl-select__option")[0]).toHaveTextContent(
            "item 1",
        );
    });
    ...
    it("should render correct label and value when given values as objects", () => {
        ...
        expect(getAllByTestId("jkl-select__option")[1]).toHaveAttribute(
            "value",
            "item2",
        );
        expect(getAllByTestId("jkl-select__option")[1]).toHaveTextContent(
            "Item 2",
        );
    });
