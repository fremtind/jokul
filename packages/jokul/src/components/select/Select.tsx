...
export const Select = forwardRef<HTMLSelectElement, Props>(
    function Select(props, externalRef) {
        ...
        const filterFn: (pair: ValuePair) => boolean = (pair) =>
        ...
        useLayoutEffect(() => {
            setSelected(
                new Set(
                    Array.from(selectRef.current?.selectedOptions || []).map(
                        (o) => o.value,
                    ),
                ),
            );
                    ...
                    <div>
                        ...
                        >
                            <Flex direction="column" gap="8" as="fieldset">
                                ...
                                {valuePairs.length && !filteredPairs.length && (
