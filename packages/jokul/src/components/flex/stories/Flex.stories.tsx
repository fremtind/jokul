...
const semanticGapValues = createGapValues(Object.keys(tokens.semanticSpacing));
const staticGapValues = createGapValues(Object.keys(tokens.spacing));
        ...
        return (
            <>
                ...
                <Flex
                    ...
                    // biome-ignore lint/suspicious/noExplicitAny: Storybook klager på denne ved bruk i flex story, men ikke der den ellers.
                    gap={{ medium: "none s", large: "s m", xl: "m xl" } as any}
                    {...props}
                >
