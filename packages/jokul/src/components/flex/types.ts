...
const responsiveSpacingTokens = tokens.default.unit;

/**
 * Én verdi gjelder begge akser. To verdier gir henholdsvis `row-gap` og
 * `column-gap`. De to skalaene kan ikke blandes.
 * @example "m"
 * @example "16 24"
 */
export type Gap =
    | keyof typeof staticSpacingTokens
    | keyof typeof responsiveSpacingTokens
