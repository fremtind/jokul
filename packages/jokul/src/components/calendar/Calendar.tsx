...
export const Calendar = (props: CalendarProps) => {
    ...
    const minDate = useMemo(() => (min ? parseToDate(min) : undefined), [min]);
    const maxDate = useMemo(() => (max ? parseToDate(max) : undefined), [max]);
    ...
    useEffect(() => {
        ...
        const next = parseToDate(value) ?? new Date();
        setDay(next);
