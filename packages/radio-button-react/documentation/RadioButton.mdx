...
import {
    RadioButtonPreselectedExample,
    radioButtonPreselectedExampleCode,
} from "./RadioButtonPreselectedExample";
import {
    RadioButtonHelpLabelExample,
    radioButtonHelpLabelExampleCode,
} from "./RadioButtonHelpLabelExample";
...
Du finner et [eksempel på radioknapper brukt i skjemakontekst her](/demoer/skjemavalidering/) under Demoer. [Koden til eksempelet](https://github.com/fremtind/jokul/blob/main/portal/src/pages/demoer/skjemavalidering.tsx) finner du på GitHub.
...
### Hjelpetekst for en individuell radioknapp

Valgene i en gruppe med radioknapper bør helst være selvforklarende og korte, men det er ikke alltid mulig. I de tilfellene er det mulig å sette en hjelpetekst på de individuelle radioknappene.

<ComponentExample
    title="Hjelpetekst på en individuell radioknapp"
    component={RadioButtonHelpLabelExample}
    codeExample={radioButtonHelpLabelExampleCode}
/>
