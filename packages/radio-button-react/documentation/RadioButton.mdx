...
import { RadioButtonHelpLabelExample, radioButtonHelpLabelExampleCode } from "./RadioButtonHelpLabelExample";
...
Du finner et [eksempel på radioknapper brukt i skjemakontekst](/demoer/skjemavalidering/) under Profil og Skjemadesign. [Koden til eksempelet](https://github.com/fremtind/jokul/blob/main/portal/src/pages/demoer/skjemavalidering.tsx) finner du på GitHub.
